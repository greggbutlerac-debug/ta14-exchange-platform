...
const requirements=[
 ['01','Freeze the mechanism.','Frozen mechanism identity: TA14-AFA-EABA-SX-001 · v1.0.0. The server harness exposes that same immutable mechanism identity on every run.'],
 ...
 ['06','Show the protected consequence did not fire.','The bypass result records protectedConsequenceFired=false and preserves that state in the trace and receipt.'],
 ['07','Preserve the receipt.','Each execution returns a machine-readable TA14_EXECUTION_RECEIPT_V1 object with a SHA-256 integrity hash; the JSON can be downloaded.'],
 ['08','Replay it.','REPLAY sends the preserved receipt back to the server, recomputes the same action under the frozen mechanism, and compares integrity hashes.'],
] as const;
