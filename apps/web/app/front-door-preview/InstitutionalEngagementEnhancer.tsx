...
export default function InstitutionalEngagementEnhancer() {
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .fdp .door.sovereign:after{content:'WORLD 06';position:absolute;right:18px;top:18px;font-size:8px;font-weight:950;letter-spacing:.16em;color:rgba(255,255,255,.52)}
