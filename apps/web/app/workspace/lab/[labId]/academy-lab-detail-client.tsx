...
type AcademyLabDetailClientProps = {
  lab: AcademyLab;
};

export default function AcademyLabDetailClient({
  lab,
}: AcademyLabDetailClientProps) {
    ...
    <main className="page">
      ...
      <style jsx>{`
        ...
        :global(body) {
          margin: 0;
          background:
            radial-gradient(circle at 12% 5%, rgba(41, 167, 255, 0.12), transparent 28%),
            radial-gradient(circle at 88% 18%, rgba(57, 242, 161, 0.08), transparent 24%),
            #040a11;
        }
