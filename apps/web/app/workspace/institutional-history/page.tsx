...
const events = [
  { id: "EVT-8112", event: "scope.version.accepted", subject: "TA14-SCP-000084", actor: "Authorized organization representative", occurred: "8 minutes ago", className: "gold" },
  { id: "EVT-8111", event: "evidence.package.submitted", subject: "TA14-EVD-000119", actor: "Governance entity steward", occurred: "27 minutes ago", className: "cyan" },
  { id: "EVT-8110", event: "registry.review.assigned", subject: "TA14-ENT-000017", actor: "TA-14 Registry", occurred: "1 hour ago", className: "violet" },
  { id: "EVT-8109", event: "credential.issued", subject: "TA14-CRD-000006", actor: "TA-14 Academy", occurred: "Yesterday", className: "green" },
  { id: "EVT-8108", event: "artifact.outcome.required", subject: "TA14-EA-000012", actor: "Artifact integrity service", occurred: "Yesterday", className: "red" },
] as const;
  ...
  return (
    <main className="historyPage">
      ...
      <header className="topbar">
        <div><p>TA-14 AUTHORITY GOVERNANCE INSTITUTION</p><h1>Institutional History</h1></div>
        <div className="actions">
          <Link href="/workspace/mission-control">← Mission Control</Link>
          <Link href="/workspace/route-history" className="routeLedger">Route History Ledger →</Link>
        </div>
      </header>
