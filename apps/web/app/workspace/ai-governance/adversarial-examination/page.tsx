...
export default function AdversarialExaminationPage() {
  ...
  function exportRecord() {
    const record = {
      ...
      sourceInfluence: 'Adversarial conformance and succession concepts adapted after review of ZGCS v1.0 (Michal Harcej, 2026). TA-14 tests and outcomes are independently defined and do not claim PLI/ZGCS conformance.',
    ...
    <main className="page">
      <section className="shell">
        ...
        <header className="hero">
          ...
          <p className="lead">A working examination surface for adversarially challenging changed-condition detection, authority separation, evidence supportability, ordering, material-change gates, historical integrity, revalidation, offline reconstruction, and compound bypass routes.</p>
