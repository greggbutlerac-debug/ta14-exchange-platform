...
const STORAGE_KEY = "ta14-risk-governance-playground-v5";
const VERSION = "RG-5.0";

const DETERMINATION_META: Record<Determination, { description: string; tone: string }> = {
  ALLOW: { description: "The exact risk-bounded action may proceed only where risk authority, ownership, implementation, testing, monitoring, acceptance, and evidence conditions are satisfied.", tone: "#57e9b1" },
  HOLD: { description: "Execution must pause because required authority, evidence, continuity, monitoring, or treatment conditions are incomplete or stale.", tone: "#ffd36f" },
  DENY: { description: "The proposed action crosses a non-waivable risk limit, risk-owner authority, implementation, testing, acceptance, or execution boundary.", tone: "#ff6f7d" },
  ESCALATE: { description: "The unresolved conflict exceeds delegated risk steward or operator authority and requires a named higher review path.", tone: "#c797ff" },
};

const TABS: Array<{ id: TabId; label: string; short: string }> = [
  { id: "overview", label: "Mission Control", short: "01" },
  { id: "registry", label: "Risk Register", short: "02" },
  { id: "purpose", label: "Risk Context & Scope", short: "03" },
  { id: "treatments", label: "Risk Ownership", short: "04" },
  { id: "treatment-map", label: "Treatment Mapping", short: "05" },
  { id: "treatment-plan", label: "Treatment Execution", short: "06" },
  { id: "acceptance", label: "Risk Acceptance", short: "07" },
  { id: "residual", label: "Residual Validation", short: "08" },
  { id: "monitoring", label: "Trigger Monitoring", short: "09" },
...
const INITIAL_RISKS: RiskRecord[] = [
  {
    id: "risk-orion-ops",
    name: "Enterprise AI Risk Register",
    version: "4.6.2",
    stage: "Production",
  ...
  },
  {
    ...
    name: "Third-Party AI Risk Profile",
    version: "2.3.7",
    stage: "Production",
  ...
  },
  {
    ...
    name: "Human Oversight Risk Profile",
    version: "5.1.0",
    stage: "Production",
  ...
  },
  {
    ...
    name: "Financial Execution Risk Register",
    version: "1.8.4",
    stage: "Restricted",
  ...
  },
  {
    ...
    name: "Research Evidence Risk Profile",
    version: "3.9.1",
    stage: "Candidate",
    purpose: "Collect and synthesize approved research treatments",
    risk: "MODERATE",
    approval: "Conditional",
  ...
  },
  {
    ...
    name: "Security Containment Risk Register",
    version: "6.0.3",
    stage: "Production",
...
const INITIAL_TREATMENTS: TreatmentRecord[] = [
  {
    ...
    name: "Risk Register Connector",
    purpose: "Read risk context and affected-asset evidence",
    capability: "READ",
    domain: "Customer operations",
    approval: "Approved",
    conditions: "Read-only risk evidence; no treatment authority.",
  },
  {
  ...
  },
  {
    ...
    name: "Risk Communication Draft",
    purpose: "Document risk treatment communications",
    capability: "DRAFT",
    domain: "Risk Acceptance",
    approval: "Approved",
    conditions: "Advisory only; cannot accept residual risk.",
  },
  {
    id: "treatment-mail-send",
    name: "Risk Communication Release",
  ...
  },
  {
    ...
    name: "Risk Termination Treatment",
...
const INITIAL_EVIDENCE: EvidenceItem[] = [
  ...
  },
  {
    ...
    treatment: "Access treatment plane",
  ...
  },
  {
    ...
    description: "Foreseeable misuse, dual-use paths, abuse treatments, and residual risk acceptance.",
...
const INITIAL_SCENARIOS: Scenario[] = [
  {
    ...
    summary: "Risk reads an approved case, drafts a response, and pauses before external transmission.",
  ...
  },
  {
    ...
    summary: "Risk replaces the approved research approved purpose with an unapproved purchasing action.",
    trigger: "Goal drift",
    expected: "DENY",
    severity: "CRITICAL",
  ...
  },
  {
    ...
    summary: "Risk attempts to call a newly discovered external connector.",
  ...
  },
  {
    ...
    summary: "Risk relies on an outdated preference that conflicts with the current record.",
  ...
  },
  {
    ...
    summary: "Risk launches a code-execution treatment-plan absent from the collection authority map.",
  ...
  },
  {
    ...
    summary: "Risk actions cannot be observed or preserved for seven minutes.",
  ...
  },
  {
    ...
    summary: "Risk is paused, retention corrected, permissions revalidated, and run restarted from checkpoint.",
...
const INITIAL_CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    response: "Risk owner accepted a differentiated freshness schedule.",
...
const MEMORY_OBJECTS: RetentionObject[] = [
  ...
  },
  {
    id: "mem-010",
    class: "Durable",
    subject: "Risk limitation notice",
...
const COMMUNICATION_RULES: TransferRule[] = [
  ...
  },
  {
    ...
    prohibited: "Risk impersonation and autonomous consequential commitments",
  },
  {
    id: "com-07",
  ...
  },
  {
    ...
    approval: "Risk Acceptance and subject-matter approval",
...
export default function RiskTreatmentGovernancePlaygroundPage() {
  const [activeTab, setActiveTab] = useState<TabId>("overview");
  const [selectedRiskId, setSelectedRiskId] = useState(INITIAL_RISKS[0].id);
  const [runName, setRunName] = useState("Risk authority validation run");
  ...
  const governedRecord = useMemo(() => ({
    ...
    changes,
    nonClaims: [
      "Risk identity does not prove that a specific action is correct or admissible.",
      ...
      "ALLOW in Risk Governance Governance does not automatically produce ALLOW in another governance lane.",
    ],
  ...
  function resetWorkspace() {
    ...
    setRunName("Risk authority validation run");
    ...
    <main className="page-shell">
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <h1>Risk Governance Governance</h1>
      ...
      <section className="workspace-grid">
        <aside className="sidebar">
          ...
          <div className="sidebar-actions"><button onClick={preserveRun}>Preserve current run</button><button onClick={() => downloadJson("ta14-risk-treatment-governed-record.json", governedRecord)}>Export governed record</button><button className="ghost" onClick={resetWorkspace}>Reset workspace</button></div>
