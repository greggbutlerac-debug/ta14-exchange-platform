...
const STORAGE_KEY = "ta14-security-governance-playground-v5";
const VERSION = "SG-5.0";

const DETERMINATION_META: Record<Determination, { description: string; tone: string }> = {
  ALLOW: { description: "The exact security-bounded operation may proceed only where environment, identity, credential, privilege, dependency, containment, restoration, monitoring, and evidence conditions are satisfied.", tone: "#57e9b1" },
  HOLD: { description: "The security determination must pause because environment, identity, credential, privilege, dependency, incident, containment, restoration, or monitoring evidence is incomplete or stale.", tone: "#ffd36f" },
  DENY: { description: "The proposed action crosses a non-waivable security boundary, unauthorized privilege, untrusted dependency, containment, restoration, or execution boundary.", tone: "#ff6f7d" },
  ESCALATE: { description: "The unresolved threat, vulnerability, identity, privilege, dependency, incident, containment, or recovery conflict exceeds delegated security authority and requires incident commander, security authority, or named higher review.", tone: "#c797ff" },
};

const TABS: Array<{ id: TabId; label: string; short: string }> = [
  { id: "overview", label: "Mission Control", short: "01" },
  { id: "registry", label: "Security Register", short: "02" },
  { id: "purpose", label: "Environment & Boundary", short: "03" },
  { id: "treatments", label: "Identity & Privilege", short: "04" },
  { id: "treatment-map", label: "Control Mapping", short: "05" },
  { id: "treatment-plan", label: "Control Effectiveness", short: "06" },
  { id: "acceptance", label: "Security Approval", short: "07" },
  { id: "residual", label: "Residual Risk Validation", short: "08" },
  { id: "monitoring", label: "Continuous Security Monitoring", short: "09" },
...
const INITIAL_RISKS: RiskRecord[] = [
  {
    id: "risk-orion-ops",
    name: "Enterprise AI Security Register",
    version: "4.6.2",
    stage: "Production",
    purpose: "Demonstrate security for approved maintenance workflows",
    risk: "HIGH",
  ...
  },
  {
    ...
    name: "Third-Party Security Assurance Profile",
    version: "2.3.7",
    stage: "Production",
    purpose: "Validate supplier security requirements and continuing duties",
    risk: "MODERATE",
    approval: "Approved",
  ...
  },
  {
    ...
    name: "Human Oversight Security Profile",
    version: "5.1.0",
    stage: "Production",
    purpose: "Demonstrate notice, review, and identity and access-control assurance",
    risk: "LOW",
    approval: "Approved",
  ...
  },
  {
    ...
    name: "Financial Execution Security Register",
    version: "1.8.4",
    stage: "Restricted",
    purpose: "Validate financial-service security requirements before recommendation",
    risk: "CRITICAL",
    approval: "Hold",
  ...
  },
  {
    ...
    version: "3.9.1",
    stage: "Candidate",
    purpose: "Map identity and identity, credential, and trust sources and preserve security assessment evidence",
    risk: "MODERATE",
    approval: "Conditional",
  ...
  },
  {
    ...
    name: "Security Containment Security Register",
    version: "6.0.3",
    stage: "Production",
...
const INITIAL_TREATMENTS: TreatmentRecord[] = [
  {
    ...
    name: "Security Register Connector",
    purpose: "Read risk context and affected-asset evidence",
    capability: "READ",
    domain: "Customer operations",
    approval: "Approved",
    conditions: "Read-only security evidence; no treatment authority.",
  },
  {
    id: "treatment-crm-write",
    name: "Security Register Update",
  ...
  },
  {
    ...
    name: "Security profile Communication Draft",
    purpose: "Document control implementation communications",
    capability: "DRAFT",
    domain: "Security Approval",
    approval: "Approved",
    conditions: "Advisory only; cannot accept residual security exposure.",
  },
  {
    id: "treatment-mail-send",
    name: "Security profile Communication Release",
  ...
  },
  {
    ...
    name: "Security profile Termination Treatment",
...
const INITIAL_EVIDENCE: EvidenceItem[] = [
  ...
  },
  {
    ...
    owner: "Security profile operator",
    state: "STALE",
    required: true,
  },
  {
  ...
  },
  {
    ...
    description: "Foreseeable misuse, dual-use paths, abuse treatments, and residual security assessment approval.",
...
const INITIAL_GATES: RiskGate[] = [
  {
    id: "gate-01",
    order: 1,
    title: "Security profile identity",
...
const INITIAL_SCENARIOS: Scenario[] = [
  {
    ...
    summary: "Security profile reads an approved case, drafts a response, and pauses before external transmission.",
  ...
  },
  {
    ...
    summary: "Security profile replaces the approved research approved purpose with an unapproved purchasing action.",
    trigger: "Goal drift",
    expected: "DENY",
    severity: "CRITICAL",
  ...
  },
  {
    ...
    summary: "Security profile attempts to call a newly discovered external connector.",
  ...
  },
  {
    ...
    summary: "Security profile relies on an outdated preference that conflicts with the current record.",
  ...
  },
  {
    ...
    summary: "Security profile launches a code-execution treatment-plan absent from the collection authority map.",
  ...
  },
  {
    ...
    summary: "Security profile actions cannot be observed or preserved for seven minutes.",
  ...
  },
  {
    ...
    summary: "Security profile is paused, retention corrected, permissions revalidated, and run restarted from checkpoint.",
...
const INITIAL_CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    response: "Security profile owner accepted a differentiated freshness schedule.",
...
const MEMORY_OBJECTS: RetentionObject[] = [
  ...
  },
  {
    id: "mem-010",
    class: "Durable",
    subject: "Security profile limitation notice",
...
const COMMUNICATION_RULES: TransferRule[] = [
  ...
  },
  {
    ...
    prohibited: "Security profile impersonation and autonomous consequential commitments",
  },
  {
    id: "com-07",
  ...
  },
  {
    ...
    approval: "Security Approval and subject-matter approval",
  ...
  },
  {
    ...
    preservation: "Treatment identity, call arguments, result hash, and security assessment",
...
export default function SecurityRegulationGovernancePlaygroundPage() {
  const [activeTab, setActiveTab] = useState<TabId>("overview");
  const [selectedRiskId, setSelectedRiskId] = useState(INITIAL_RISKS[0].id);
  const [runName, setRunName] = useState("Security profile authority validation run");
  ...
  const governedRecord = useMemo(() => ({
    ...
    changes,
    nonClaims: [
      "Security profile identity does not prove that a specific action is correct or admissible.",
      ...
      "ALLOW in Security Governance does not automatically produce ALLOW in another governance lane.",
    ],
  ...
  function resetWorkspace() {
    ...
    setRunName("Security profile authority validation run");
    ...
    <main className="page-shell">
      ...
      <section className="workspace-grid">
        <aside className="sidebar">
          ...
          <div className="sidebar-actions"><button onClick={preserveRun}>Preserve current run</button><button onClick={() => downloadJson("ta14-security-governed-record.json", governedRecord)}>Export governed record</button><button className="ghost" onClick={resetWorkspace}>Reset workspace</button></div>
