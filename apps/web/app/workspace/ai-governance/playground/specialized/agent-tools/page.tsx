...
const STORAGE_KEY = "ta14-agent-tool-governance-playground-v5";
const VERSION = "AT-5.0";

const DETERMINATION_META: Record<Determination, { description: string; tone: string }> = {
  ALLOW: { description: "The exact agent action may proceed inside the stated delegation, tool, memory, communication, financial, and termination boundaries.", tone: "#57e9b1" },
...
const TABS: Array<{ id: TabId; label: string; short: string }> = [
  ...
  { id: "registry", label: "Agent Registry", short: "02" },
  { id: "delegation", label: "Delegation & Objective", short: "03" },
  { id: "tools", label: "Tool Authority", short: "04" },
  { id: "memory", label: "Memory Governance", short: "05" },
  { id: "orchestration", label: "Sub-agent Control", short: "06" },
  { id: "communications", label: "Communications", short: "07" },
  { id: "financial", label: "Financial Limits", short: "08" },
  { id: "monitoring", label: "Runtime Monitoring", short: "09" },
...
const INITIAL_AGENTS: AgentRecord[] = [
  {
    ...
    version: "4.6.2",
    stage: "Production",
    objective: "Coordinate approved maintenance workflows",
    risk: "HIGH",
  ...
  },
  {
    ...
    name: "Meridian Procurement Agent",
    version: "2.3.7",
    stage: "Production",
    objective: "Prepare bounded supplier comparisons",
    risk: "MODERATE",
    approval: "Approved",
  ...
  },
  {
    ...
    name: "Lumen Service Agent",
    version: "5.1.0",
    stage: "Production",
    objective: "Draft customer-service responses",
    risk: "LOW",
    approval: "Approved",
  ...
  },
  {
    ...
    name: "Vault Finance Agent",
    version: "1.8.4",
    stage: "Restricted",
    objective: "Prepare payment exception recommendations",
    risk: "CRITICAL",
    approval: "Hold",
  ...
  },
  {
    ...
    version: "3.9.1",
    stage: "Candidate",
    objective: "Collect and synthesize approved research sources",
    risk: "MODERATE",
    approval: "Conditional",
  ...
  },
  {
    ...
    name: "Sentinel Response Agent",
    version: "6.0.3",
    stage: "Production",
    objective: "Coordinate bounded security containment playbooks",
    risk: "CRITICAL",
    approval: "Escalate",
...
const INITIAL_EVIDENCE: EvidenceItem[] = [
  {
    id: "ev-01",
    category: "Identity",
    title: "Canonical agent identity",
...
const INITIAL_SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    summary: "Agent actions cannot be observed or preserved for seven minutes.",
...
const COMMUNICATION_RULES: CommunicationRule[] = [
  ...
  },
  {
    ...
    approval: "Communications and subject-matter approval",
...
export default function AgentToolGovernancePlaygroundPage() {
  const [activeTab, setActiveTab] = useState<TabId>("overview");
  const [selectedAgentId, setSelectedAgentId] = useState(INITIAL_AGENTS[0].id);
  const [runName, setRunName] = useState("Agent authority validation run");
  ...
  const governedRecord = useMemo(() => ({
    ...
    changes,
    nonClaims: [
      "Agent identity does not prove that a specific action is correct or admissible.",
      ...
      "ALLOW in Agent & Tool Governance does not automatically produce ALLOW in another governance lane.",
    ],
  ...
  function resetWorkspace() {
    ...
    setRunName("Agent authority validation run");
  ...
  return (
    <main className="page-shell">
      ...
      <footer className="footer"><span>TA-14 Exchange Platform</span><strong>No admissible evidence. No admissible execution.</strong><span>Agent & Tool Governance · {VERSION}</span></footer>
      <style jsx>{`
