...
const STORAGE_KEY = "ta14-policy-controls-governance-playground-v5";
const VERSION = "PC-5.0";

const DETERMINATION_META: Record<Determination, { description: string; tone: string }> = {
  ALLOW: { description: "The exact controlled action may proceed only where policy authority, ownership, implementation, testing, monitoring, exception, and evidence conditions are satisfied.", tone: "#57e9b1" },
  ...
  DENY: { description: "The proposed action crosses a non-waivable policy mandate, control-owner authority, implementation, testing, exception, or execution boundary.", tone: "#ff6f7d" },
...
const TABS: Array<{ id: TabId; label: string; short: string }> = [
  ...
  { id: "registry", label: "Policy Registry", short: "02" },
  { id: "purpose", label: "Policy Intent & Scope", short: "03" },
  { id: "sources", label: "Control Ownership", short: "04" },
  { id: "lineage", label: "Control Mapping", short: "05" },
  { id: "transformation", label: "Implementation Control", short: "06" },
  { id: "transfers", label: "Exceptions", short: "07" },
  { id: "residency", label: "Testing & Attestation", short: "08" },
  { id: "monitoring", label: "Control Monitoring", short: "09" },
...
const INITIAL_DATASETS: DatasetRecord[] = [
  ...
  },
  {
    ...
    name: "Third-Party AI Control Standard",
    version: "2.3.7",
    stage: "Production",
  ...
  },
  {
    ...
    name: "Human Oversight Operating Policy",
    version: "5.1.0",
    stage: "Production",
  ...
  },
  {
    ...
    name: "Financial Execution Control Policy",
    version: "1.8.4",
    stage: "Restricted",
  ...
  },
  {
    ...
    name: "Security Containment Policy",
    version: "6.0.3",
    stage: "Production",
...
const INITIAL_SOURCES: SourceRecord[] = [
  {
    id: "source-crm-read",
    name: "Policy Repository Connector",
...
const COMMUNICATION_RULES: TransferRule[] = [
  ...
  },
  {
    ...
    approval: "Exceptions and subject-matter approval",
...
export default function DatasetSourceGovernancePlaygroundPage() {
  ...
  const governedRecord = useMemo(() => ({
    ...
    nonClaims: [
      ...
      "ALLOW in Policy & Controls Governance does not automatically produce ALLOW in another governance lane.",
    ],
    ...
    <main className="page-shell">
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <h1>Policy & Controls Governance</h1>
      ...
      <footer className="footer"><span>TA-14 Exchange Platform</span><strong>No admissible evidence. No admissible execution.</strong><span>Policy & Controls Governance · {VERSION}</span></footer>
      <style jsx>{`
