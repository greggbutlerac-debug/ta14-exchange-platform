...
function PartnerCard({ partner }: { partner: Partner }) {
  ...
  return (
    <article className="overflow-hidden rounded-[26px] border border-white/10 bg-white/[0.045] shadow-[0_24px_80px_rgba(0,0,0,0.24)] backdrop-blur-xl">
      <div className="p-6 sm:p-8">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <span className="rounded-full border border-amber-300/25 bg-amber-300/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-amber-200">
            {partner.status}
          </span>

          <span className="rounded-full border border-sky-300/20 bg-sky-300/10 px-3 py-1 text-xs font-medium text-sky-100">
            TA-14 second-layer review
          </span>
        </div>
      ...
      >
        <div className="overflow-hidden">
          <div className="border-t border-white/10 bg-slate-950/40 p-6 sm:p-8">
...
export default function PartnerReviewNetworkWorkspacePage() {
  return (
    <div className="px-5 py-8 sm:px-8 sm:py-10 lg:px-10 xl:px-12">
      <section className="mx-auto max-w-7xl">
        <div className="grid items-center gap-8 rounded-[30px] border border-white/10 bg-white/[0.045] p-6 shadow-[0_28px_90px_rgba(0,0,0,0.26)] backdrop-blur-xl sm:p-8 lg:grid-cols-[1.2fr_0.8fr] lg:p-10">
          <div>
          ...
          <div className="mx-auto w-full max-w-sm">
            <div className="rounded-[28px] border border-amber-200/20 bg-white/[0.05] p-4 shadow-[0_24px_80px_rgba(0,0,0,0.3)]">
              <img
                src="/images/ta-14-partner-review-network-emblem.png"
                alt="TA-14 Partner Review Network emblem"
                className="mx-auto aspect-square w-full rounded-[22px] object-contain"
              />
            </div>
          </div>
        </div>
      ...
      <section
        id="current-partners"
        className="mx-auto max-w-7xl scroll-mt-28 py-14 sm:py-16"
      >
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-8 text-slate-300">
            ...
            governance lens. Open any pathway to see what it reviews, what it
            contributes, and where its claims remain bounded.
          </p>
        </div>
      ...
      <section
        id="how-it-works"
        className="mx-auto max-w-7xl scroll-mt-28 rounded-[30px] border border-white/10 bg-white/[0.03] p-6 sm:p-8 lg:p-10"
      >
        <div className="max-w-3xl">
          <p className="text-sm font-bold uppercase tracking-[0.22em] text-amber-200">
            How the network works
        ...
        <div className="mt-10 rounded-[26px] border border-sky-300/20 bg-sky-300/[0.06] p-7 sm:p-8">
          ...
          <p className="mt-5 max-w-4xl text-base leading-8 text-slate-300">
            A partner may provide a strong specialized review layer. TA-14 asks
            the broader question: was the consequence-bearing route admissible
            enough for execution to proceed?
          </p>
        </div>
      </section>

      <section className="mx-auto max-w-5xl py-14 text-center sm:py-16">
        <p className="text-sm font-bold uppercase tracking-[0.22em] text-amber-200">
          Network principle
        </p>
        ...
        <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-300">
          ...
          preserves independence, review boundaries, evidence discipline, and
          second-layer scrutiny before stronger claims are made.
        </p>
      </section>
    </div>
  );
