...
const sections = [
  ...
  ['13', 'Founding Demonstration engagement and institutional-labor boundary', [
    'A no-cost Founding Demonstration is a bounded institutional examination, not an open-ended advisory, development, reconciliation, publication, or continuing-assurance relationship.',
    'Unless TA-14 expressly constitutes otherwise in writing, a Founding Demonstration is limited to one registered and frozen governance object, one frozen proposition and examination scope, a defined evidence submission and reconciliation cycle, one bounded examination, and one institutional disposition or closure state.',
    'Participant-side delay, architecture modification, successor development, new repositories, new governance registrations, role or participant changes, changed evidence surfaces, or unrelated development activity do not automatically extend, restart, or enlarge the original Founding Demonstration.',
    'TA-14 is not obligated to reconstruct a stale, abandoned, materially changed, or historically fragmented examination so that later development can be made to fit the original chain. Where changed conditions defeat the cleanliness of the original examination object or authority chain, TA-14 may require a new reality, new frozen object, new proposition, new participants, and a new examination chain.',
    'A participant with an unfinished Founding Demonstration may not presume entitlement to another no-cost Founding Demonstration. Any additional or concurrent no-cost examination requires TA-14\'s express institutional authorization.',
    'Successor examinations, additional propositions, repeated or substantial reconciliation, additional Technical Freeze work outside the constituted scope, continuing assurance, surveillance, substantial publication or showcase work, or other expanded institutional services may require a separate written engagement and may be offered on commercial terms.',
    'TA-14 may close an examination without an adverse finding where elapsed time, changed conditions, accumulated dependencies, participant or role changes, evidence drift, unresolved authority, or institutional complexity makes continuation of the original chain no longer sufficiently clean or bounded. Such closure does not manufacture PASS, FAIL, fault, or adverse inference.',
    'Closure preserves the record of what was actually established, including supported propositions, unresolved conditions, participant returns, limitations, and the absence of execution or finding where applicable. Later work must not silently rewrite that historical state.'
  ]],
  ['14', 'Special terms', [
