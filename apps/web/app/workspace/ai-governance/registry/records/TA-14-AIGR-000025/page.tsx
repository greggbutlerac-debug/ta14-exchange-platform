  ...
  return <main style={{minHeight:'100vh',background:'radial-gradient(circle at 15% 0%,rgba(28,83,139,.24),transparent 30%),radial-gradient(circle at 90% 8%,rgba(213,167,75,.13),transparent 26%),linear-gradient(180deg,#020813,#06111e 48%,#020710)',color:'#f3f6f9',padding:'64px 20px'}}>
    <div style={{width:'min(1040px,100%)',margin:'0 auto'}}>
      ...
      <div style={{marginTop:38,border:'1px solid rgba(213,167,75,.28)',borderRadius:28,background:'linear-gradient(135deg,rgba(8,26,45,.92),rgba(4,15,27,.98))',padding:'clamp(28px,6vw,58px)',boxShadow:'0 28px 90px rgba(0,0,0,.3)'}}>
        ...
        <section style={{marginTop:30,border:'1px solid rgba(105,239,179,.28)',borderRadius:18,padding:22,background:'linear-gradient(135deg,rgba(21,79,61,.28),rgba(7,22,31,.62))'}}><div style={{color:'#7aefba',fontSize:11,fontWeight:800,letterSpacing:'.14em',textTransform:'uppercase',marginBottom:9}}>Governed Demonstration · Open</div><h2 style={{margin:'0 0 10px',fontSize:25}}>COBIT-Chain Azure MCP Gateway R1</h2><p style={{margin:'0 0 12px',color:'#c3d7ce',fontSize:15,lineHeight:1.75}}>Current TA-14 draft finding: <strong style={{color:'#83efbd'}}>SUPPORTED - BOUNDED PASS</strong>. The admitted participant evidence supports bounded execution containment and restraint for the tested R1 condition. Catalog correspondence remains <strong style={{color:'#ffd477'}}>NOT ESTABLISHED</strong>, participant factual review is pending, and the case remains open.</p><p style={{margin:'0 0 18px',color:'#8fa9b9',fontSize:13,lineHeight:1.65}}>This is a controlled demonstration state, not a closed case, certification, endorsement, or final participant-approved finding.</p><Link href="/artifacts/vsa-cobit-chain-r1" style={{display:'inline-flex',alignItems:'center',minHeight:46,padding:'0 16px',borderRadius:11,textDecoration:'none',fontWeight:800,background:'linear-gradient(135deg,#69efb3,#2e9d73)',color:'#03130e'}}>Open Governed Demonstration →</Link></section>
