...
export const metadata: Metadata = {
  title: 'Governance Professionals Marketplace',
  description:
    'Explore governance architects, reviewers, record stewards, verifiers, and domain specialists inside the TA-14 AI Governance Exchange Marketplace.',
};
...
const professionals = [
  {
    ...
    summary:
      'Designs consequential execution routes, authority boundaries, evidence requirements, challenge states, and replay cases.',
    domains: [
      'AI Governance',
      'Financial Execution',
  ...
  },
  {
    ...
    summary:
      'Structures attributable environmental records, contributor roles, continuity controls, and bounded interpretation workflows.',
    domains: [
    ...
    evidence: [
      ...
      'Availability declaration current',
    ],
  },
  {
    slug: 'nina-patel',
    ...
    evidence: [
      ...
      'Independence declaration current',
      'Review summaries logged',
    ],
  },
  {
    slug: 'jonas-reed',
    name: 'Jonas Reed',
    initials: 'JR',
    title: 'Execution Verification Specialist',
    organization: 'Replay Integrity Lab',
    location: 'Germany',
    availability: 'AVAILABLE',
    verification: 'IDENTITY VERIFIED',
    summary:
      'Tests route packages, evidence dependencies, signatures, digests, commit integrity, and execution-to-outcome correspondence.',
    domains: [
      'Replay Verification',
  ...
  },
  {
    ...
    name: 'Ava Morales',
    initials: 'AM',
    title: 'Healthcare Environmental Governance Specialist',
    organization: 'Clinical Environment Review Group',
    location: 'United States',
    availability: 'INVITATION ONLY',
    verification: 'ORGANIZATION VERIFIED',
    summary:
      'Defines healthcare environmental record boundaries, contributor permissions, interpretation limits, and clinical non-diagnosis controls.',
    domains: [
    ...
    evidence: [
      ...
      'Clinical boundary declaration current',
    ],
  },
  {
    slug: 'samir-bose',
    name: 'Samir Bose',
    initials: 'SB',
    title: 'Authority and Commit Governance Architect',
    organization: 'Bose Consequence Systems',
    location: 'Singapore',
    availability: 'AVAILABLE',
    verification: 'IDENTITY VERIFIED',
    summary:
      'Separates identity, standing, authority, binding, commit, execution, and outcome across consequential workflows.',
    domains: [
      'Authority Governance',
      'Commit Integrity',
...
const roleTypes = [
  {
    ...
    description:
      'Designs the route, roles, evidence gates, authority states, decisions, challenges, and proof boundaries.',
  },
  {
    title: 'Record Steward',
    description:
      'Maintains source identity, continuity, permissions, versions, corrections, and preservation.',
  },
  {
    title: 'Independent Reviewer',
    description:
      'Examines architecture, claims, evidence, gaps, conflicts, and scope without owning execution.',
  },
  {
    title: 'Verifier',
    description:
      'Tests declared integrity, dependencies, signatures, replay cases, and route correspondence.',
  },
  {
    title: 'Domain Specialist',
    description:
      'Contributes bounded subject-matter interpretation without silently taking governance authority.',
  },
  {
    title: 'Challenge Specialist',
    description:
      'Builds adversarial, missing-evidence, stale-evidence, and conflicting-authority test cases.',
  },
];
...
export default function MarketplaceProfessionalsDirectoryPage() {
  return (
    <main className="professionalsPage">
      ...
      <section className="heroSection">
        <div className="pageShell">
          ...
          <div className="heroGrid">
            <div>
              <span className="kicker">GOVERNANCE PROFESSIONALS</span>
              <h1>Find people by preserved work, not popularity.</h1>
              <p className="heroLead">
                Explore governance architects, independent reviewers, record
                stewards, verifiers, and domain specialists through attributable
                qualifications, governed artifacts, review history, replay
                results, continuity evidence, and declared boundaries.
              </p>
              ...
              <div className="boundaryNotice">
                <AlertIcon />
                <span>
                  This is the professional directory architecture. Live profile
                  creation, credential upload, identity verification, contact
                  requests, messaging, contracting, payment, and reputation
            ...
            <aside className="heroPanel">
              <div className="heroPanelHeader">
                ...
                <strong>Professional standing should be reviewable.</strong>
              </div>

              {[
                ['Identity', 'Who is making the claim'],
                ['Qualifications', 'What competence is declared'],
                ['Artifacts', 'What work has been preserved'],
                ['Reviews', 'What independent examination occurred'],
                ['Replay', 'What test cases can be repeated'],
                ['Boundaries', 'What remains unproven'],
        ...
        <div className="pageShell">
          <div className="sectionHeading">
            <div>
              ...
              <h2>Different work requires different authority.</h2>
            </div>
            <p>
              Architecture, evidence stewardship, domain interpretation,
              independent review, verification, and execution should not be
              collapsed into one undefined role.
            </p>
          </div>
      ...
      <section className="sectionBlock" id="directory">
        <div className="pageShell">
          <div className="sectionHeading">
            <div>
              <span className="kicker">PROFESSIONAL DIRECTORY</span>
              <h2>Review declared competence and preserved evidence.</h2>
            </div>
            <p>
              Each profile distinguishes self-declared qualifications,
              identity verification, organization verification, reviewed work,
              replay outcomes, availability, and proof boundaries.
            </p>
          </div>

          <div className="filterBar" aria-label="Professional filters">
            <label>
              <span>Search professionals</span>
              <input
                type="search"
                placeholder="Search by name, role, domain, or qualification"
                disabled
              />
            </label>
            ...
            <label>
              ...
              <select defaultValue="all" disabled>
                ...
                <option value="architect">Governance architect</option>
                <option value="steward">Record steward</option>
                <option value="reviewer">Independent reviewer</option>
                <option value="verifier">Verifier</option>
                <option value="domain">Domain specialist</option>
              </select>
            </label>
            ...
            {professionals.map((professional) => (
              <article className="professionalCard" key={professional.slug}>
                ...
                <div className="professionalMeta">
                  ...
                  <span className="availabilityBadge">
                    {professional.availability}
                  </span>
                </div>

                <p className="professionalSummary">{professional.summary}</p>
                ...
                <div className="statsGrid">
                  {professional.stats.map(([value, label]) => (
                    <div key={label}>
                      <strong>{value}</strong>
                      <span>{label}</span>
                    </div>
                ...
                <div className="evidenceList">
                  <span>Preserved profile evidence</span>
                  {professional.evidence.map((item) => (
                    <div key={item}>
                      <CheckIcon />
                      <small>{item}</small>
                    </div>
                ...
                <div className="cardActions">
                  <Link
                    ...
                    href={`/marketplace/professionals/${professional.slug}`}
                  >
      ...
      <section className="sectionBlock sectionTint">
        <div className="pageShell proofGrid">
          <div>
            <span className="kicker">PROFILE STATES</span>
            <h2>Verification must remain specific.</h2>
            <p>
              A visible badge must state exactly what was checked. Identity,
              organization, chronology, qualification, portfolio, independent
              review, and route performance are different claims.
            </p>
          </div>

          <div className="proofStates">
            {[
              ['DECLARED', 'The professional supplied the claim.'],
              ['IDENTITY VERIFIED', 'The person’s identity was checked.'],
              ['ORGANIZATION VERIFIED', 'The organization relationship was checked.'],
              ['DOCUMENTED', 'Supporting evidence or artifacts were provided.'],
              ['INDEPENDENTLY REVIEWED', 'A separate reviewer examined a declared scope.'],
              ['VERIFIED', 'A specific test or integrity check passed.'],
      ...
      <section className="sectionBlock">
        <div className="pageShell engagementPanel">
          <div>
            ...
            <h2>Contact begins with a declared problem, not an empty message.</h2>
            <p>
              The connected workflow will require the requester to declare the
              governance need, intended scope, evidence available, budget,
              timing, visibility, conflicts, and expected deliverable before a
              professional receives the request.
            </p>
          ...
          <div className="engagementAction">
            ...
            <button type="button" disabled>
              Start governed contact request
            </button>
            <small>
      ...
      <section className="finalSection">
        <div className="pageShell finalPanel">
          <div>
            ...
            <h2>Reputation should follow evidence, review, and preserved work.</h2>
            <p>
              The TA-14 AI Governance Exchange Marketplace separates popularity
              from competence and competence from proof.
            </p>
          </div>
      ...
      <style>{`
        ...
        * {
        ...
        .heroPanelRow {
          display: grid;
          grid-template-columns: 34px minmax(92px, auto) 1fr;
          gap: 12px;
          align-items: center;
          padding: 13px 0;
        ...
        .professionalHeader h3 {
          margin: 9px 0 4px;
          font-size: 1.4rem;
        }

        .professionalHeader p {
          margin: 0;
          color: var(--muted);
          font-size: 0.79rem;
          line-height: 1.45;
