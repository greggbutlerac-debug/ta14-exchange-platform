...
export default function PaidPlanRail(){
  return <section className="paidRail" aria-labelledby="paid-plan-heading">
    ...
    <div className="paidReview"><div><b>Need an independent human readiness examination?</b><span>A governed readiness review is separate from software access and starts at $750.</span></div><Link href="/eu-ai-act/readiness-review">START $750 READINESS REVIEW →</Link></div>
