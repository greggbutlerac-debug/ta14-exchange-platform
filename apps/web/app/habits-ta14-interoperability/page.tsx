...
export default function Page(){
 ...
 return <main className="page"><div className="wrap">
  ...
  <section><p className="eyebrow">PROPOSED JOINT FREEZE</p><h2>What we would freeze before a formal examination.</h2>
   <div className="chain">{["EXECUTION SCENARIO","PROPOSED CONSEQUENCE","OBSERVATION PATH","MATERIALITY TEST","GOVERNING PREDICATES","HABITS UAB + ENFORCEMENT","INTERFACE OBJECT / STATE","TA-14 RESPONSIBILITY","UNKNOWN / REVALIDATION BRANCHES","NON-BYPASSABILITY TEST"].map(x=><span key={x}>{x}</span>)}</div>
  </section>
