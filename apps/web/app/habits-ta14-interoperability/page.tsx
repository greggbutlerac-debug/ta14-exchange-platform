...
function EnforcementContractLab(){
 ...
 const cases:Record<ContractCase,{habits:string;ta14:string;iface:string;release:string;why:string}>={
  "both":{habits:"CURRENT · UAB: ALLOW",ta14:"CURRENT · ALLOW",iface:"VERIFIED + CURRENT",release:"RELEASE ELIGIBLE · FINAL CHECK REQUIRED",why:"Both independently required determinations and the interface object/state have current standing. Release eligibility is not release. Current standing must be checked again at the final release boundary. Eligibility is limited to the exact jointly examined path and does not prove wider non-bypassability."},
  "habits-refuse":{habits:"CURRENT · REFUSE",ta14:"CURRENT · ALLOW",iface:"VERIFIED + CURRENT",release:"NO RELEASE · UAB: REFUSE",why:"TA-14 ALLOW cannot route around UAB: REFUSE. A positive result from one architecture is not the other's permission."},
  "ta14-hold":{habits:"CURRENT · UAB: ALLOW",ta14:"CURRENT · HOLD",iface:"VERIFIED + CURRENT",release:"NO RELEASE · TA-14 HOLD",why:"UAB: ALLOW cannot route around TA-14 HOLD on the jointly examined path."},
  ...
  "ta14-stale":{habits:"CURRENT · UAB: ALLOW",ta14:"STALE",iface:"VERIFIED + CURRENT",release:"NO RELEASE · STALE DETERMINATION",why:"A stale TA-14 determination cannot be treated as present authority for consequence."},
  "missing":{habits:"CURRENT · UAB: ALLOW",ta14:"ABSENT",iface:"INCOMPLETE",release:"NO RELEASE · REQUIRED STATE ABSENT",why:"Absence is not permission. The release boundary remains closed until the required determination exists and is attributable to the same jointly examined state."},
  "unverifiable":{habits:"CURRENT · UAB: ALLOW",ta14:"CURRENT · ALLOW",iface:"UNVERIFIABLE",release:"NO RELEASE · INTERFACE NOT ESTABLISHED",why:"Two positive determinations cannot establish release if the object/state connecting them cannot itself be verified."},
  "changed":{habits:"CURRENT · UAB: ALLOW",ta14:"CURRENT · ALLOW",iface:"MATERIAL STATE CHANGED",release:"NO RELEASE · REVALIDATION REQUIRED",why:"A material change before irreversible release invalidates reliance on the prior release-eligible state. The changed state must be re-evaluated."}
 };
 const x=cases[test];
 ...
 return <main className="page"><div className="wrap">
  ...
  <div className="objectGrid">
   {[
    ...
    ["07","INTERFACE OBJECT / STATE","OPEN · JOINT DEFINITION"],
    ["08","TA-14 DETERMINATION STATE","ALLOW / HOLD / DENY / ESCALATE"],
    ["09","RELEASE ELIGIBILITY","NOT ACTUAL RELEASE"],
    ["10","COMPONENT HOLDING FINAL RELEASE","OPEN · JOINT DEFINITION"],
    ["11","FINAL CURRENT-STANDING CHECK","REQUIRED AT RELEASE BOUNDARY"],
    ["12","CONTINUED PREVENTION CONDITIONS","STALE · ABSENT · UNVERIFIABLE · CONFLICT · UNKNOWN · MATERIAL CHANGE"]
