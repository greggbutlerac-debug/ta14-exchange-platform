    ...
    <main style={{ background: '#f7fbfc', color: '#102f3d', minHeight: '100vh' }}>
      ...
      <header className="ta-hero">
        <div className="ta-wrap ta-grid">
          <div>
            ...
            <div className="ta-phone-row">
              <a className="ta-btn" href={PRIMARY_PHONE_HREF}>Call {PRIMARY_PHONE_DISPLAY}</a>
              <a className="ta-alt-phone" href={SECONDARY_PHONE_HREF}>Or {SECONDARY_PHONE_DISPLAY}</a>
            </div>
          ...
          <aside className="ta-card">
            ...
            <div className="ta-phone-row">
              <a className="ta-btn secondary" href={PRIMARY_PHONE_HREF}>Call {PRIMARY_PHONE_DISPLAY}</a>
              <a className="ta-alt-phone" href={SECONDARY_PHONE_HREF}>{SECONDARY_PHONE_DISPLAY}</a>
            </div>
          </aside>
        </div>
      </header>
      ...
      <section className="ta-section alt">
        <div className="ta-wrap">
          ...
          <p>For visitors who want the educational foundation, the TA-14 Academy HVAC section explains why baseline evidence, diagnostic determination, governed intervention, and post-intervention performance matter.</p>
          <Link className="ta-academy" href="/academy/hvac">Explore the TA-14 Academy HVAC Section →</Link>
        </div>
      </section>
      ...
      <section className="ta-section ta-center">
        <div className="ta-wrap">
          ...
          <div className="ta-phone-row" style={{ justifyContent: 'center' }}>
            <a className="ta-btn" href={PRIMARY_PHONE_HREF}>Call {PRIMARY_PHONE_DISPLAY}</a>
            <a className="ta-alt-phone" style={{ color: '#0a5560', borderColor: '#aacfd3' }} href={SECONDARY_PHONE_HREF}>Or {SECONDARY_PHONE_DISPLAY}</a>
          </div>
        </div>
      </section>
      ...
      <footer className="ta-footer">
        <div className="ta-wrap">
          ...
          AC diagnostics and second opinions for selected Pinellas County service areas.<br />
          <a href={PRIMARY_PHONE_HREF} style={{ color: '#ffffff' }}>{PRIMARY_PHONE_DISPLAY}</a> · <a href={SECONDARY_PHONE_HREF} style={{ color: '#ffffff' }}>{SECONDARY_PHONE_DISPLAY}</a>
          <p className="ta-small" style={{ color: '#a9c0c6' }}>TA-14 is a diagnostic/governance methodology and is not an occupational license or government certification. Local service availability, pricing, and contractor/license information should be verified before public promotion.</p>
        </div>
      </footer>
