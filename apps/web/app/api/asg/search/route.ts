...
export async function POST(req:NextRequest){
  ...
  try{
    ...
    return NextResponse.json({schema:"ta14.asg.runtime-record.v0.2",recordId,request,profile,engineVersion:ASG_ENGINE_VERSION,profileVersion:ASG_PROFILE_VERSION,state:"HOLD",reasonCode:notConfigured?"PROVIDER_CANDIDATE_SET_UNAVAILABLE":"PROVIDER_ERROR",explanation:notConfigured?"The request is preserved, but the live Google-results provider API key is not configured. TA-14 will not manufacture provider candidates.":"The provider did not establish a candidate set. No delivery commit occurred.",provider:"GOOGLE_VIA_SERPER",providerLive:false,frozenProviderCandidates:[],candidates:[],deliveryCommit:{candidateRanks:[],deliveredCount:0,delivered:[]},admittedRecord:null,nonAdmittedRecord:null},{status:notConfigured?503:502});
  }
}
