...
export const metadata: Metadata = {
  ...
  keywords: [
    'TA-14', 'Admissible Execution', 'AI Governance', 'EU AI Act compliance',
    'EU AI Act governance', 'AI compliance evidence', 'AI system governance',
    'Execution Governance', 'Evidence Integrity', 'Admissible Execution Record',
    'AER', 'Runtime Governance', 'Authority Governance', 'Consequential Execution',
  ...
  openGraph: {
    ...
    description: 'Every consequence has a route. TA-14 proves whether it should exist.',
    images: [{ url: '/ta14-social-preview.png', width: 1200, height: 630, alt: 'TA-14 Authority Governance Institution' }],
  },
  twitter: {
...
export const viewport: Viewport = {
  ...
  themeColor: [
    { media: '(prefers-color-scheme: light)', color: '#03060b' },
    { media: '(prefers-color-scheme: dark)', color: '#03060b' },
  ],
  colorScheme: 'dark',
};
