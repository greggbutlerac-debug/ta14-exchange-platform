...
export default function ServiceCallHold(){
 ...
 {!started?<section className="intro"><div className="kicker">EIGHT24 SOLUTIONS HVAC TECHNICIAN DECISION ARCADE</div><h1>SERVICE CALL:<br/><em>HOLD</em></h1><p>You already know how to move fast. This game tests whether you know when <strong>not</strong> to move. Establish reality. Preserve the record. Earn the right to intervene.</p><button onClick={()=>setStarted(true)}>ACCEPT DISPATCH →</button><div className="rule">NO ADMISSIBLE EVIDENCE. NO ADMISSIBLE EXECUTION.</div></section>:
