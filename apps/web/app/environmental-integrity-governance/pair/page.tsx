...
export default function PairWorld(){
  return <main className="pairPage">
    ...
    <ConsequenceLab eyebrow="PAIR™ · CONTINUITY LAB" title="Move the person. Change the atmosphere. Test whether the record still stands." intro="PAIR preserves a person-centered chronology across changing environments. Break provenance, continuity, currentness or target binding and watch the modeled reliance determination change without turning atmospheric evidence into medical diagnosis." actionLabel="BREAK ONE RECORD CONDITION →" allowReason="The modeled atmospheric record remains attributable, continuous and current for bounded environmental reliance. This does not establish medical diagnosis or intervention authority." conditions={[
{id:'source',label:'SOURCE / INSTRUMENT',question:'Is the measurement source identified with usable provenance?',healthy:'ATTRIBUTABLE',failed:'UNKNOWN',failure:'HOLD',failureReason:'The atmospheric measurement is no longer sufficiently attributable.'},
{id:'continuity',label:'CONTINUITY',question:'Are transitions and gaps preserved rather than silently repaired?',healthy:'PRESERVED',failed:'GAP UNRESOLVED',failure:'HOLD',failureReason:'A continuity gap prevents the record from silently carrying standing forward.'},
{id:'current',label:'CURRENTNESS',question:'Does the record still describe the person’s present environmental context?',healthy:'CURRENT',failed:'STALE',failure:'HOLD',failureReason:'The person or atmosphere changed; the earlier record requires revalidation.'},
{id:'binding',label:'BOUND RELIANCE',question:'Is the proposed reliance bounded to what the environmental evidence can support?',healthy:'BOUNDED',failed:'OVERCLAIMED',failure:'DENY',failureReason:'The proposed reliance exceeds what the atmospheric evidence establishes.'}
]} />
