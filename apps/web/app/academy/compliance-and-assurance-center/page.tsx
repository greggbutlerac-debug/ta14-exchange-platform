...
/*
 * TA-14 Academy Compliance and Assurance Center
 * Governing principle: No admissible evidence. No admissible execution.
 * Production workspace for regulatory compliance, internal controls, assurance review, CAPA,
 * continuous monitoring and improvement, evidence preservation, risk, and executive reporting.
 */
...
type WorkspaceState = {
  schema: "TA14_ACADEMY_COMPLIANCE_ASSURANCE_V1";
...
const STORAGE_KEY = "ta14-academy-compliance-assurance-center-v1";
...
const seedProgram: ProgramProfile[] = [
  ...
  },
  {
    ...
    title: "Compliance and Assurance Coordinator",
...
const seedCompetencies: Competency[] = [
  ...
  },
  {
    ...
    requiredLevel: "LEAD",
    evidenceStandard: "Compliance review packet and governance board finding.",
    revalidationMonths: 12,
  },
];
...
const seedImprovements: ImprovementPlan[] = [
  {
    ...
    opened: "2026-04-05",
    due: "2026-07-25",
    owner: "Compliance and Assurance Committee",
...
const seedAudit: AuditEvent[] = [
  {
    ...
    actor: "Compliance and Assurance Committee",
...
function validateWorkspace(value: unknown): value is WorkspaceState {
  ...
  return (
    candidate.schema === "TA14_ACADEMY_COMPLIANCE_ASSURANCE_V1" &&
...
function PlanModal({ program, selectedProgramId, onClose, onSave }: { program: ProgramProfile[]; selectedProgramId: string; onClose: () => void; onSave: (plan: SuccessPlan) => void }) {
  ...
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("PLN"), programId, title, cycle: "2026 Development Cycle", status: "DRAFT", priority: "MEDIUM", owner: "Compliance and Assurance Committee", start: today(), due, progress: 0, objectives: [objective], successMeasures: ["Objective supported by preserved evidence"], dependencies: ["Program and supervisor review"], risks: [], lastUpdate: today() }); }
...
function ImprovementModal({ program, onClose, onSave }: { program: ProgramProfile[]; onClose: () => void; onSave: (plan: ImprovementPlan) => void }) {
  ...
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("IMP"), programId, title, trigger, status: "OPEN", priority: "HIGH", opened: today(), due, owner: "Compliance and Assurance Committee", actions: ["Complete bounded review with program member"], checkpoints: ["Initial evidence review", "Midpoint check", "Final determination"], progress: 0, determination: "HOLD" }); }
