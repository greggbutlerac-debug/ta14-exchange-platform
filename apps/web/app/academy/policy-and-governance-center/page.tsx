...
/*
 * TA-14 Academy Policy and Governance Center
 * Governing principle: No admissible evidence. No admissible execution.
 * Production workspace for institutional policy authoring, review, authority delegation,
 * exceptions, acknowledgments, impact analysis, evidence preservation, and executive reporting.
 */
...
type WorkspaceState = {
  schema: "TA14_ACADEMY_POLICY_AND_GOVERNANCE_V1";
...
const STORAGE_KEY = "ta14-academy-policy-and-governance-center-v1";
...
const seedProgram: ProgramProfile[] = [
  {
    ...
    notes: "Primary program lead for architecture and authority curriculum.",
  },
  {
    id: "FAC-002",
    name: "Jordan Ellis",
  ...
  },
  {
    ...
    title: "Policy and Governance Coordinator",
    ...
    goals: ["Institutionalize advisoring review", "Publish annual policy governance report"],
...
const seedCompetencies: Competency[] = [
  ...
  },
  {
    ...
    requiredLevel: "LEAD",
    evidenceStandard: "Quality review packet and governance board finding.",
    revalidationMonths: 12,
  },
];
...
const seedPlans: SuccessPlan[] = [
  {
    id: "PLN-001",
    programId: "FAC-001",
    title: "2026 Program Success Plan \u2014 Dr. Mara Voss",
  ...
  },
  {
    id: "PLN-002",
    programId: "FAC-002",
    title: "2026 Program Success Plan \u2014 Jordan Ellis",
    cycle: "2026 Annual Cycle",
    status: "AT_RISK",
    priority: "CRITICAL",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-003",
    programId: "FAC-003",
    title: "2026 Program Success Plan \u2014 Priya Nand",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-004",
    programId: "FAC-004",
    title: "2026 Program Success Plan \u2014 Mateo Ruiz",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-005",
    programId: "FAC-005",
    title: "2026 Program Success Plan \u2014 Amina Cole",
    cycle: "2026 Annual Cycle",
    status: "PAUSED",
    priority: "HIGH",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-006",
    programId: "FAC-006",
    title: "2026 Program Success Plan \u2014 Daniel Cho",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-007",
    programId: "FAC-007",
    title: "2026 Program Success Plan \u2014 Selene Brooks",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "HIGH",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-008",
    programId: "FAC-008",
    title: "2026 Program Success Plan \u2014 Owen Hart",
    cycle: "2026 Annual Cycle",
    status: "DRAFT",
    priority: "HIGH",
    owner: "Daniel Cho",
...
const seedActivities: LearningActivity[] = [
  {
    ...
    description: "Structured policy governance activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-002",
...
const seedImprovements: ImprovementPlan[] = [
  {
    ...
    opened: "2026-04-05",
    due: "2026-07-25",
    owner: "Policy and Governance Committee",
...
const seedAudit: AuditEvent[] = [
  {
    ...
    actor: "Policy and Governance Committee",
...
function validateWorkspace(value: unknown): value is WorkspaceState {
  ...
  return (
    candidate.schema === "TA14_ACADEMY_POLICY_AND_GOVERNANCE_V1" &&
...
const tabs: { key: TabKey; label: string; description: string }[] = [
  { key: "overview", label: "Governance Overview", description: "Institutional policy posture" },
  { key: "success-plans", label: "Policy Review Cycles", description: "Review dates, approvals, and policy risk" },
  { key: "competencies", label: "Governance Requirements", description: "Authority, applicability, and evidence" },
  { key: "catalog", label: "Consultation Register", description: "Consultations, notices, and stakeholder input" },
  { key: "pathways", label: "Governance Frameworks", description: "Frameworks, standards, and policy hierarchy" },
  { key: "advising", label: "Authority Delegations", description: "Delegated authority and role boundaries" },
  { key: "observations", label: "Impact Assessments", description: "Change impact, applicability, and affected parties" },
  { key: "portfolio", label: "Policy Library", description: "Controlled policies, procedures, and guidance" },
  { key: "improvement", label: "Exceptions and Waivers", description: "Waivers, exceptions, conditions, and expiry" },
  { key: "readiness", label: "Governance Readiness", description: "Evidence-bound policy readiness scoring" },
  { key: "evidence", label: "Policy Evidence Repository", description: "Sources, approvals, hashes, and limitations" },
  { key: "reports", label: "Reports", description: "Policy analysis, acknowledgments, and export" },
  { key: "audit", label: "Audit Timeline", description: "Attributable action history" },
];

export default function PolicyAndGovernanceCenterPage() {
  ...
  function exportJson() {
    ...
    addAudit("WORKSPACE_EXPORTED", "Policy and Governance Center", "ALLOW", "Exported complete JSON workspace.");
  ...
  async function importWorkspace(event: ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      setToast("Import denied: file does not match the Policy and Governance schema.");
    } finally {
      event.target.value = "";
    }
  }
  ...
  function resetWorkspace() {
    if (!window.confirm("Reset the Policy and Governance Center to its institutional seed state?")) return;
    ...
    <main style={styles.page}>
      ...
      <header style={styles.header}>
        <div>
          ...
          <h1 style={styles.title}>Policy and Governance Center</h1>
          <p style={styles.subtitle}>
            Govern policy evolution through preserved drafts, evidence-bound authority, consultation,
            impact analysis, controlled exceptions, and challengeable approval determinations.
          </p>
        </div>
      ...
      <section style={styles.canonBanner}>
        ...
        <span>
          Development activity does not itself create learning authority. Governance Readiness must remain tied to
      ...
      <section style={styles.workspaceShell}>
        ...
        <div style={styles.content}>
          <div style={styles.toolbar}>
            ...
            <button style={styles.buttonPrimary} onClick={() => setModal("program")}>New program record</button>
          </div>
        ...
        <section style={styles.detailRail}>
          ...
          <div style={styles.detailGrid}>
            <DetailCard title="Development posture" lines={[
              ...
              `Course load: ${selectedProgram.courseLoad}%`,
      ...
      {modal === "program" && <ProgramModal onClose={() => setModal(null)} onSave={(member) => { setWorkspace((current) => ({ ...current, program: [member, ...current.program] })); setSelectedProgramId(member.id); setModal(null); setToast("Program record created."); }} />}
...
function ActivityModal({ competencies, onClose, onSave }: { competencies: Competency[]; onClose: () => void; onSave: (activity: LearningActivity) => void }) {
  ...
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("ACT"), title, provider: "TA-14 Academy", category, format: "WORKSHOP", status: "PLANNED", start: today(), end: today(), hours, seats: 12, enrolled: [], competencyIds: [competencyId], facilitator: "To be assigned", description: "New policy governance activity pending facilitator and evidence-plan review." }); }
...
function ObservationModal({ program, onClose, onSave }: { program: ProgramProfile[]; onClose: () => void; onSave: (observation: Observation) => void }) {
  const [programId, setProgramId] = useState(program[0]?.id ?? ""); const [course, setCourse] = useState(""); const [reviewer, setReviewer] = useState(""); const [date, setDate] = useState(today());
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("OBS"), programId, reviewer, course, date, status: "SCHEDULED", score: 0, strengths: [], findings: [], requiredActions: [], evidenceIds: [] }); }
  return <ModalShell title="Schedule peer observation" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Program"><select style={styles.input} value={programId} onChange={(e) => setProgramId(e.target.value)}>{program.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Course"><input required style={styles.input} value={course} onChange={(e) => setCourse(e.target.value)} /></Field><Field label="Reviewer"><input required style={styles.input} value={reviewer} onChange={(e) => setReviewer(e.target.value)} /></Field><Field label="Date"><input type="date" style={styles.input} value={date} onChange={(e) => setDate(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Schedule</button></div></form></ModalShell>;
}
