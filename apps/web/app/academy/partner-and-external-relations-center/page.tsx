...
/*
 * TA-14 Academy Partner and External Relations Center
 * Governing principle: No admissible evidence. No admissible execution.
 * Production workspace for partner directories, MOUs, external advisory boards, joint programs, opportunity intake,
 * engagement evidence, partner capability, relationship performance, renewal, risk, and executive reporting.
 */
...
type CapabilityLevel = "FOUNDATIONAL" | "PRACTITIONER" | "ADVANCED" | "LEAD";
type ModalKey = "partners" | "plan" | "activity" | "partner-review" | "evidence" | "remediation" | null;
...
type WorkspaceState = {
  schema: "TA14_ACADEMY_PARTNER_EXTERNAL_RELATIONS_V1";
  partners: PartnerProfile[];
  plans: EngagementPlan[];
  competencies: Capability[];
  capabilityRecords: CapabilityRecord[];
  activities: EngagementActivity[];
  pathways: EngagementPathway[];
  advisoryRelationships: AdvisoryRelationship[];
  partnerReviews: PartnerReview[];
  portfolio: AgreementRecord[];
  improvements: RemediationPlan[];
  evidence: EvidenceRecord[];
  audit: AuditEvent[];
};

const STORAGE_KEY = "ta14-academy-partner-external-relations-center-v1";
...
const seedPartner: PartnerProfile[] = [
  {
    id: "FAC-001",
    name: "Dr. Mara Voss",
    email: "mara.voss@academy.example",
    title: "Lead Governance Advisor",
    partners: "Admissible Execution",
    status: "ACTIVE",
    readiness: 96,
    engagementLoad: 72,
    engagementHours: 31,
    ...
    notes: "Primary partners lead for architecture and authority partnership portfolio.",
  },
  {
    id: "FAC-002",
    name: "Jordan Ellis",
    email: "jordan.ellis@academy.example",
    title: "Technical Partnership Portfolio Advisor",
    partners: "HVAC Evidence Systems",
    status: "REVIEW",
    readiness: 81,
    engagementLoad: 88,
    engagementHours: 18,
    engagementTarget: 30,
    relationshipLeadId: "FAC-001",
    joined: "2026-01-15",
  ...
  },
  {
    ...
    partners: "Partnership Governance",
    status: "ACTIVE",
    readiness: 92,
    engagementLoad: 61,
    engagementHours: 27,
  ...
  },
  {
    ...
    partners: "Applied Governance Labs",
    status: "ACTIVE",
    readiness: 87,
    engagementLoad: 67,
    engagementHours: 24,
    engagementTarget: 30,
    relationshipLeadId: "FAC-003",
    joined: "2026-02-20",
  ...
  },
  {
    ...
    partners: "Environmental Integrity",
    status: "LEAVE",
    readiness: 74,
    engagementLoad: 32,
    engagementHours: 12,
  ...
  },
  {
    ...
    title: "Partner and External Relations Coordinator",
    partners: "Partnership Operations",
    status: "ACTIVE",
    readiness: 94,
    engagementLoad: 54,
    engagementHours: 38,
    ...
    notes: "Owns partners-development cycle and institutional reporting.",
  },
  {
    id: "FAC-007",
    name: "Selene Brooks",
  ...
  },
  {
    ...
    partners: "Academy Foundations",
    status: "REVIEW",
    readiness: 69,
    engagementLoad: 45,
    engagementHours: 14,
    engagementTarget: 24,
    relationshipLeadId: "FAC-002",
    joined: "2026-05-12",
...
const seedCompetencies: Capability[] = [
  {
    id: "CMP-001",
    domain: "Governance Foundations",
    name: "Evidence Before Intervention",
    description: "Separates partner review, record, interpretation, and intervention without collapsing uncertainty.",
  ...
  },
  {
    ...
    evidenceStandard: "Published lesson, contributor evidence, and partnership review.",
  ...
  },
  {
    ...
    requiredLevel: "PRACTITIONER",
    evidenceStandard: "PartnerReview record and contributor improvement evidence.",
  ...
  },
  {
    ...
    description: "Guides partners growth without laundering authority or suppressing adverse evidence.",
    requiredLevel: "LEAD",
  ...
  },
  {
    ...
    description: "Maintains partnership portfolio continuity, version lineage, and institutional boundaries.",
    requiredLevel: "LEAD",
    evidenceStandard: "Partnership ethics packet, reproducibility record, and external engagement council determination.",
    revalidationMonths: 12,
  },
];

const seedCapabilityRecords: CapabilityRecord[] = [
  {
    id: "CCR-001",
    partnerId: "FAC-001",
    capabilityId: "CMP-001",
    level: "FOUNDATIONAL",
    score: 68,
    assessed: "2026-03-01",
    expires: "2027-03-01",
...
const seedPlans: EngagementPlan[] = [
  {
    id: "PLN-001",
    partnerId: "FAC-001",
    title: "2026 Partnership Advancement Plan \u2014 Dr. Mara Voss",
    ...
    successMeasures: ["Observed practice meets declared capability threshold", "Evidence packet is complete and challengeable"],
    dependencies: ["Scheduled partner review", "Required learning activities"],
    risks: [],
  ...
  },
  {
    id: "PLN-002",
    partnerId: "FAC-002",
    title: "2026 Partnership Advancement Plan \u2014 Jordan Ellis",
    cycle: "2026 Annual Cycle",
    status: "AT_RISK",
    priority: "CRITICAL",
    owner: "Daniel Cho",
    ...
    successMeasures: ["Observed practice meets declared capability threshold", "Evidence packet is complete and challengeable"],
    dependencies: ["Scheduled partner review", "Required learning activities"],
    risks: ["Engagement load may delay milestones"],
    lastUpdate: "2026-07-25",
  },
  {
    id: "PLN-003",
    partnerId: "FAC-003",
    title: "2026 Partnership Advancement Plan \u2014 Priya Nand",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-004",
    partnerId: "FAC-004",
    title: "2026 Partnership Advancement Plan \u2014 Mateo Ruiz",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-005",
    partnerId: "FAC-005",
    title: "2026 Partnership Advancement Plan \u2014 Amina Cole",
    cycle: "2026 Annual Cycle",
    status: "PAUSED",
    priority: "HIGH",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-006",
    partnerId: "FAC-006",
    title: "2026 Partnership Advancement Plan \u2014 Daniel Cho",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-007",
    partnerId: "FAC-007",
    title: "2026 Partnership Advancement Plan \u2014 Selene Brooks",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "HIGH",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-008",
    partnerId: "FAC-008",
    title: "2026 Partnership Advancement Plan \u2014 Owen Hart",
    cycle: "2026 Annual Cycle",
    status: "DRAFT",
    priority: "HIGH",
    owner: "Daniel Cho",
...
const seedActivities: EngagementActivity[] = [
  {
    id: "ACT-001",
    title: "Calibrated Evidence Review 1",
    provider: "TA-14 Academy",
    category: "Partnership Practice",
    format: "WORKSHOP",
    status: "OPEN",
    start: "2026-08-03",
    end: "2026-09-05",
    ...
    capabilityIds: ["CMP-001"],
    relationshipLead: "Mateo Ruiz",
  ...
  },
  {
    ...
    capabilityIds: ["CMP-002"],
    relationshipLead: "Amina Cole",
    description: "Structured compliance and assurance activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-003",
    title: "Accessible Engagement Design 1",
    provider: "TA-14 Academy",
    category: "Assessment",
    format: "COACHING",
    status: "PLANNED",
    ...
    capabilityIds: ["CMP-003"],
    relationshipLead: "Daniel Cho",
    description: "Structured compliance and assurance activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-004",
    ...
    seats: 12,
    enrolled: ["FAC-005"],
    capabilityIds: ["CMP-004"],
    relationshipLead: "Selene Brooks",
    description: "Structured compliance and assurance activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-005",
    ...
    capabilityIds: ["CMP-005"],
    relationshipLead: "Owen Hart",
    description: "Structured compliance and assurance activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-006",
    ...
    capabilityIds: ["CMP-006"],
    relationshipLead: "Dr. Mara Voss",
    description: "Structured compliance and assurance activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-007",
    ...
    capabilityIds: ["CMP-007"],
    relationshipLead: "Jordan Ellis",
    description: "Structured compliance and assurance activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-008",
    ...
    seats: 16,
    enrolled: ["FAC-001"],
    capabilityIds: ["CMP-008"],
    relationshipLead: "Priya Nand",
    description: "Structured compliance and assurance activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-009",
  ...
  },
  {
    ...
    seats: 20,
    enrolled: ["FAC-005"],
    capabilityIds: ["CMP-012"],
    relationshipLead: "Selene Brooks",
    description: "Structured compliance and assurance activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-013",
    title: "Accessible Engagement Design 2",
    provider: "TA-14 Academy",
    category: "Partnership Practice",
    format: "WORKSHOP",
    status: "OPEN",
  ...
  {
    id: "ACT-023",
    title: "Accessible Engagement Design 3",
    provider: "TA-14 Academy",
    category: "Leadership",
    format: "SELF_STUDY",
    status: "PLANNED",
...
const seedPathways: EngagementPathway[] = [
  {
    id: "PTH-001",
    name: "New Quality Review Authorization Pathway",
    audience: "Advisor candidates",
    description: "Builds platform, partnership, authority, and partner review readiness before independent learning.",
    activityIds: ["ACT-003", "ACT-004", "ACT-007", "ACT-008"],
    capabilityIds: ["CMP-003", "CMP-007", "CMP-012", "CMP-013"],
    estimatedHours: 28,
    status: "PUBLISHED",
  },
  {
    ...
    capabilityIds: ["CMP-001", "CMP-002", "CMP-004", "CMP-007"],
    estimatedHours: 32,
    status: "PUBLISHED",
  },
  {
    ...
    audience: "HVAC and environmental partners",
    ...
    capabilityIds: ["CMP-009", "CMP-010", "CMP-011"],
    estimatedHours: 36,
    status: "PUBLISHED",
  },
  {
    ...
    description: "Prepares partners for coaching, stewardship, calibration, and institutional review.",
    activityIds: ["ACT-006", "ACT-010", "ACT-016", "ACT-026"],
    capabilityIds: ["CMP-014", "CMP-015", "CMP-007", "CMP-008"],
    estimatedHours: 24,
    status: "DRAFT",
  },
];

const seedAdvisoryRelationships: AdvisoryRelationship[] = [
  {
    id: "MNT-001",
    relationshipLeadId: "FAC-006",
    partnerContactId: "FAC-003",
  ...
  {
    id: "MNT-002",
    relationshipLeadId: "FAC-007",
    partnerContactId: "FAC-004",
  ...
  {
    id: "MNT-003",
    relationshipLeadId: "FAC-008",
    partnerContactId: "FAC-005",
  ...
  },
  {
    id: "MNT-004",
    relationshipLeadId: "FAC-001",
    partnerContactId: "FAC-006",
    focus: "Partnership pacing",
    start: "2026-02-01",
    end: "2026-11-30",
    cadence: "Monthly",
    status: "ACTIVE",
  ...
  {
    id: "MNT-007",
    relationshipLeadId: "FAC-004",
    partnerContactId: "FAC-001",
    focus: "Quality leadership",
    start: "2026-02-01",
    end: "2026-11-30",
    cadence: "Monthly",
  ...
  {
    id: "MNT-008",
    relationshipLeadId: "FAC-005",
    partnerContactId: "FAC-002",
    focus: "Partnership pacing",
    start: "2026-02-01",
    end: "2026-11-30",
    cadence: "Weekly",
...
const seedPartnerReviews: PartnerReview[] = [
  {
    id: "OBS-001",
    partnerId: "FAC-001",
    reviewer: "Mateo Ruiz",
    engagement: "Electricity Made Simple",
    date: "2026-06-04",
    status: "COMPLETE",
    score: 77,
  ...
  },
  {
    ...
    partnerId: "FAC-005",
    reviewer: "Owen Hart",
    engagement: "Execution Admissibility",
    date: "2026-02-16",
    status: "COMPLETE",
    score: 76,
    strengths: ["Clear evidence boundaries", "Strong contributor engagement"],
...
const seedPortfolio: AgreementRecord[] = [
  {
    id: "PRT-001",
    partnerId: "FAC-001",
    ...
    category: "Assessment",
    created: "2026-03-05",
    summary: "Preserved partners-development artifact with declared scope, source attribution, and limitations.",
    tags: ["partners-development", "evidence", "academy"],
  ...
  },
  {
    id: "PRT-003",
    partnerId: "FAC-003",
    title: "Partnership Portfolio Revision 3",
    category: "Partnership Portfolio",
    created: "2026-05-13",
    summary: "Preserved partners-development artifact with declared scope, source attribution, and limitations.",
    tags: ["partners-development", "evidence", "academy"],
  ...
  },
  {
    id: "PRT-004",
    partnerId: "FAC-004",
    title: "AdvisoryRelationship Reflection 4",
    category: "Leadership",
    created: "2026-06-17",
    summary: "Preserved partners-development artifact with declared scope, source attribution, and limitations.",
    tags: ["partners-development", "evidence", "academy"],
  ...
  },
  {
    id: "PRT-009",
    partnerId: "FAC-001",
    title: "Partnership Portfolio Revision 9",
    category: "Partnership Portfolio",
    created: "2026-04-13",
    summary: "Preserved partners-development artifact with declared scope, source attribution, and limitations.",
    tags: ["partners-development", "evidence", "academy"],
  ...
  },
  {
    id: "PRT-010",
    partnerId: "FAC-002",
    title: "AdvisoryRelationship Reflection 10",
    category: "Leadership",
    created: "2026-05-17",
    summary: "Preserved partners-development artifact with declared scope, source attribution, and limitations.",
    tags: ["partners-development", "evidence", "academy"],
  ...
  },
  {
    id: "PRT-015",
    partnerId: "FAC-007",
    title: "Partnership Portfolio Revision 15",
    category: "Partnership Portfolio",
    created: "2026-03-13",
    summary: "Preserved partners-development artifact with declared scope, source attribution, and limitations.",
    tags: ["partners-development", "evidence", "academy"],
  ...
  },
  {
    id: "PRT-016",
    partnerId: "FAC-008",
    title: "AdvisoryRelationship Reflection 16",
    category: "Leadership",
    created: "2026-04-17",
    summary: "Preserved partners-development artifact with declared scope, source attribution, and limitations.",
    tags: ["partners-development", "evidence", "academy"],
  ...
  },
  {
    id: "PRT-021",
    partnerId: "FAC-005",
    title: "Partnership Portfolio Revision 21",
    category: "Partnership Portfolio",
    created: "2026-02-13",
    summary: "Preserved partners-development artifact with declared scope, source attribution, and limitations.",
    tags: ["partners-development", "evidence", "academy"],
  ...
  },
  {
    id: "PRT-022",
    partnerId: "FAC-006",
    title: "AdvisoryRelationship Reflection 22",
    category: "Leadership",
    created: "2026-03-17",
    summary: "Preserved partners-development artifact with declared scope, source attribution, and limitations.",
    tags: ["partners-development", "evidence", "academy"],
...
const seedImprovements: RemediationPlan[] = [
  {
    id: "IMP-001",
    partnerId: "FAC-003",
    title: "PartnerReview follow-up",
    trigger: "Peer partner review finding",
    status: "MONITORING",
    priority: "HIGH",
    opened: "2026-04-05",
    due: "2026-07-25",
    owner: "Partner and External Relations Council",
    actions: ["Complete coaching session", "Submit revised artifact", "Pass follow-up partner review"],
  ...
  },
  {
    id: "IMP-004",
    partnerId: "FAC-006",
    title: "Engagement load stabilization",
...
const seedEvidence: EvidenceRecord[] = [
  {
    ...
    relatedIds: ["FAC-001"],
    limitations: "Supports the declared partners-development purpose only; does not independently authorize learning.",
  },
  {
    id: "EVD-002",
    partnerId: "FAC-002",
...
const seedAudit: AuditEvent[] = [
  {
    ...
    actor: "Partner and External Relations Council",
    action: "EVIDENCE_VERIFIED",
    target: "Engagement plan 1",
    determination: "ALLOW",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
    id: "AUD-002",
    timestamp: "2026-07-02T10:14:00.000Z",
    actor: "Partnership Director",
  ...
  },
  {
    ...
    actor: "Partner and External Relations Council",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 5",
    determination: "ALLOW",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
  ...
  },
  {
    ...
    actor: "Partnership Director",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 10",
    determination: "HOLD",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
  ...
  },
  {
    ...
    actor: "Partnership Director",
    action: "MENTORSHIP_UPDATED",
    target: "AdvisoryRelationship 14",
    determination: "HOLD",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
    ...
    actor: "System Import",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 15",
    determination: "ESCALATE",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
  ...
  },
  {
    ...
    actor: "System Import",
    action: "MENTORSHIP_UPDATED",
    target: "AdvisoryRelationship 19",
    determination: "ESCALATE",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
    ...
    actor: "Daniel Cho",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 20",
    determination: "ALLOW",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
  ...
  },
  {
    ...
    actor: "Daniel Cho",
    action: "MENTORSHIP_UPDATED",
    target: "AdvisoryRelationship 24",
    determination: "ALLOW",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
    ...
    actor: "Partner and External Relations Council",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 25",
    determination: "ALLOW",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
  ...
  },
  {
    ...
    actor: "Partner and External Relations Council",
    action: "MENTORSHIP_UPDATED",
    target: "AdvisoryRelationship 29",
    determination: "ALLOW",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
    ...
    actor: "Partnership Director",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 30",
    determination: "HOLD",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
  ...
  },
  {
    ...
    actor: "Partnership Director",
    action: "MENTORSHIP_UPDATED",
    target: "AdvisoryRelationship 34",
    determination: "HOLD",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
    ...
    actor: "System Import",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 35",
    determination: "ESCALATE",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
  ...
  },
  {
    ...
    actor: "System Import",
    action: "MENTORSHIP_UPDATED",
    target: "AdvisoryRelationship 39",
    determination: "ESCALATE",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
    ...
    actor: "Daniel Cho",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 40",
    determination: "ALLOW",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
  ...
  },
  {
    ...
    actor: "Daniel Cho",
    action: "MENTORSHIP_UPDATED",
    target: "AdvisoryRelationship 44",
    determination: "ALLOW",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
    ...
    actor: "Partner and External Relations Council",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 45",
    determination: "ALLOW",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
  ...
  },
  {
    ...
    actor: "Partner and External Relations Council",
    action: "MENTORSHIP_UPDATED",
    target: "AdvisoryRelationship 49",
    determination: "ALLOW",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
    ...
    actor: "Partnership Director",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 50",
    determination: "HOLD",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
  ...
  },
  {
    ...
    actor: "Partnership Director",
    action: "MENTORSHIP_UPDATED",
    target: "AdvisoryRelationship 54",
    determination: "HOLD",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
    ...
    actor: "System Import",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 55",
    determination: "ESCALATE",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
  ...
  },
  {
    ...
    actor: "System Import",
    action: "MENTORSHIP_UPDATED",
    target: "AdvisoryRelationship 59",
    determination: "ESCALATE",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
  {
    ...
    actor: "Daniel Cho",
    action: "PLAN_UPDATED",
    target: "Partnership partnership 60",
    determination: "ALLOW",
    detail: "Preserved partners-development action with actor, target, determination, and bounded detail.",
  },
];
...
const initialState: WorkspaceState = {
  ...
  capabilityRecords: seedCapabilityRecords,
  activities: seedActivities,
  pathways: seedPathways,
  advisoryRelationships: seedAdvisoryRelationships,
  partnerReviews: seedPartnerReviews,
...
function validateWorkspace(value: unknown): value is WorkspaceState {
  ...
  return (
    candidate.schema === "TA14_ACADEMY_PARTNER_EXTERNAL_RELATIONS_V1" &&
...
const tabs: { key: TabKey; label: string; description: string }[] = [
  ...
  { key: "engagement-plans", label: "Development Plans", description: "Objectives, milestones, and risk" },
  { key: "competencies", label: "Capability Framework", description: "Required capability and evidence" },
  { key: "opportunities", label: "Learning Catalog", description: "Workshops, engagements, coaching, and labs" },
  { key: "joint-programs", label: "Partnership Portfolio Paths", description: "Sequenced partners progression" },
  { key: "advisory-boards", label: "Governance Reviews", description: "Bounded coaching relationships" },
  { key: "partner-reviews", label: "Quality Reviews", description: "Partnership review and learning evidence" },
  { key: "agreements", label: "Learning Portfolio", description: "Preserved partners artifacts" },
  { key: "remediation", label: "Improvement Plans", description: "Corrective action and monitoring" },
...
export default function PartnerDevelopmentCenterPage() {
  const [workspace, setWorkspace] = useState<WorkspaceState>(initialState);
  const [tab, setTab] = useState<TabKey>("overview");
  const [search, setSearch] = useState("");
  const [partners, setPartner] = useState("ALL");
  const [statusFilter, setStatusFilter] = useState("ALL");
  const [selectedPartnerId, setSelectedPartnerId] = useState(seedPartner[0].id);
  ...
  const partnerss = useMemo(
    () => Array.from(new Set(workspace.partners.map((member) => member.partners))).sort(),
    [workspace.partners],
  );

  const filteredPartner = useMemo(() => {
    const query = search.trim().toLowerCase();
    return workspace.partners.filter((member) => {
      const matchesQuery =
        !query ||
        [member.name, member.email, member.title, member.partners, ...member.specialties]
          .join(" ")
          .toLowerCase()
          .includes(query);
      const matchesPartner = partners === "ALL" || member.partners === partners;
      const matchesStatus = statusFilter === "ALL" || member.status === statusFilter;
      return matchesQuery && matchesPartner && matchesStatus;
    });
  }, [workspace.partners, search, partners, statusFilter]);

  const selectedPartner = workspace.partners.find((member) => member.id === selectedPartnerId) ?? workspace.partners[0];
  const selectedPlans = workspace.plans.filter((plan) => plan.partnerId === selectedPartner?.id);
  const selectedRecords = workspace.capabilityRecords.filter((record) => record.partnerId === selectedPartner?.id);
  const selectedEvidence = workspace.evidence.filter((record) => record.partnerId === selectedPartner?.id);

  const metrics = useMemo(() => {
    const active = workspace.partners.filter((member) => member.status === "ACTIVE").length;
    const atRisk = workspace.plans.filter((plan) => plan.status === "AT_RISK").length;
    const readiness = Math.round(
      workspace.partners.reduce((sum, member) => sum + member.readiness, 0) /
        Math.max(workspace.partners.length, 1),
    );
    ...
    const overduePartnerReviews = workspace.partnerReviews.filter((item) => item.status === "OVERDUE").length;
    return { active, atRisk, readiness, verifiedEvidence, openImprovements, overduePartnerReviews };
  }, [workspace]);
  ...
  function updatePartner(member: PartnerProfile) {
    setWorkspace((current) => ({
      ...current,
      partners: current.partners.map((item) => (item.id === member.id ? member : item)),
    }));
    addAudit("FACULTY_UPDATED", member.id, "ALLOW", `Updated partners profile for ${member.name}.`);
    setToast("Partner profile preserved locally.");
  }

  function exportJson() {
    downloadText(
      `TA-14_Partner_Development_Export_${today()}.json`,
  ...
  function exportPartnerCsv() {
    downloadText(
      `TA-14_Partner_Development_Partner_${today()}.csv`,
      toCsv(workspace.partners as unknown as Record<string, unknown>[]),
      "text/csv",
    );
    addAudit("FACULTY_CSV_EXPORTED", "Partner roster", "ALLOW", "Exported partners roster as CSV.");
    setToast("Partner CSV exported.");
  }
  ...
  async function importWorkspace(event: ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      setWorkspace(parsed);
      setSelectedPartnerId(parsed.partners[0]?.id ?? "");
      setToast("Validated workspace imported.");
    } catch {
      setToast("Import denied: file does not match the Partner Success schema.");
    } finally {
      event.target.value = "";
    }
  }
  ...
  function resetWorkspace() {
    ...
    setSelectedPartnerId(initialState.partners[0].id);
  ...
  return (
    <main style={styles.page}>
      ...
      <header style={styles.header}>
        <div>
          ...
          <p style={styles.subtitle}>
            Govern partners growth through preserved plans, evidence-bound capability, advisory relationship,
            partner review, corrective action, and challengeable readiness determinations.
          </p>
        </div>
        <div style={styles.headerActions}>
          <button style={styles.buttonSecondary} onClick={() => importRef.current?.click()}>Import JSON</button>
          <button style={styles.buttonSecondary} onClick={exportPartnerCsv}>Export CSV</button>
      ...
      <section style={styles.metricsGrid}>
        <MetricCard label="Active partners" value={metrics.active} detail={`${workspace.partners.length} total records`} />
        ...
        <MetricCard label="Overdue partnerReviews" value={metrics.overduePartnerReviews} detail="Partnership review continuity risk" tone="#ff6b76" />
      </section>
        ...
        <div style={styles.content}>
          <div style={styles.toolbar}>
            <input
              ...
              placeholder="Search partners, title, partners, specialty..."
            />
            <select style={styles.select} value={partners} onChange={(event) => setPartner(event.target.value)}>
              <option value="ALL">All partnerss</option>
              {partnerss.map((item) => <option key={item}>{item}</option>)}
            </select>
            ...
            <button style={styles.buttonPrimary} onClick={() => setModal("partners")}>New partnership partnership</button>
          </div>

          {tab === "overview" && <OverviewTab workspace={workspace} filteredPartner={filteredPartner} onSelect={setSelectedPartnerId} selectedPartnerId={selectedPartnerId} />}
          {tab === "engagement-plans" && <PlansTab workspace={workspace} selectedPartner={selectedPartner} onCreate={() => setModal("plan")} />}
          {tab === "competencies" && <CompetenciesTab workspace={workspace} selectedPartner={selectedPartner} />}
          {tab === "opportunities" && <CatalogTab workspace={workspace} onCreate={() => setModal("activity")} />}
          {tab === "joint-programs" && <PathwaysTab workspace={workspace} />}
          {tab === "advisory-boards" && <AdvisoryRelationshipTab workspace={workspace} />}
          {tab === "partner-reviews" && <PartnerReviewsTab workspace={workspace} onCreate={() => setModal("partner-review")} />}
          {tab === "agreements" && <PortfolioTab workspace={workspace} selectedPartner={selectedPartner} />}
          {tab === "remediation" && <ImprovementTab workspace={workspace} onCreate={() => setModal("remediation")} />}
        ...
        <section style={styles.detailRail}>
          <div style={styles.detailHeader}>
            <div>
              ...
              <h2 style={styles.sectionTitle}>{selectedPartner.name}</h2>
              <p style={styles.muted}>{selectedPartner.title} · {selectedPartner.partners}</p>
            </div>
            <span style={{ ...styles.scoreBadge, borderColor: scoreTone(selectedPartner.readiness), color: scoreTone(selectedPartner.readiness) }}>
              {selectedPartner.readiness}% ready
            </span>
          </div>
          <div style={styles.detailGrid}>
            <DetailCard title="Development posture" lines={[
              `Status: ${selectedPartner.status}`,
              `Engagement load: ${selectedPartner.engagementLoad}%`,
              `Engagement and participation: ${selectedPartner.engagementHours}/${selectedPartner.engagementTarget} hours`,
              `Next review: ${selectedPartner.nextReview}`,
            ]} />
            ...
            <DetailCard title="Capability evidence" lines={[
              `${selectedRecords.length} capability records`,
            ...
            <DetailCard title="Declared goals" lines={selectedPartner.goals} />
          </div>
        </section>
      )}

      {modal === "partners" && <PartnerModal onClose={() => setModal(null)} onSave={(member) => { setWorkspace((current) => ({ ...current, partners: [member, ...current.partners] })); setSelectedPartnerId(member.id); setModal(null); setToast("Partnership partnership created."); }} />}
      {modal === "plan" && <PlanModal partners={workspace.partners} selectedPartnerId={selectedPartnerId} onClose={() => setModal(null)} onSave={(plan) => { setWorkspace((current) => ({ ...current, plans: [plan, ...current.plans] })); setModal(null); setToast("Engagement plan created."); }} />}
      ...
      {modal === "partner-review" && <PartnerReviewModal partners={workspace.partners} onClose={() => setModal(null)} onSave={(partnerReview) => { setWorkspace((current) => ({ ...current, partnerReviews: [partnerReview, ...current.partnerReviews] })); setModal(null); setToast("PartnerReview scheduled."); }} />}
      {modal === "evidence" && <EvidenceModal partners={workspace.partners} onClose={() => setModal(null)} onSave={(record) => { setWorkspace((current) => ({ ...current, evidence: [record, ...current.evidence] })); setModal(null); setToast("Evidence record preserved."); }} />}
      {modal === "remediation" && <ImprovementModal partners={workspace.partners} onClose={() => setModal(null)} onSave={(plan) => { setWorkspace((current) => ({ ...current, improvements: [plan, ...current.improvements] })); setModal(null); setToast("Improvement plan opened."); }} />}
...
function OverviewTab({ workspace, filteredPartner, onSelect, selectedPartnerId }: { workspace: WorkspaceState; filteredPartner: PartnerProfile[]; onSelect: (id: string) => void; selectedPartnerId: string }) {
  ...
  return <div>
    <SectionHeading title="Partner development mission control" description="A single view of partners readiness, workload, development risk, and upcoming institutional activity." />
    <div style={styles.twoColumn}>
      <div style={styles.panel}>
        <h3 style={styles.cardTitle}>Partner roster</h3>
        <div style={styles.stack}>{filteredPartner.map((member) => <button key={member.id} onClick={() => onSelect(member.id)} style={{ ...styles.listButton, ...(selectedPartnerId === member.id ? styles.listButtonActive : {}) }}><div><strong>{member.name}</strong><div style={styles.mutedSmall}>{member.title} · {member.partners}</div></div><div style={styles.listRight}><Pill tone={member.status === "ACTIVE" ? "#45d483" : "#f0c35c"}>{member.status}</Pill><strong style={{ color: scoreTone(member.readiness) }}>{member.readiness}%</strong></div></button>)}</div>
      </div>
      <div style={styles.panel}>
    ...
    <div style={styles.threeColumn}>
      ...
      <SummaryPanel title="PartnerReview posture" items={[
        `${workspace.partnerReviews.filter((item) => item.status === "COMPLETE").length} complete`,
        `${workspace.partnerReviews.filter((item) => item.status === "FOLLOW_UP").length} follow-up`,
        `${workspace.partnerReviews.filter((item) => item.status === "OVERDUE").length} overdue`,
      ]} />
...
function PlansTab({ workspace, selectedPartner, onCreate }: { workspace: WorkspaceState; selectedPartner?: PartnerProfile; onCreate: () => void }) {
  const plans = selectedPartner ? workspace.plans.filter((plan) => plan.partnerId === selectedPartner.id) : workspace.plans;
  return <div><SectionHeading title="Professional engagement plans" description="Objectives remain attributable, measurable, time-bound, and connected to preserved evidence." action={<button style={styles.buttonPrimary} onClick={onCreate}>Create plan</button>} /><div style={styles.cardGrid}>{plans.map((plan) => <article key={plan.id} style={styles.panel}><div style={styles.cardHeader}><div><Pill tone={plan.status === "AT_RISK" ? "#ff9b6b" : plan.status === "ACTIVE" ? "#45d483" : "#71b7ff"}>{plan.status}</Pill><h3 style={styles.cardTitle}>{plan.title}</h3><p style={styles.mutedSmall}>{plan.cycle} · Due {plan.due}</p></div><Pill tone={plan.priority === "CRITICAL" ? "#ff6b76" : "#f0c35c"}>{plan.priority}</Pill></div><ProgressBar value={plan.progress} /><div style={styles.objectiveGrid}><div><strong>Objectives</strong>{plan.objectives.map((item) => <p key={item} style={styles.mutedSmall}>• {item}</p>)}</div><div><strong>Success measures</strong>{plan.successMeasures.map((item) => <p key={item} style={styles.mutedSmall}>• {item}</p>)}</div></div>{plan.risks.length > 0 && <div style={styles.warningBox}><strong>Declared risks</strong>{plan.risks.map((risk) => <div key={risk}>• {risk}</div>)}</div>}</article>)}</div></div>;
}

function CompetenciesTab({ workspace, selectedPartner }: { workspace: WorkspaceState; selectedPartner?: PartnerProfile }) {
  return <div><SectionHeading title="Learning capability framework" description="Required levels are separated from current evidence and cannot be inferred from role title alone." /><div style={styles.tableWrap}><table style={styles.table}><thead><tr><th>Capability</th><th>Domain</th><th>Required</th><th>Current</th><th>Score</th><th>Evidence determination</th><th>Revalidate</th></tr></thead><tbody>{workspace.competencies.map((capability) => { const record = workspace.capabilityRecords.find((item) => item.capabilityId === capability.id && item.partnerId === selectedPartner?.id); const current = record?.level ?? "UNASSESSED"; const gap = record ? capabilityRank[record.level] < capabilityRank[capability.requiredLevel] : true; return <tr key={capability.id}><td><strong>{capability.name}</strong><div style={styles.mutedSmall}>{capability.description}</div></td><td>{capability.domain}</td><td><Pill>{capability.requiredLevel}</Pill></td><td><Pill tone={gap ? "#f0c35c" : "#45d483"}>{current}</Pill></td><td>{record ? `${record.score}%` : "—"}</td><td>{record ? <Pill tone={determinationTone[record.determination]}>{record.determination}</Pill> : <Pill tone="#f0c35c">HOLD</Pill>}</td><td>{capability.revalidationMonths} months</td></tr>; })}</tbody></table></div></div>;
}

function CatalogTab({ workspace, onCreate }: { workspace: WorkspaceState; onCreate: () => void }) {
  return <div><SectionHeading title="Learning activity catalog" description="Development offerings declare provider, relationshipLead, capability relationship, capacity, and status." action={<button style={styles.buttonPrimary} onClick={onCreate}>Add activity</button>} /><div style={styles.cardGrid}>{workspace.activities.map((activity) => <article key={activity.id} style={styles.panel}><div style={styles.cardHeader}><div><Pill>{activity.format}</Pill><h3 style={styles.cardTitle}>{activity.title}</h3></div><Pill tone={activity.status === "COMPLETE" ? "#45d483" : activity.status === "IN_PROGRESS" ? "#f0c35c" : "#71b7ff"}>{activity.status}</Pill></div><p style={styles.muted}>{activity.description}</p><div style={styles.metaGrid}><span>Provider: {activity.provider}</span><span>Relationship lead: {activity.relationshipLead}</span><span>Dates: {activity.start} → {activity.end}</span><span>Hours: {activity.hours}</span><span>Seats: {activity.enrolled.length}/{activity.seats}</span><span>Category: {activity.category}</span></div></article>)}</div></div>;
}

function PathwaysTab({ workspace }: { workspace: WorkspaceState }) {
  return <div><SectionHeading title="Partner partnership pathways" description="Sequenced development does not replace the evidence and authority required for final learning authorization." /><div style={styles.cardGrid}>{workspace.pathways.map((pathway) => <article key={pathway.id} style={styles.panel}><div style={styles.cardHeader}><h3 style={styles.cardTitle}>{pathway.name}</h3><Pill tone={pathway.status === "PUBLISHED" ? "#45d483" : "#f0c35c"}>{pathway.status}</Pill></div><p style={styles.muted}>{pathway.description}</p><div style={styles.metaGrid}><span>Audience: {pathway.audience}</span><span>Estimated: {pathway.estimatedHours} hours</span><span>{pathway.activityIds.length} activities</span><span>{pathway.capabilityIds.length} competencies</span></div><div style={styles.chain}>{pathway.activityIds.map((id, index) => <span key={id} style={styles.chainNode}>{index + 1}. {workspace.activities.find((item) => item.id === id)?.title ?? id}</span>)}</div></article>)}</div></div>;
}

function AdvisoryRelationshipTab({ workspace }: { workspace: WorkspaceState }) {
  const name = (id: string) => workspace.partners.find((member) => member.id === id)?.name ?? id;
  return <div><SectionHeading title="AdvisoryRelationship and coaching" description="AdvisoryRelationship preserves role boundaries, goals, cadence, meeting evidence, and outcome review." /><div style={styles.cardGrid}>{workspace.advisoryRelationships.map((item) => <article key={item.id} style={styles.panel}><div style={styles.cardHeader}><div><Pill tone={item.status === "ACTIVE" ? "#45d483" : "#f0c35c"}>{item.status}</Pill><h3 style={styles.cardTitle}>{name(item.relationshipLeadId)} → {name(item.partnerContactId)}</h3></div><span style={styles.largeNumber}>{item.meetingCount}</span></div><p style={styles.muted}>{item.focus}</p><div style={styles.metaGrid}><span>Cadence: {item.cadence}</span><span>Next meeting: {item.nextMeeting}</span><span>Window: {item.start} → {item.end}</span></div>{item.goals.map((goal) => <div key={goal} style={styles.goalLine}>• {goal}</div>)}</article>)}</div></div>;
}

function PartnerReviewsTab({ workspace, onCreate }: { workspace: WorkspaceState; onCreate: () => void }) {
  const name = (id: string) => workspace.partners.find((member) => member.id === id)?.name ?? id;
  return <div><SectionHeading title="Performance partnerReviews and partnership review" description="PartnerReview preserves strengths, adverse findings, required actions, and supporting evidence." action={<button style={styles.buttonPrimary} onClick={onCreate}>Schedule partner review</button>} /><div style={styles.tableWrap}><table style={styles.table}><thead><tr><th>Partner</th><th>Engagement</th><th>Reviewer</th><th>Date</th><th>Status</th><th>Score</th><th>Findings</th><th>Required action</th></tr></thead><tbody>{workspace.partnerReviews.map((item) => <tr key={item.id}><td><strong>{name(item.partnerId)}</strong></td><td>{item.engagement}</td><td>{item.reviewer}</td><td>{item.date}</td><td><Pill tone={item.status === "OVERDUE" ? "#ff6b76" : item.status === "COMPLETE" ? "#45d483" : "#f0c35c"}>{item.status}</Pill></td><td style={{ color: scoreTone(item.score), fontWeight: 800 }}>{item.score}%</td><td>{item.findings.join("; ")}</td><td>{item.requiredActions.join("; ") || "None"}</td></tr>)}</tbody></table></div></div>;
}

function PortfolioTab({ workspace, selectedPartner }: { workspace: WorkspaceState; selectedPartner?: PartnerProfile }) {
  const items = selectedPartner ? workspace.portfolio.filter((item) => item.partnerId === selectedPartner.id) : workspace.portfolio;
...
function ImprovementTab({ workspace, onCreate }: { workspace: WorkspaceState; onCreate: () => void }) {
  const name = (id: string) => workspace.partners.find((member) => member.id === id)?.name ?? id;
  return <div><SectionHeading title="Partner intervention and remediation plans" description="Corrective action is separated from punishment and remains tied to findings, checkpoints, and fresh evidence." action={<button style={styles.buttonPrimary} onClick={onCreate}>Open remediation plan</button>} /><div style={styles.cardGrid}>{workspace.improvements.map((item) => <article key={item.id} style={styles.panel}><div style={styles.cardHeader}><div><Pill tone={item.status === "ESCALATED" ? "#ff6b76" : item.status === "SATISFIED" ? "#45d483" : "#f0c35c"}>{item.status}</Pill><h3 style={styles.cardTitle}>{item.title}</h3><p style={styles.mutedSmall}>{name(item.partnerId)} · Trigger: {item.trigger}</p></div><Pill tone={determinationTone[item.determination]}>{item.determination}</Pill></div><ProgressBar value={item.progress} /><div style={styles.metaGrid}><span>Owner: {item.owner}</span><span>Due: {item.due}</span><span>Priority: {item.priority}</span><span>{item.progress}% complete</span></div><div style={styles.objectiveGrid}><div><strong>Actions</strong>{item.actions.map((action) => <p key={action} style={styles.mutedSmall}>• {action}</p>)}</div><div><strong>Checkpoints</strong>{item.checkpoints.map((checkpoint) => <p key={checkpoint} style={styles.mutedSmall}>• {checkpoint}</p>)}</div></div></article>)}</div></div>;
}

function ReadinessTab({ workspace }: { workspace: WorkspaceState }) {
  return <div><SectionHeading title="Partner readiness scoring" description="Readiness is an operational aid, not independent permission. Missing authority or stale evidence can still force HOLD." /><div style={styles.tableWrap}><table style={styles.table}><thead><tr><th>Partner</th><th>Readiness</th><th>Engagement load</th><th>CE completion</th><th>Capability ALLOW</th><th>Verified evidence</th><th>Open improvement</th><th>Institutional posture</th></tr></thead><tbody>{workspace.partners.map((member) => { const records = workspace.capabilityRecords.filter((item) => item.partnerId === member.id); const allow = records.filter((item) => item.determination === "ALLOW").length; const evidence = workspace.evidence.filter((item) => item.partnerId === member.id && item.status === "VERIFIED").length; const improvements = workspace.improvements.filter((item) => item.partnerId === member.id && item.status !== "SATISFIED").length; const posture: Determination = member.readiness >= 85 && member.engagementLoad <= 85 && improvements === 0 ? "ALLOW" : member.readiness >= 70 ? "HOLD" : "ESCALATE"; return <tr key={member.id}><td><strong>{member.name}</strong><div style={styles.mutedSmall}>{member.title}</div></td><td><strong style={{ color: scoreTone(member.readiness) }}>{member.readiness}%</strong><ProgressBar value={member.readiness} /></td><td>{member.engagementLoad}%</td><td>{member.engagementHours}/{member.engagementTarget}</td><td>{allow}/{records.length}</td><td>{evidence}</td><td>{improvements}</td><td><Pill tone={determinationTone[posture]}>{posture}</Pill></td></tr>; })}</tbody></table></div><div style={styles.infoBox}><strong>Scoring boundary:</strong> readiness combines development evidence, workload, engagement and participation, observed practice, and corrective-action posture. It cannot override expired authorization, unresolved conflict, or missing institutional authority.</div></div>;
}

function EvidenceTab({ workspace, onCreate }: { workspace: WorkspaceState; onCreate: () => void }) {
  const name = (id: string) => workspace.partners.find((member) => member.id === id)?.name ?? id;
  return <div><SectionHeading title="Partner management evidence repository" description="Every record declares source, capture date, verification state, related objects, hash, and limitations." action={<button style={styles.buttonPrimary} onClick={onCreate}>Preserve evidence</button>} /><div style={styles.tableWrap}><table style={styles.table}><thead><tr><th>Evidence</th><th>Partner</th><th>Type</th><th>Source</th><th>Captured</th><th>Status</th><th>Hash</th><th>Limitations</th></tr></thead><tbody>{workspace.evidence.map((item) => <tr key={item.id}><td><strong>{item.title}</strong><div style={styles.mutedSmall}>{item.id}</div></td><td>{name(item.partnerId)}</td><td>{item.type}</td><td>{item.source}</td><td>{item.captured}</td><td><Pill tone={item.status === "VERIFIED" ? "#45d483" : item.status === "PENDING" ? "#f0c35c" : "#ff6b76"}>{item.status}</Pill></td><td><code style={styles.code}>{item.hash.slice(0, 18)}…</code></td><td>{item.limitations}</td></tr>)}</tbody></table></div></div>;
}

function ReportsTab({ workspace }: { workspace: WorkspaceState }) {
  const byPartner = Array.from(new Set(workspace.partners.map((item) => item.partners))).map((partners) => { const members = workspace.partners.filter((item) => item.partners === partners); return { partners, count: members.length, readiness: Math.round(members.reduce((sum, item) => sum + item.readiness, 0) / members.length), load: Math.round(members.reduce((sum, item) => sum + item.engagementLoad, 0) / members.length) }; });
  return <div><SectionHeading title="Partner management reporting" description="Reports expose favorable and adverse conditions without turning approval rate into the primary success metric." /><div style={styles.threeColumn}><SummaryPanel title="Participation" items={[`${workspace.activities.reduce((sum, item) => sum + item.enrolled.length, 0)} participations`, `${workspace.advisoryRelationships.filter((item) => item.status === "ACTIVE").length} active advisoryRelationships`, `${workspace.portfolio.length} learning-record artifacts`]} /><SummaryPanel title="Quality and review" items={[`${workspace.partnerReviews.filter((item) => item.status === "FOLLOW_UP").length} follow-up partnerReviews`, `${workspace.plans.filter((item) => item.status === "AT_RISK").length} plans at risk`, `${workspace.improvements.filter((item) => item.status === "ESCALATED").length} escalated improvements`]} /><SummaryPanel title="Evidence integrity" items={[`${workspace.evidence.filter((item) => item.status === "VERIFIED").length} verified`, `${workspace.evidence.filter((item) => item.status === "PENDING").length} pending`, `${workspace.evidence.filter((item) => item.status === "SUPERSEDED").length} superseded`]} /></div><div style={styles.panel}><h3 style={styles.cardTitle}>Partner posture</h3>{byPartner.map((item) => <div key={item.partners} style={styles.reportRow}><div><strong>{item.partners}</strong><div style={styles.mutedSmall}>{item.count} partners</div></div><div style={styles.reportBars}><span>Readiness {item.readiness}%</span><ProgressBar value={item.readiness} /><span>Load {item.load}%</span><ProgressBar value={item.load} /></div></div>)}</div></div>;
}
...
function PartnerModal({ onClose, onSave }: { onClose: () => void; onSave: (member: PartnerProfile) => void }) {
  const [form, setForm] = useState({ name: "", email: "", title: "", partners: "", notes: "" });
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("FAC"), name: form.name, email: form.email, title: form.title, partners: form.partners, status: "REVIEW", readiness: 0, engagementLoad: 0, engagementHours: 0, engagementTarget: 24, relationshipLeadId: null, joined: today(), nextReview: today(), specialties: [], goals: ["Complete initial compliance and assurance plan"], notes: form.notes }); }
  return <ModalShell title="Create compliance and assurance record" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Name"><input required style={styles.input} value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} /></Field><Field label="Email"><input required type="email" style={styles.input} value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} /></Field><Field label="Title"><input required style={styles.input} value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} /></Field><Field label="Partner"><input required style={styles.input} value={form.partners} onChange={(e) => setForm({ ...form, partners: e.target.value })} /></Field><Field label="Notes"><textarea style={styles.textarea} value={form.notes} onChange={(e) => setForm({ ...form, notes: e.target.value })} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Create record</button></div></form></ModalShell>;
}

function PlanModal({ partners, selectedPartnerId, onClose, onSave }: { partners: PartnerProfile[]; selectedPartnerId: string; onClose: () => void; onSave: (plan: EngagementPlan) => void }) {
  const [partnerId, setPartnerId] = useState(selectedPartnerId); const [title, setTitle] = useState(""); const [due, setDue] = useState(today()); const [objective, setObjective] = useState("");
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("PLN"), partnerId, title, cycle: "2026 Development Cycle", status: "DRAFT", priority: "MEDIUM", owner: "Partner and External Relations Council", start: today(), due, progress: 0, objectives: [objective], successMeasures: ["Objective supported by preserved evidence"], dependencies: ["Partner and supervisor review"], risks: [], lastUpdate: today() }); }
  return <ModalShell title="Create professional engagement plan" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Partner"><select style={styles.input} value={partnerId} onChange={(e) => setPartnerId(e.target.value)}>{partners.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Plan title"><input required style={styles.input} value={title} onChange={(e) => setTitle(e.target.value)} /></Field><Field label="Due date"><input required type="date" style={styles.input} value={due} onChange={(e) => setDue(e.target.value)} /></Field><Field label="Primary objective"><textarea required style={styles.textarea} value={objective} onChange={(e) => setObjective(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Create plan</button></div></form></ModalShell>;
}

function ActivityModal({ competencies, onClose, onSave }: { competencies: Capability[]; onClose: () => void; onSave: (activity: EngagementActivity) => void }) {
  const [title, setTitle] = useState(""); const [category, setCategory] = useState("Partnership Practice"); const [hours, setHours] = useState(4); const [capabilityId, setCapabilityId] = useState(competencies[0]?.id ?? "");
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("ACT"), title, provider: "TA-14 Academy", category, format: "WORKSHOP", status: "PLANNED", start: today(), end: today(), hours, seats: 12, enrolled: [], capabilityIds: [capabilityId], relationshipLead: "To be assigned", description: "New compliance and assurance activity pending relationshipLead and evidence-plan review." }); }
  return <ModalShell title="Add engagement activity" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Activity title"><input required style={styles.input} value={title} onChange={(e) => setTitle(e.target.value)} /></Field><Field label="Category"><input required style={styles.input} value={category} onChange={(e) => setCategory(e.target.value)} /></Field><Field label="Hours"><input type="number" min={1} style={styles.input} value={hours} onChange={(e) => setHours(Number(e.target.value))} /></Field><Field label="Primary capability"><select style={styles.input} value={capabilityId} onChange={(e) => setCapabilityId(e.target.value)}>{competencies.map((c) => <option key={c.id} value={c.id}>{c.name}</option>)}</select></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Add activity</button></div></form></ModalShell>;
}

function PartnerReviewModal({ partners, onClose, onSave }: { partners: PartnerProfile[]; onClose: () => void; onSave: (partnerReview: PartnerReview) => void }) {
  const [partnerId, setPartnerId] = useState(partners[0]?.id ?? ""); const [engagement, setEngagement] = useState(""); const [reviewer, setReviewer] = useState(""); const [date, setDate] = useState(today());
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("OBS"), partnerId, reviewer, engagement, date, status: "SCHEDULED", score: 0, strengths: [], findings: [], requiredActions: [], evidenceIds: [] }); }
  return <ModalShell title="Schedule peer partner review" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Partner"><select style={styles.input} value={partnerId} onChange={(e) => setPartnerId(e.target.value)}>{partners.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Engagement"><input required style={styles.input} value={engagement} onChange={(e) => setEngagement(e.target.value)} /></Field><Field label="Reviewer"><input required style={styles.input} value={reviewer} onChange={(e) => setReviewer(e.target.value)} /></Field><Field label="Date"><input type="date" style={styles.input} value={date} onChange={(e) => setDate(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Schedule</button></div></form></ModalShell>;
}

function EvidenceModal({ partners, onClose, onSave }: { partners: PartnerProfile[]; onClose: () => void; onSave: (record: EvidenceRecord) => void }) {
  const [partnerId, setPartnerId] = useState(partners[0]?.id ?? ""); const [title, setTitle] = useState(""); const [type, setType] = useState("ARTIFACT"); const [source, setSource] = useState(""); const [limitations, setLimitations] = useState("");
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("EVD"), partnerId, title, type, source, captured: today(), status: "PENDING", hash: `pending:${uid("hash")}`, relatedIds: [partnerId], limitations }); }
  return <ModalShell title="Preserve partners evidence" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Partner"><select style={styles.input} value={partnerId} onChange={(e) => setPartnerId(e.target.value)}>{partners.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Evidence title"><input required style={styles.input} value={title} onChange={(e) => setTitle(e.target.value)} /></Field><Field label="Type"><input required style={styles.input} value={type} onChange={(e) => setType(e.target.value)} /></Field><Field label="Source"><input required style={styles.input} value={source} onChange={(e) => setSource(e.target.value)} /></Field><Field label="Limitations"><textarea required style={styles.textarea} value={limitations} onChange={(e) => setLimitations(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Preserve record</button></div></form></ModalShell>;
}

function ImprovementModal({ partners, onClose, onSave }: { partners: PartnerProfile[]; onClose: () => void; onSave: (plan: RemediationPlan) => void }) {
  const [partnerId, setPartnerId] = useState(partners[0]?.id ?? ""); const [title, setTitle] = useState(""); const [trigger, setTrigger] = useState(""); const [due, setDue] = useState(today());
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("IMP"), partnerId, title, trigger, status: "OPEN", priority: "HIGH", opened: today(), due, owner: "Partner and External Relations Council", actions: ["Complete bounded review with partners member"], checkpoints: ["Initial evidence review", "Midpoint check", "Final determination"], progress: 0, determination: "HOLD" }); }
  return <ModalShell title="Open partners remediation plan" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Partner"><select style={styles.input} value={partnerId} onChange={(e) => setPartnerId(e.target.value)}>{partners.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Plan title"><input required style={styles.input} value={title} onChange={(e) => setTitle(e.target.value)} /></Field><Field label="Trigger finding"><textarea required style={styles.textarea} value={trigger} onChange={(e) => setTrigger(e.target.value)} /></Field><Field label="Due date"><input type="date" style={styles.input} value={due} onChange={(e) => setDue(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Open plan</button></div></form></ModalShell>;
}
