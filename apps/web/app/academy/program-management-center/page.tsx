...
type WorkspaceState = {
  schema: "TA14_ACADEMY_PROGRAM_MANAGEMENT_V1";
...
const STORAGE_KEY = "ta14-academy-program-management-center-v1";
...
const seedProgram: ProgramProfile[] = [
  ...
  },
  {
    ...
    title: "Program Success Coordinator",
    ...
    specialties: ["Program coaching", "Program analytics", "Learning design"],
    goals: ["Institutionalize advisoring review", "Publish annual program management report"],
...
const seedCompetencies: Competency[] = [
  ...
  },
  {
    id: "CMP-014",
    domain: "Leadership",
    name: "Advising and Program Coaching",
...
const seedCompetencyRecords: CompetencyRecord[] = [
  {
    ...
    assessed: "2026-03-01",
    expires: "2027-03-01",
    assessor: "Program Calibration Panel",
    evidenceIds: ["EVD-001"],
...
const seedPlans: SuccessPlan[] = [
  ...
  },
  {
    ...
    due: "2026-10-16",
    progress: 88,
    objectives: ["Program coaching", "Program analytics"],
    successMeasures: ["Observed practice meets declared competency threshold", "Evidence packet is complete and challengeable"],
    dependencies: ["Scheduled observation", "Required learning activities"],
    risks: [],
    lastUpdate: "2026-07-25",
...
const seedActivities: LearningActivity[] = [
  {
    ...
    description: "Structured program management activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-002",
...
const seedPathways: LearningPathway[] = [
  {
    id: "PTH-001",
    name: "New Program Authorization Pathway",
  ...
  {
    id: "PTH-002",
    name: "Advanced Governance Program Pathway",
  ...
  {
    id: "PTH-004",
    name: "Program Leadership Pathway",
...
const seedImprovements: ImprovementPlan[] = [
  {
    ...
    opened: "2026-04-05",
    due: "2026-07-25",
    owner: "Program Success Committee",
...
const seedAudit: AuditEvent[] = [
  {
    ...
    actor: "Program Success Committee",
...
function validateWorkspace(value: unknown): value is WorkspaceState {
  ...
  return (
    candidate.schema === "TA14_ACADEMY_PROGRAM_MANAGEMENT_V1" &&
...
const tabs: { key: TabKey; label: string; description: string }[] = [
  ...
  { key: "pathways", label: "Curriculum Paths", description: "Sequenced program progression" },
  { key: "advising", label: "Governance Reviews", description: "Bounded coaching relationships" },
  { key: "observations", label: "Quality Reviews", description: "Academic review and learning evidence" },
...
export default function ProgramDevelopmentCenterPage() {
  ...
  function exportJson() {
    ...
    addAudit("WORKSPACE_EXPORTED", "Program Management Center", "ALLOW", "Exported complete JSON workspace.");
  ...
  function resetWorkspace() {
    if (!window.confirm("Reset the Program Management Center to its institutional seed state?")) return;
    ...
    <main style={styles.page}>
      ...
      <header style={styles.header}>
        <div>
          ...
          <h1 style={styles.title}>Program Management Center</h1>
          <p style={styles.subtitle}>
            Govern program growth through preserved plans, evidence-bound competency, advising,
...
function ActivityModal({ competencies, onClose, onSave }: { competencies: Competency[]; onClose: () => void; onSave: (activity: LearningActivity) => void }) {
  ...
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("ACT"), title, provider: "TA-14 Academy", category, format: "WORKSHOP", status: "PLANNED", start: today(), end: today(), hours, seats: 12, enrolled: [], competencyIds: [competencyId], facilitator: "To be assigned", description: "New program management activity pending facilitator and evidence-plan review." }); }
...
function ImprovementModal({ program, onClose, onSave }: { program: ProgramProfile[]; onClose: () => void; onSave: (plan: ImprovementPlan) => void }) {
  ...
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("IMP"), programId, title, trigger, status: "OPEN", priority: "HIGH", opened: today(), due, owner: "Program Success Committee", actions: ["Complete bounded review with program member"], checkpoints: ["Initial evidence review", "Midpoint check", "Final determination"], progress: 0, determination: "HOLD" }); }
