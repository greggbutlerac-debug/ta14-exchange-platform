...
type ModalKey = "student" | "plan" | "activity" | "observation" | "evidence" | "improvement" | null;
...
type WorkspaceState = {
  schema: "TA14_ACADEMY_STUDENT_SUCCESS_V1";
...
const STORAGE_KEY = "ta14-academy-student-success-center-v1";
...
const seedStudent: StudentProfile[] = [
  {
    id: "FAC-001",
    name: "Dr. Mara Voss",
    ...
    notes: "Primary student lead for architecture and authority curriculum.",
  },
  {
    id: "FAC-002",
    name: "Jordan Ellis",
    email: "jordan.ellis@academy.example",
    title: "Technical Curriculum Advisor",
  ...
  },
  {
    ...
    program: "Institutional Assurance",
    status: "ACTIVE",
    readiness: 92,
    courseLoad: 61,
    engagementHours: 27,
  ...
  },
  {
    ...
    specialties: ["Student coaching", "Program analytics", "Learning design"],
    goals: ["Institutionalize advisoring review", "Publish annual student success report"],
    notes: "Owns student-development cycle and institutional reporting.",
  },
  {
    id: "FAC-007",
    name: "Selene Brooks",
...
const seedCompetencies: Competency[] = [
  ...
  },
  {
    ...
    evidenceStandard: "Published lesson, learner evidence, and academic review.",
  ...
  },
  {
    id: "CMP-014",
    domain: "Leadership",
    name: "Advising and Student Coaching",
    description: "Guides student growth without laundering authority or suppressing adverse evidence.",
    requiredLevel: "LEAD",
...
const seedCompetencyRecords: CompetencyRecord[] = [
  {
    ...
    assessed: "2026-03-01",
    expires: "2027-03-01",
    assessor: "Student Calibration Panel",
    evidenceIds: ["EVD-001"],
...
const seedPlans: SuccessPlan[] = [
  {
    id: "PLN-001",
    studentId: "FAC-001",
    title: "2026 Student Success Plan \u2014 Dr. Mara Voss",
  ...
  },
  {
    id: "PLN-002",
    studentId: "FAC-002",
    title: "2026 Student Success Plan \u2014 Jordan Ellis",
    cycle: "2026 Annual Cycle",
    status: "AT_RISK",
    priority: "CRITICAL",
    owner: "Daniel Cho",
    ...
    successMeasures: ["Observed practice meets declared competency threshold", "Evidence packet is complete and challengeable"],
    dependencies: ["Scheduled observation", "Required learning activities"],
    risks: ["Course load may delay milestones"],
    lastUpdate: "2026-07-25",
  },
  {
    id: "PLN-003",
    studentId: "FAC-003",
    title: "2026 Student Success Plan \u2014 Priya Nand",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-004",
    studentId: "FAC-004",
    title: "2026 Student Success Plan \u2014 Mateo Ruiz",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-005",
    studentId: "FAC-005",
    title: "2026 Student Success Plan \u2014 Amina Cole",
    cycle: "2026 Annual Cycle",
    status: "PAUSED",
    priority: "HIGH",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-006",
    studentId: "FAC-006",
    title: "2026 Student Success Plan \u2014 Daniel Cho",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
    ...
    due: "2026-10-16",
    progress: 88,
    objectives: ["Student coaching", "Program analytics"],
    successMeasures: ["Observed practice meets declared competency threshold", "Evidence packet is complete and challengeable"],
    dependencies: ["Scheduled observation", "Required learning activities"],
    risks: [],
    lastUpdate: "2026-07-25",
  },
  {
    id: "PLN-007",
    studentId: "FAC-007",
    title: "2026 Student Success Plan \u2014 Selene Brooks",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "HIGH",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-008",
    studentId: "FAC-008",
    title: "2026 Student Success Plan \u2014 Owen Hart",
    cycle: "2026 Annual Cycle",
    status: "DRAFT",
    priority: "HIGH",
    owner: "Daniel Cho",
...
const seedActivities: LearningActivity[] = [
  {
    ...
    description: "Structured student success activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-002",
...
const seedPathways: LearningPathway[] = [
  {
    id: "PTH-001",
    name: "New Student Authorization Pathway",
    audience: "Advisor candidates",
    description: "Builds platform, instructional, authority, and observation readiness before independent learning.",
  ...
  {
    id: "PTH-002",
    name: "Advanced Governance Student Pathway",
  ...
  },
  {
    ...
    audience: "HVAC and environmental student",
  ...
  {
    id: "PTH-004",
    name: "Student Leadership Pathway",
    audience: "Program leads and advisors",
    description: "Prepares student for coaching, stewardship, calibration, and institutional review.",
...
const seedPortfolio: PortfolioItem[] = [
  {
    ...
    category: "Assessment",
    created: "2026-03-05",
    summary: "Preserved student-development artifact with declared scope, source attribution, and limitations.",
    tags: ["student-development", "evidence", "academy"],
...
const seedImprovements: ImprovementPlan[] = [
  {
    ...
    opened: "2026-04-05",
    due: "2026-07-25",
    owner: "Student Success Committee",
  ...
  },
  {
    id: "IMP-004",
    studentId: "FAC-006",
    title: "Course load stabilization",
...
const seedEvidence: EvidenceRecord[] = [
  {
    ...
    relatedIds: ["FAC-001"],
    limitations: "Supports the declared student-development purpose only; does not independently authorize learning.",
  },
  {
    id: "EVD-002",
    studentId: "FAC-002",
...
const seedAudit: AuditEvent[] = [
  {
    ...
    actor: "Student Success Committee",
    action: "EVIDENCE_VERIFIED",
    target: "Success plan 1",
    determination: "ALLOW",
    detail: "Preserved student-development action with actor, target, determination, and bounded detail.",
  },
  {
    id: "AUD-002",
...
function validateWorkspace(value: unknown): value is WorkspaceState {
  ...
  return (
    candidate.schema === "TA14_ACADEMY_STUDENT_SUCCESS_V1" &&
    Array.isArray(candidate.student) &&
...
const tabs: { key: TabKey; label: string; description: string }[] = [
  ...
  { key: "pathways", label: "Learning Pathways", description: "Sequenced student progression" },
  { key: "advising", label: "Advising", description: "Bounded coaching relationships" },
  { key: "observations", label: "Observations", description: "Academic review and learning evidence" },
  { key: "portfolio", label: "Learning Portfolio", description: "Preserved student artifacts" },
...
export default function StudentDevelopmentCenterPage() {
  const [workspace, setWorkspace] = useState<WorkspaceState>(initialState);
  const [tab, setTab] = useState<TabKey>("overview");
  const [search, setSearch] = useState("");
  const [program, setProgram] = useState("ALL");
  const [statusFilter, setStatusFilter] = useState("ALL");
  const [selectedStudentId, setSelectedStudentId] = useState(seedStudent[0].id);
  ...
  const programs = useMemo(
    () => Array.from(new Set(workspace.student.map((member) => member.program))).sort(),
    [workspace.student],
  );

  const filteredStudent = useMemo(() => {
    const query = search.trim().toLowerCase();
    return workspace.student.filter((member) => {
      const matchesQuery =
        !query ||
  ...
  }, [workspace.student, search, program, statusFilter]);

  const selectedStudent = workspace.student.find((member) => member.id === selectedStudentId) ?? workspace.student[0];
  const selectedPlans = workspace.plans.filter((plan) => plan.studentId === selectedStudent?.id);
  const selectedRecords = workspace.competencyRecords.filter((record) => record.studentId === selectedStudent?.id);
  const selectedEvidence = workspace.evidence.filter((record) => record.studentId === selectedStudent?.id);

  const metrics = useMemo(() => {
    const active = workspace.student.filter((member) => member.status === "ACTIVE").length;
    const atRisk = workspace.plans.filter((plan) => plan.status === "AT_RISK").length;
    const readiness = Math.round(
      workspace.student.reduce((sum, member) => sum + member.readiness, 0) /
        Math.max(workspace.student.length, 1),
    );
  ...
  function updateStudent(member: StudentProfile) {
    setWorkspace((current) => ({
      ...current,
      student: current.student.map((item) => (item.id === member.id ? member : item)),
    }));
    addAudit("FACULTY_UPDATED", member.id, "ALLOW", `Updated student profile for ${member.name}.`);
    setToast("Student profile preserved locally.");
  }

  function exportJson() {
    downloadText(
      `TA-14_Student_Development_Export_${today()}.json`,
      JSON.stringify(workspace, null, 2),
    );
    addAudit("WORKSPACE_EXPORTED", "Student Success Center", "ALLOW", "Exported complete JSON workspace.");
    setToast("Complete JSON workspace exported.");
  }

  function exportStudentCsv() {
    downloadText(
      `TA-14_Student_Development_Student_${today()}.csv`,
      toCsv(workspace.student as unknown as Record<string, unknown>[]),
      "text/csv",
    );
    addAudit("FACULTY_CSV_EXPORTED", "Student roster", "ALLOW", "Exported student roster as CSV.");
    setToast("Student CSV exported.");
  }
  ...
  async function importWorkspace(event: ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      setWorkspace(parsed);
      setSelectedStudentId(parsed.student[0]?.id ?? "");
      setToast("Validated workspace imported.");
    } catch {
      setToast("Import denied: file does not match the Student Success schema.");
    } finally {
      event.target.value = "";
    }
  }
  ...
  function resetWorkspace() {
    if (!window.confirm("Reset the Student Success Center to its institutional seed state?")) return;
    setWorkspace(initialState);
    setSelectedStudentId(initialState.student[0].id);
    ...
    <main style={styles.page}>
      ...
      <header style={styles.header}>
        <div>
          ...
          <h1 style={styles.title}>Student Success Center</h1>
          <p style={styles.subtitle}>
            Govern student growth through preserved plans, evidence-bound competency, advising,
        ...
        <div style={styles.headerActions}>
          ...
          <button style={styles.buttonSecondary} onClick={exportStudentCsv}>Export CSV</button>
      ...
      <section style={styles.metricsGrid}>
        <MetricCard label="Active student" value={metrics.active} detail={`${workspace.student.length} total records`} />
        ...
        <MetricCard label="Overdue observations" value={metrics.overdueObservations} detail="Academic review continuity risk" tone="#ff6b76" />
      </section>
        ...
        <div style={styles.content}>
          <div style={styles.toolbar}>
            <input
              ...
              placeholder="Search student, title, program, specialty..."
            />
            ...
            <button style={styles.buttonPrimary} onClick={() => setModal("student")}>New student record</button>
          </div>

          {tab === "overview" && <OverviewTab workspace={workspace} filteredStudent={filteredStudent} onSelect={setSelectedStudentId} selectedStudentId={selectedStudentId} />}
          {tab === "success-plans" && <PlansTab workspace={workspace} selectedStudent={selectedStudent} onCreate={() => setModal("plan")} />}
          {tab === "competencies" && <CompetenciesTab workspace={workspace} selectedStudent={selectedStudent} />}
          {tab === "catalog" && <CatalogTab workspace={workspace} onCreate={() => setModal("activity")} />}
          {tab === "pathways" && <PathwaysTab workspace={workspace} />}
          {tab === "advising" && <AdvisingTab workspace={workspace} />}
          {tab === "observations" && <ObservationsTab workspace={workspace} onCreate={() => setModal("observation")} />}
          {tab === "portfolio" && <PortfolioTab workspace={workspace} selectedStudent={selectedStudent} />}
        ...
        <section style={styles.detailRail}>
          <div style={styles.detailHeader}>
            <div>
              ...
              <h2 style={styles.sectionTitle}>{selectedStudent.name}</h2>
              <p style={styles.muted}>{selectedStudent.title} · {selectedStudent.program}</p>
            </div>
            <span style={{ ...styles.scoreBadge, borderColor: scoreTone(selectedStudent.readiness), color: scoreTone(selectedStudent.readiness) }}>
              {selectedStudent.readiness}% ready
            </span>
          </div>
          <div style={styles.detailGrid}>
            <DetailCard title="Development posture" lines={[
              `Status: ${selectedStudent.status}`,
              `Course load: ${selectedStudent.courseLoad}%`,
              `Engagement and participation: ${selectedStudent.engagementHours}/${selectedStudent.engagementTarget} hours`,
              `Next review: ${selectedStudent.nextReview}`,
            ]} />
            ...
            <DetailCard title="Declared goals" lines={selectedStudent.goals} />
          </div>
        </section>
      )}

      {modal === "student" && <StudentModal onClose={() => setModal(null)} onSave={(member) => { setWorkspace((current) => ({ ...current, student: [member, ...current.student] })); setSelectedStudentId(member.id); setModal(null); setToast("Student record created."); }} />}
      {modal === "plan" && <PlanModal student={workspace.student} selectedStudentId={selectedStudentId} onClose={() => setModal(null)} onSave={(plan) => { setWorkspace((current) => ({ ...current, plans: [plan, ...current.plans] })); setModal(null); setToast("Success plan created."); }} />}
      ...
      {modal === "observation" && <ObservationModal student={workspace.student} onClose={() => setModal(null)} onSave={(observation) => { setWorkspace((current) => ({ ...current, observations: [observation, ...current.observations] })); setModal(null); setToast("Observation scheduled."); }} />}
      {modal === "evidence" && <EvidenceModal student={workspace.student} onClose={() => setModal(null)} onSave={(record) => { setWorkspace((current) => ({ ...current, evidence: [record, ...current.evidence] })); setModal(null); setToast("Evidence record preserved."); }} />}
      {modal === "improvement" && <ImprovementModal student={workspace.student} onClose={() => setModal(null)} onSave={(plan) => { setWorkspace((current) => ({ ...current, improvements: [plan, ...current.improvements] })); setModal(null); setToast("Improvement plan opened."); }} />}
...
function OverviewTab({ workspace, filteredStudent, onSelect, selectedStudentId }: { workspace: WorkspaceState; filteredStudent: StudentProfile[]; onSelect: (id: string) => void; selectedStudentId: string }) {
  ...
  return <div>
    <SectionHeading title="Student development mission control" description="A single view of student readiness, workload, development risk, and upcoming institutional activity." />
    <div style={styles.twoColumn}>
      <div style={styles.panel}>
        <h3 style={styles.cardTitle}>Student roster</h3>
        <div style={styles.stack}>{filteredStudent.map((member) => <button key={member.id} onClick={() => onSelect(member.id)} style={{ ...styles.listButton, ...(selectedStudentId === member.id ? styles.listButtonActive : {}) }}><div><strong>{member.name}</strong><div style={styles.mutedSmall}>{member.title} · {member.program}</div></div><div style={styles.listRight}><Pill tone={member.status === "ACTIVE" ? "#45d483" : "#f0c35c"}>{member.status}</Pill><strong style={{ color: scoreTone(member.readiness) }}>{member.readiness}%</strong></div></button>)}</div>
      </div>
      <div style={styles.panel}>
...
function PlansTab({ workspace, selectedStudent, onCreate }: { workspace: WorkspaceState; selectedStudent?: StudentProfile; onCreate: () => void }) {
  const plans = selectedStudent ? workspace.plans.filter((plan) => plan.studentId === selectedStudent.id) : workspace.plans;
...
function CompetenciesTab({ workspace, selectedStudent }: { workspace: WorkspaceState; selectedStudent?: StudentProfile }) {
  return <div><SectionHeading title="Learning competency framework" description="Required levels are separated from current evidence and cannot be inferred from role title alone." /><div style={styles.tableWrap}><table style={styles.table}><thead><tr><th>Competency</th><th>Domain</th><th>Required</th><th>Current</th><th>Score</th><th>Evidence determination</th><th>Revalidate</th></tr></thead><tbody>{workspace.competencies.map((competency) => { const record = workspace.competencyRecords.find((item) => item.competencyId === competency.id && item.studentId === selectedStudent?.id); const current = record?.level ?? "UNASSESSED"; const gap = record ? competencyRank[record.level] < competencyRank[competency.requiredLevel] : true; return <tr key={competency.id}><td><strong>{competency.name}</strong><div style={styles.mutedSmall}>{competency.description}</div></td><td>{competency.domain}</td><td><Pill>{competency.requiredLevel}</Pill></td><td><Pill tone={gap ? "#f0c35c" : "#45d483"}>{current}</Pill></td><td>{record ? `${record.score}%` : "—"}</td><td>{record ? <Pill tone={determinationTone[record.determination]}>{record.determination}</Pill> : <Pill tone="#f0c35c">HOLD</Pill>}</td><td>{competency.revalidationMonths} months</td></tr>; })}</tbody></table></div></div>;
}
...
function ActivityModal({ competencies, onClose, onSave }: { competencies: Competency[]; onClose: () => void; onSave: (activity: LearningActivity) => void }) {
  ...
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("ACT"), title, provider: "TA-14 Academy", category, format: "WORKSHOP", status: "PLANNED", start: today(), end: today(), hours, seats: 12, enrolled: [], competencyIds: [competencyId], facilitator: "To be assigned", description: "New student success activity pending facilitator and evidence-plan review." }); }
...
function ObservationModal({ student, onClose, onSave }: { student: StudentProfile[]; onClose: () => void; onSave: (observation: Observation) => void }) {
  const [studentId, setStudentId] = useState(student[0]?.id ?? ""); const [course, setCourse] = useState(""); const [reviewer, setReviewer] = useState(""); const [date, setDate] = useState(today());
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("OBS"), studentId, reviewer, course, date, status: "SCHEDULED", score: 0, strengths: [], findings: [], requiredActions: [], evidenceIds: [] }); }
  return <ModalShell title="Schedule peer observation" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Student"><select style={styles.input} value={studentId} onChange={(e) => setStudentId(e.target.value)}>{student.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Course"><input required style={styles.input} value={course} onChange={(e) => setCourse(e.target.value)} /></Field><Field label="Reviewer"><input required style={styles.input} value={reviewer} onChange={(e) => setReviewer(e.target.value)} /></Field><Field label="Date"><input type="date" style={styles.input} value={date} onChange={(e) => setDate(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Schedule</button></div></form></ModalShell>;
}

function EvidenceModal({ student, onClose, onSave }: { student: StudentProfile[]; onClose: () => void; onSave: (record: EvidenceRecord) => void }) {
  const [studentId, setStudentId] = useState(student[0]?.id ?? ""); const [title, setTitle] = useState(""); const [type, setType] = useState("ARTIFACT"); const [source, setSource] = useState(""); const [limitations, setLimitations] = useState("");
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("EVD"), studentId, title, type, source, captured: today(), status: "PENDING", hash: `pending:${uid("hash")}`, relatedIds: [studentId], limitations }); }
  return <ModalShell title="Preserve student evidence" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Student"><select style={styles.input} value={studentId} onChange={(e) => setStudentId(e.target.value)}>{student.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Evidence title"><input required style={styles.input} value={title} onChange={(e) => setTitle(e.target.value)} /></Field><Field label="Type"><input required style={styles.input} value={type} onChange={(e) => setType(e.target.value)} /></Field><Field label="Source"><input required style={styles.input} value={source} onChange={(e) => setSource(e.target.value)} /></Field><Field label="Limitations"><textarea required style={styles.textarea} value={limitations} onChange={(e) => setLimitations(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Preserve record</button></div></form></ModalShell>;
}

function ImprovementModal({ student, onClose, onSave }: { student: StudentProfile[]; onClose: () => void; onSave: (plan: ImprovementPlan) => void }) {
  const [studentId, setStudentId] = useState(student[0]?.id ?? ""); const [title, setTitle] = useState(""); const [trigger, setTrigger] = useState(""); const [due, setDue] = useState(today());
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("IMP"), studentId, title, trigger, status: "OPEN", priority: "HIGH", opened: today(), due, owner: "Student Success Committee", actions: ["Complete bounded review with student member"], checkpoints: ["Initial evidence review", "Midpoint check", "Final determination"], progress: 0, determination: "HOLD" }); }
  return <ModalShell title="Open student improvement plan" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Student"><select style={styles.input} value={studentId} onChange={(e) => setStudentId(e.target.value)}>{student.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Plan title"><input required style={styles.input} value={title} onChange={(e) => setTitle(e.target.value)} /></Field><Field label="Trigger finding"><textarea required style={styles.textarea} value={trigger} onChange={(e) => setTrigger(e.target.value)} /></Field><Field label="Due date"><input type="date" style={styles.input} value={due} onChange={(e) => setDue(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Open plan</button></div></form></ModalShell>;
}
