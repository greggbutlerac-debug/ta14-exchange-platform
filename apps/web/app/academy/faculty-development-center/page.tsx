...
type ModalKey = "faculty" | "plan" | "activity" | "observation" | "evidence" | "improvement" | null;
...
type WorkspaceState = {
  schema: "TA14_ACADEMY_FACULTY_DEVELOPMENT_V1";
...
const STORAGE_KEY = "ta14-academy-faculty-development-center-v1";
...
const seedFaculty: FacultyMember[] = [
  {
    id: "FAC-001",
    name: "Dr. Mara Voss",
    ...
    goals: ["Publish advanced teaching portfolio", "Qualify two new lead instructors"],
    notes: "Primary faculty lead for architecture and authority curriculum.",
  },
  {
    id: "FAC-002",
    name: "Jordan Ellis",
    ...
    goals: ["Reduce teaching overload", "Complete advanced facilitation pathway"],
  ...
  },
  {
    ...
    title: "Simulation Faculty",
    department: "Applied Governance Labs",
    status: "ACTIVE",
    readiness: 87,
    teachingLoad: 67,
    ceHours: 24,
  ...
  },
  {
    ...
    department: "Environmental Integrity",
    status: "LEAVE",
    readiness: 74,
    teachingLoad: 32,
    ceHours: 12,
    ...
    goals: ["Return-to-teaching readiness review", "Refresh Academy platform training"],
  ...
  },
  {
    ...
    title: "Faculty Development Coordinator",
    ...
    specialties: ["Faculty coaching", "Program analytics", "Learning design"],
    goals: ["Institutionalize mentoring review", "Publish annual faculty development report"],
    notes: "Owns faculty-development cycle and institutional reporting.",
  },
  {
    id: "FAC-007",
    name: "Selene Brooks",
    ...
    notes: "High learner satisfaction with pacing improvement opportunity.",
  },
  {
    id: "FAC-008",
    name: "Owen Hart",
    ...
    department: "Academy Foundations",
    status: "REVIEW",
    readiness: 69,
    teachingLoad: 45,
    ceHours: 14,
    ...
    goals: ["Earn initial teaching authorization", "Complete three observed lessons"],
    notes: "Candidate remains under bounded co-teaching authority.",
  },
];
...
const seedCompetencies: Competency[] = [
  {
    ...
    evidenceStandard: "Observed instruction plus preserved teaching artifact and assessor calibration.",
  ...
  },
  {
    ...
    evidenceStandard: "Published lesson, learner evidence, and peer review.",
  ...
  },
  {
    ...
    description: "Provides actionable feedback while preserving source evidence and learner dignity.",
    requiredLevel: "PRACTITIONER",
    evidenceStandard: "Observation record and learner improvement evidence.",
  ...
  },
  {
    ...
    description: "Operates only within declared teaching, review, and credential authority.",
    requiredLevel: "LEAD",
  ...
  },
  {
    ...
    requiredLevel: "PRACTITIONER",
    evidenceStandard: "Accessibility review and learner accommodation artifact.",
    revalidationMonths: 24,
  },
  {
    id: "CMP-014",
    domain: "Leadership",
    name: "Mentorship and Faculty Coaching",
    description: "Guides faculty growth without laundering authority or suppressing adverse evidence.",
    requiredLevel: "LEAD",
    evidenceStandard: "Mentoring record, observed coaching, and outcome review.",
    revalidationMonths: 18,
  },
  {
    id: "CMP-015",
    ...
    description: "Maintains curriculum continuity, version lineage, and institutional boundaries.",
    requiredLevel: "LEAD",
    evidenceStandard: "Program review packet and governance board finding.",
    revalidationMonths: 12,
  },
];
...
const seedCompetencyRecords: CompetencyRecord[] = [
  {
    ...
    assessed: "2026-03-01",
    expires: "2027-03-01",
    assessor: "Faculty Calibration Panel",
    evidenceIds: ["EVD-001"],
...
const seedPlans: DevelopmentPlan[] = [
  {
    id: "PLN-001",
    facultyId: "FAC-001",
    title: "2026 Faculty Development Plan \u2014 Dr. Mara Voss",
  ...
  },
  {
    id: "PLN-002",
    facultyId: "FAC-002",
    title: "2026 Faculty Development Plan \u2014 Jordan Ellis",
    cycle: "2026 Annual Cycle",
    status: "AT_RISK",
    priority: "CRITICAL",
    owner: "Daniel Cho",
    ...
    successMeasures: ["Observed practice meets declared competency threshold", "Evidence packet is complete and challengeable"],
    dependencies: ["Scheduled observation", "Required learning activities"],
    risks: ["Teaching load may delay milestones"],
    lastUpdate: "2026-07-25",
  },
  {
    id: "PLN-003",
    facultyId: "FAC-003",
    title: "2026 Faculty Development Plan \u2014 Priya Nand",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-004",
    facultyId: "FAC-004",
    title: "2026 Faculty Development Plan \u2014 Mateo Ruiz",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-005",
    facultyId: "FAC-005",
    title: "2026 Faculty Development Plan \u2014 Amina Cole",
    cycle: "2026 Annual Cycle",
    status: "PAUSED",
    priority: "HIGH",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-006",
    facultyId: "FAC-006",
    title: "2026 Faculty Development Plan \u2014 Daniel Cho",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "MEDIUM",
    owner: "Daniel Cho",
    ...
    due: "2026-10-16",
    progress: 88,
    objectives: ["Faculty coaching", "Program analytics"],
    successMeasures: ["Observed practice meets declared competency threshold", "Evidence packet is complete and challengeable"],
    dependencies: ["Scheduled observation", "Required learning activities"],
    risks: [],
    lastUpdate: "2026-07-25",
  },
  {
    id: "PLN-007",
    facultyId: "FAC-007",
    title: "2026 Faculty Development Plan \u2014 Selene Brooks",
    cycle: "2026 Annual Cycle",
    status: "ACTIVE",
    priority: "HIGH",
    owner: "Daniel Cho",
  ...
  },
  {
    id: "PLN-008",
    facultyId: "FAC-008",
    title: "2026 Faculty Development Plan \u2014 Owen Hart",
    cycle: "2026 Annual Cycle",
    status: "DRAFT",
    priority: "HIGH",
    owner: "Daniel Cho",
...
const seedActivities: LearningActivity[] = [
  {
    ...
    description: "Structured faculty development activity with preserved participation evidence, declared outcomes, and bounded authority.",
  },
  {
    id: "ACT-002",
  ...
  {
    id: "ACT-003",
    title: "Accessible Course Design 1",
    provider: "TA-14 Academy",
    category: "Assessment",
    format: "COACHING",
    status: "PLANNED",
  ...
  {
    id: "ACT-006",
    title: "Mentor Coaching Roundtable 1",
    provider: "TA-14 Academy",
  ...
  {
    id: "ACT-010",
    title: "Teaching Portfolio Clinic 1",
    provider: "TA-14 Academy",
    category: "Technical Practice",
    format: "CONFERENCE",
    status: "IN_PROGRESS",
  ...
  {
    id: "ACT-013",
    title: "Accessible Course Design 2",
    provider: "TA-14 Academy",
    category: "Instructional Practice",
    format: "WORKSHOP",
    status: "OPEN",
  ...
  {
    id: "ACT-016",
    title: "Mentor Coaching Roundtable 2",
    provider: "TA-14 Academy",
    category: "Technical Practice",
    format: "CONFERENCE",
    status: "COMPLETE",
  ...
  {
    id: "ACT-020",
    title: "Teaching Portfolio Clinic 2",
    provider: "TA-14 Academy",
    category: "Governance Foundations",
    format: "COURSE",
    status: "COMPLETE",
  ...
  {
    id: "ACT-023",
    title: "Accessible Course Design 3",
    provider: "TA-14 Academy",
    category: "Leadership",
    format: "SELF_STUDY",
    status: "PLANNED",
  ...
  {
    id: "ACT-026",
    title: "Mentor Coaching Roundtable 3",
    provider: "TA-14 Academy",
    category: "Governance Foundations",
    format: "COURSE",
    status: "IN_PROGRESS",
  ...
  {
    id: "ACT-030",
    title: "Teaching Portfolio Clinic 3",
    provider: "TA-14 Academy",
    category: "Digital Practice",
    format: "LAB",
    status: "IN_PROGRESS",
...
const seedPathways: LearningPathway[] = [
  {
    id: "PTH-001",
    name: "New Faculty Authorization Pathway",
    audience: "Instructor candidates",
    description: "Builds platform, instructional, authority, and observation readiness before independent teaching.",
  ...
  {
    id: "PTH-002",
    name: "Advanced Governance Faculty Pathway",
    audience: "Experienced governance instructors",
  ...
  {
    id: "PTH-003",
    name: "Technical Evidence Instructor Pathway",
    audience: "HVAC and environmental faculty",
    description: "Qualifies instructors to teach evidence sequence, electrical boundaries, and atmospheric records.",
  ...
  {
    id: "PTH-004",
    name: "Faculty Leadership Pathway",
    audience: "Program leads and mentors",
    description: "Prepares faculty for coaching, stewardship, calibration, and institutional review.",
...
const seedMentorships: Mentorship[] = [
  {
    id: "MNT-001",
    mentorId: "FAC-006",
    menteeId: "FAC-003",
...
const seedObservations: Observation[] = [
  {
    ...
    facultyId: "FAC-001",
    reviewer: "Mateo Ruiz",
    course: "Electricity Made Simple",
    date: "2026-06-04",
    status: "COMPLETE",
    score: 77,
    strengths: ["Clear evidence boundaries", "Strong learner engagement"],
  ...
  },
  {
    ...
    facultyId: "FAC-005",
    reviewer: "Owen Hart",
    course: "Execution Admissibility",
    date: "2026-02-16",
    status: "COMPLETE",
    score: 76,
    strengths: ["Clear evidence boundaries", "Strong learner engagement"],
...
const seedPortfolio: PortfolioItem[] = [
  {
    ...
    category: "Assessment",
    created: "2026-03-05",
    summary: "Preserved faculty-development artifact with declared scope, source attribution, and limitations.",
    tags: ["faculty-development", "evidence", "academy"],
  ...
  },
  {
    id: "PRT-010",
    facultyId: "FAC-002",
    title: "Mentorship Reflection 10",
    category: "Leadership",
    created: "2026-05-17",
    summary: "Preserved faculty-development artifact with declared scope, source attribution, and limitations.",
    tags: ["faculty-development", "evidence", "academy"],
  ...
  },
  {
    id: "PRT-016",
    facultyId: "FAC-008",
    title: "Mentorship Reflection 16",
    category: "Leadership",
    created: "2026-04-17",
    summary: "Preserved faculty-development artifact with declared scope, source attribution, and limitations.",
    tags: ["faculty-development", "evidence", "academy"],
  ...
  },
  {
    id: "PRT-022",
    facultyId: "FAC-006",
    title: "Mentorship Reflection 22",
    category: "Leadership",
    created: "2026-03-17",
    summary: "Preserved faculty-development artifact with declared scope, source attribution, and limitations.",
    tags: ["faculty-development", "evidence", "academy"],
...
const seedImprovements: ImprovementPlan[] = [
  {
    ...
    opened: "2026-04-05",
    due: "2026-07-25",
    owner: "Faculty Development Committee",
  ...
  },
  {
    id: "IMP-004",
    facultyId: "FAC-006",
    title: "Teaching load stabilization",
...
const seedEvidence: EvidenceRecord[] = [
  {
    ...
    relatedIds: ["FAC-001"],
    limitations: "Supports the declared faculty-development purpose only; does not independently authorize teaching.",
  },
  {
    id: "EVD-002",
    facultyId: "FAC-002",
    title: "Teaching artifact 2",
    type: "ARTIFACT",
...
const seedAudit: AuditEvent[] = [
  {
    ...
    actor: "Faculty Development Committee",
    action: "EVIDENCE_VERIFIED",
    target: "Development plan 1",
    determination: "ALLOW",
    detail: "Preserved faculty-development action with actor, target, determination, and bounded detail.",
  },
  {
    id: "AUD-002",
...
function validateWorkspace(value: unknown): value is WorkspaceState {
  ...
  return (
    candidate.schema === "TA14_ACADEMY_FACULTY_DEVELOPMENT_V1" &&
...
const tabs: { key: TabKey; label: string; description: string }[] = [
  ...
  { key: "plans", label: "Development Plans", description: "Objectives, milestones, and risk" },
  { key: "competencies", label: "Competency Framework", description: "Required capability and evidence" },
  { key: "catalog", label: "Learning Catalog", description: "Workshops, courses, coaching, and labs" },
  { key: "pathways", label: "Learning Pathways", description: "Sequenced faculty progression" },
  { key: "mentorship", label: "Mentorship", description: "Bounded coaching relationships" },
  { key: "observations", label: "Observations", description: "Peer review and teaching evidence" },
  { key: "portfolio", label: "Teaching Portfolio", description: "Preserved faculty artifacts" },
...
export default function FacultyDevelopmentCenterPage() {
  const [workspace, setWorkspace] = useState<WorkspaceState>(initialState);
  const [tab, setTab] = useState<TabKey>("overview");
  const [search, setSearch] = useState("");
  const [department, setDepartment] = useState("ALL");
  const [statusFilter, setStatusFilter] = useState("ALL");
  const [selectedFacultyId, setSelectedFacultyId] = useState(seedFaculty[0].id);
  ...
  const departments = useMemo(
    () => Array.from(new Set(workspace.faculty.map((member) => member.department))).sort(),
    [workspace.faculty],
  );

  const filteredFaculty = useMemo(() => {
    const query = search.trim().toLowerCase();
    return workspace.faculty.filter((member) => {
      const matchesQuery =
        !query ||
        [member.name, member.email, member.title, member.department, ...member.specialties]
          .join(" ")
          .toLowerCase()
          .includes(query);
  ...
  }, [workspace.faculty, search, department, statusFilter]);

  const selectedFaculty = workspace.faculty.find((member) => member.id === selectedFacultyId) ?? workspace.faculty[0];
  const selectedPlans = workspace.plans.filter((plan) => plan.facultyId === selectedFaculty?.id);
  const selectedRecords = workspace.competencyRecords.filter((record) => record.facultyId === selectedFaculty?.id);
  const selectedEvidence = workspace.evidence.filter((record) => record.facultyId === selectedFaculty?.id);

  const metrics = useMemo(() => {
    const active = workspace.faculty.filter((member) => member.status === "ACTIVE").length;
    const atRisk = workspace.plans.filter((plan) => plan.status === "AT_RISK").length;
    const readiness = Math.round(
      workspace.faculty.reduce((sum, member) => sum + member.readiness, 0) /
        Math.max(workspace.faculty.length, 1),
    );
  ...
  function updateFaculty(member: FacultyMember) {
    setWorkspace((current) => ({
      ...current,
      faculty: current.faculty.map((item) => (item.id === member.id ? member : item)),
    }));
    addAudit("FACULTY_UPDATED", member.id, "ALLOW", `Updated faculty profile for ${member.name}.`);
    setToast("Faculty profile preserved locally.");
  }

  function exportJson() {
    downloadText(
      `TA-14_Faculty_Development_Export_${today()}.json`,
      JSON.stringify(workspace, null, 2),
    );
    addAudit("WORKSPACE_EXPORTED", "Faculty Development Center", "ALLOW", "Exported complete JSON workspace.");
    setToast("Complete JSON workspace exported.");
  }

  function exportFacultyCsv() {
    downloadText(
      `TA-14_Faculty_Development_Faculty_${today()}.csv`,
      toCsv(workspace.faculty as unknown as Record<string, unknown>[]),
      "text/csv",
    );
    addAudit("FACULTY_CSV_EXPORTED", "Faculty roster", "ALLOW", "Exported faculty roster as CSV.");
    setToast("Faculty CSV exported.");
  }
  ...
  async function importWorkspace(event: ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      setWorkspace(parsed);
      setSelectedFacultyId(parsed.faculty[0]?.id ?? "");
      setToast("Validated workspace imported.");
    } catch {
      setToast("Import denied: file does not match the Faculty Development schema.");
    } finally {
      event.target.value = "";
    }
  }
  ...
  function resetWorkspace() {
    if (!window.confirm("Reset the Faculty Development Center to its institutional seed state?")) return;
    setWorkspace(initialState);
    setSelectedFacultyId(initialState.faculty[0].id);
    ...
    <main style={styles.page}>
      ...
      <header style={styles.header}>
        <div>
          ...
          <h1 style={styles.title}>Faculty Development Center</h1>
          <p style={styles.subtitle}>
            Govern faculty growth through preserved plans, evidence-bound competency, mentorship,
        ...
        <div style={styles.headerActions}>
          ...
          <button style={styles.buttonSecondary} onClick={exportFacultyCsv}>Export CSV</button>
      ...
      <section style={styles.canonBanner}>
        ...
        <span>
          Development activity does not itself create teaching authority. Readiness must remain tied to
          current evidence, declared scope, preserved continuity, and authorized institutional review.
        </span>
      </section>

      <section style={styles.metricsGrid}>
        <MetricCard label="Active faculty" value={metrics.active} detail={`${workspace.faculty.length} total records`} />
        ...
        <MetricCard label="Open improvement plans" value={metrics.openImprovements} detail="Open, monitoring, or escalated" tone="#ff9b6b" />
        <MetricCard label="Overdue observations" value={metrics.overdueObservations} detail="Peer review continuity risk" tone="#ff6b76" />
      </section>
        ...
        <div style={styles.content}>
          <div style={styles.toolbar}>
            <input
              ...
              placeholder="Search faculty, title, department, specialty..."
            />
            <select style={styles.select} value={department} onChange={(event) => setDepartment(event.target.value)}>
            ...
            <button style={styles.buttonPrimary} onClick={() => setModal("faculty")}>New faculty record</button>
          </div>

          {tab === "overview" && <OverviewTab workspace={workspace} filteredFaculty={filteredFaculty} onSelect={setSelectedFacultyId} selectedFacultyId={selectedFacultyId} />}
          {tab === "plans" && <PlansTab workspace={workspace} selectedFaculty={selectedFaculty} onCreate={() => setModal("plan")} />}
          {tab === "competencies" && <CompetenciesTab workspace={workspace} selectedFaculty={selectedFaculty} />}
          {tab === "catalog" && <CatalogTab workspace={workspace} onCreate={() => setModal("activity")} />}
          {tab === "pathways" && <PathwaysTab workspace={workspace} />}
          {tab === "mentorship" && <MentorshipTab workspace={workspace} />}
          {tab === "observations" && <ObservationsTab workspace={workspace} onCreate={() => setModal("observation")} />}
          {tab === "portfolio" && <PortfolioTab workspace={workspace} selectedFaculty={selectedFaculty} />}
        ...
        <section style={styles.detailRail}>
          <div style={styles.detailHeader}>
            <div>
              ...
              <h2 style={styles.sectionTitle}>{selectedFaculty.name}</h2>
              <p style={styles.muted}>{selectedFaculty.title} · {selectedFaculty.department}</p>
            </div>
            <span style={{ ...styles.scoreBadge, borderColor: scoreTone(selectedFaculty.readiness), color: scoreTone(selectedFaculty.readiness) }}>
              {selectedFaculty.readiness}% ready
            </span>
          </div>
          <div style={styles.detailGrid}>
            <DetailCard title="Development posture" lines={[
              `Status: ${selectedFaculty.status}`,
              `Teaching load: ${selectedFaculty.teachingLoad}%`,
              `Continuing education: ${selectedFaculty.ceHours}/${selectedFaculty.ceTarget} hours`,
              `Next review: ${selectedFaculty.nextReview}`,
            ]} />
            ...
            <DetailCard title="Declared goals" lines={selectedFaculty.goals} />
          </div>
        </section>
      )}

      {modal === "faculty" && <FacultyModal onClose={() => setModal(null)} onSave={(member) => { setWorkspace((current) => ({ ...current, faculty: [member, ...current.faculty] })); setSelectedFacultyId(member.id); setModal(null); setToast("Faculty record created."); }} />}
      {modal === "plan" && <PlanModal faculty={workspace.faculty} selectedFacultyId={selectedFacultyId} onClose={() => setModal(null)} onSave={(plan) => { setWorkspace((current) => ({ ...current, plans: [plan, ...current.plans] })); setModal(null); setToast("Development plan created."); }} />}
      ...
      {modal === "observation" && <ObservationModal faculty={workspace.faculty} onClose={() => setModal(null)} onSave={(observation) => { setWorkspace((current) => ({ ...current, observations: [observation, ...current.observations] })); setModal(null); setToast("Observation scheduled."); }} />}
      {modal === "evidence" && <EvidenceModal faculty={workspace.faculty} onClose={() => setModal(null)} onSave={(record) => { setWorkspace((current) => ({ ...current, evidence: [record, ...current.evidence] })); setModal(null); setToast("Evidence record preserved."); }} />}
      {modal === "improvement" && <ImprovementModal faculty={workspace.faculty} onClose={() => setModal(null)} onSave={(plan) => { setWorkspace((current) => ({ ...current, improvements: [plan, ...current.improvements] })); setModal(null); setToast("Improvement plan opened."); }} />}
...
function OverviewTab({ workspace, filteredFaculty, onSelect, selectedFacultyId }: { workspace: WorkspaceState; filteredFaculty: FacultyMember[]; onSelect: (id: string) => void; selectedFacultyId: string }) {
  ...
  return <div>
    <SectionHeading title="Faculty development mission control" description="A single view of faculty readiness, workload, development risk, and upcoming institutional activity." />
    <div style={styles.twoColumn}>
      <div style={styles.panel}>
        <h3 style={styles.cardTitle}>Faculty roster</h3>
        <div style={styles.stack}>{filteredFaculty.map((member) => <button key={member.id} onClick={() => onSelect(member.id)} style={{ ...styles.listButton, ...(selectedFacultyId === member.id ? styles.listButtonActive : {}) }}><div><strong>{member.name}</strong><div style={styles.mutedSmall}>{member.title} · {member.department}</div></div><div style={styles.listRight}><Pill tone={member.status === "ACTIVE" ? "#45d483" : "#f0c35c"}>{member.status}</Pill><strong style={{ color: scoreTone(member.readiness) }}>{member.readiness}%</strong></div></button>)}</div>
      </div>
      <div style={styles.panel}>
...
function PathwaysTab({ workspace }: { workspace: WorkspaceState }) {
  return <div><SectionHeading title="Faculty learning pathways" description="Sequenced development does not replace the evidence and authority required for final teaching authorization." /><div style={styles.cardGrid}>{workspace.pathways.map((pathway) => <article key={pathway.id} style={styles.panel}><div style={styles.cardHeader}><h3 style={styles.cardTitle}>{pathway.name}</h3><Pill tone={pathway.status === "PUBLISHED" ? "#45d483" : "#f0c35c"}>{pathway.status}</Pill></div><p style={styles.muted}>{pathway.description}</p><div style={styles.metaGrid}><span>Audience: {pathway.audience}</span><span>Estimated: {pathway.estimatedHours} hours</span><span>{pathway.activityIds.length} activities</span><span>{pathway.competencyIds.length} competencies</span></div><div style={styles.chain}>{pathway.activityIds.map((id, index) => <span key={id} style={styles.chainNode}>{index + 1}. {workspace.activities.find((item) => item.id === id)?.title ?? id}</span>)}</div></article>)}</div></div>;
}

function MentorshipTab({ workspace }: { workspace: WorkspaceState }) {
  const name = (id: string) => workspace.faculty.find((member) => member.id === id)?.name ?? id;
  return <div><SectionHeading title="Mentorship and coaching" description="Mentorship preserves role boundaries, goals, cadence, meeting evidence, and outcome review." /><div style={styles.cardGrid}>{workspace.mentorships.map((item) => <article key={item.id} style={styles.panel}><div style={styles.cardHeader}><div><Pill tone={item.status === "ACTIVE" ? "#45d483" : "#f0c35c"}>{item.status}</Pill><h3 style={styles.cardTitle}>{name(item.mentorId)} → {name(item.menteeId)}</h3></div><span style={styles.largeNumber}>{item.meetingCount}</span></div><p style={styles.muted}>{item.focus}</p><div style={styles.metaGrid}><span>Cadence: {item.cadence}</span><span>Next meeting: {item.nextMeeting}</span><span>Window: {item.start} → {item.end}</span></div>{item.goals.map((goal) => <div key={goal} style={styles.goalLine}>• {goal}</div>)}</article>)}</div></div>;
}

function ObservationsTab({ workspace, onCreate }: { workspace: WorkspaceState; onCreate: () => void }) {
  const name = (id: string) => workspace.faculty.find((member) => member.id === id)?.name ?? id;
  return <div><SectionHeading title="Performance observations and peer review" description="Observation preserves strengths, adverse findings, required actions, and supporting evidence." action={<button style={styles.buttonPrimary} onClick={onCreate}>Schedule observation</button>} /><div style={styles.tableWrap}><table style={styles.table}><thead><tr><th>Faculty</th><th>Course</th><th>Reviewer</th><th>Date</th><th>Status</th><th>Score</th><th>Findings</th><th>Required action</th></tr></thead><tbody>{workspace.observations.map((item) => <tr key={item.id}><td><strong>{name(item.facultyId)}</strong></td><td>{item.course}</td><td>{item.reviewer}</td><td>{item.date}</td><td><Pill tone={item.status === "OVERDUE" ? "#ff6b76" : item.status === "COMPLETE" ? "#45d483" : "#f0c35c"}>{item.status}</Pill></td><td style={{ color: scoreTone(item.score), fontWeight: 800 }}>{item.score}%</td><td>{item.findings.join("; ")}</td><td>{item.requiredActions.join("; ") || "None"}</td></tr>)}</tbody></table></div></div>;
}

function PortfolioTab({ workspace, selectedFaculty }: { workspace: WorkspaceState; selectedFaculty?: FacultyMember }) {
  const items = selectedFaculty ? workspace.portfolio.filter((item) => item.facultyId === selectedFaculty.id) : workspace.portfolio;
  return <div><SectionHeading title="Teaching evidence portfolio" description="Artifacts preserve provenance, declared visibility, evidence relationships, and bounded claims." /><div style={styles.cardGrid}>{items.map((item) => <article key={item.id} style={styles.panel}><div style={styles.cardHeader}><div><Pill>{item.category}</Pill><h3 style={styles.cardTitle}>{item.title}</h3></div><Pill tone={item.visibility === "PUBLIC" ? "#45d483" : item.visibility === "INSTITUTION" ? "#71b7ff" : "#9f8cff"}>{item.visibility}</Pill></div><p style={styles.muted}>{item.summary}</p><div style={styles.tagRow}>{item.tags.map((tag) => <span key={tag} style={styles.tag}>#{tag}</span>)}</div><div style={styles.mutedSmall}>{item.created} · {item.evidenceIds.length} evidence relationship(s)</div></article>)}</div></div>;
}

function ImprovementTab({ workspace, onCreate }: { workspace: WorkspaceState; onCreate: () => void }) {
  const name = (id: string) => workspace.faculty.find((member) => member.id === id)?.name ?? id;
  return <div><SectionHeading title="Faculty improvement plans" description="Corrective action is separated from punishment and remains tied to findings, checkpoints, and fresh evidence." action={<button style={styles.buttonPrimary} onClick={onCreate}>Open improvement plan</button>} /><div style={styles.cardGrid}>{workspace.improvements.map((item) => <article key={item.id} style={styles.panel}><div style={styles.cardHeader}><div><Pill tone={item.status === "ESCALATED" ? "#ff6b76" : item.status === "SATISFIED" ? "#45d483" : "#f0c35c"}>{item.status}</Pill><h3 style={styles.cardTitle}>{item.title}</h3><p style={styles.mutedSmall}>{name(item.facultyId)} · Trigger: {item.trigger}</p></div><Pill tone={determinationTone[item.determination]}>{item.determination}</Pill></div><ProgressBar value={item.progress} /><div style={styles.metaGrid}><span>Owner: {item.owner}</span><span>Due: {item.due}</span><span>Priority: {item.priority}</span><span>{item.progress}% complete</span></div><div style={styles.objectiveGrid}><div><strong>Actions</strong>{item.actions.map((action) => <p key={action} style={styles.mutedSmall}>• {action}</p>)}</div><div><strong>Checkpoints</strong>{item.checkpoints.map((checkpoint) => <p key={checkpoint} style={styles.mutedSmall}>• {checkpoint}</p>)}</div></div></article>)}</div></div>;
}

function ReadinessTab({ workspace }: { workspace: WorkspaceState }) {
  return <div><SectionHeading title="Faculty readiness scoring" description="Readiness is an operational aid, not independent permission. Missing authority or stale evidence can still force HOLD." /><div style={styles.tableWrap}><table style={styles.table}><thead><tr><th>Faculty</th><th>Readiness</th><th>Teaching load</th><th>CE completion</th><th>Competency ALLOW</th><th>Verified evidence</th><th>Open improvement</th><th>Institutional posture</th></tr></thead><tbody>{workspace.faculty.map((member) => { const records = workspace.competencyRecords.filter((item) => item.facultyId === member.id); const allow = records.filter((item) => item.determination === "ALLOW").length; const evidence = workspace.evidence.filter((item) => item.facultyId === member.id && item.status === "VERIFIED").length; const improvements = workspace.improvements.filter((item) => item.facultyId === member.id && item.status !== "SATISFIED").length; const posture: Determination = member.readiness >= 85 && member.teachingLoad <= 85 && improvements === 0 ? "ALLOW" : member.readiness >= 70 ? "HOLD" : "ESCALATE"; return <tr key={member.id}><td><strong>{member.name}</strong><div style={styles.mutedSmall}>{member.title}</div></td><td><strong style={{ color: scoreTone(member.readiness) }}>{member.readiness}%</strong><ProgressBar value={member.readiness} /></td><td>{member.teachingLoad}%</td><td>{member.ceHours}/{member.ceTarget}</td><td>{allow}/{records.length}</td><td>{evidence}</td><td>{improvements}</td><td><Pill tone={determinationTone[posture]}>{posture}</Pill></td></tr>; })}</tbody></table></div><div style={styles.infoBox}><strong>Scoring boundary:</strong> readiness combines development evidence, workload, continuing education, observed practice, and corrective-action posture. It cannot override expired authorization, unresolved conflict, or missing institutional authority.</div></div>;
}

function EvidenceTab({ workspace, onCreate }: { workspace: WorkspaceState; onCreate: () => void }) {
  const name = (id: string) => workspace.faculty.find((member) => member.id === id)?.name ?? id;
  return <div><SectionHeading title="Faculty development evidence repository" description="Every record declares source, capture date, verification state, related objects, hash, and limitations." action={<button style={styles.buttonPrimary} onClick={onCreate}>Preserve evidence</button>} /><div style={styles.tableWrap}><table style={styles.table}><thead><tr><th>Evidence</th><th>Faculty</th><th>Type</th><th>Source</th><th>Captured</th><th>Status</th><th>Hash</th><th>Limitations</th></tr></thead><tbody>{workspace.evidence.map((item) => <tr key={item.id}><td><strong>{item.title}</strong><div style={styles.mutedSmall}>{item.id}</div></td><td>{name(item.facultyId)}</td><td>{item.type}</td><td>{item.source}</td><td>{item.captured}</td><td><Pill tone={item.status === "VERIFIED" ? "#45d483" : item.status === "PENDING" ? "#f0c35c" : "#ff6b76"}>{item.status}</Pill></td><td><code style={styles.code}>{item.hash.slice(0, 18)}…</code></td><td>{item.limitations}</td></tr>)}</tbody></table></div></div>;
}

function ReportsTab({ workspace }: { workspace: WorkspaceState }) {
  const byDepartment = Array.from(new Set(workspace.faculty.map((item) => item.department))).map((department) => { const members = workspace.faculty.filter((item) => item.department === department); return { department, count: members.length, readiness: Math.round(members.reduce((sum, item) => sum + item.readiness, 0) / members.length), load: Math.round(members.reduce((sum, item) => sum + item.teachingLoad, 0) / members.length) }; });
  return <div><SectionHeading title="Faculty development reporting" description="Reports expose favorable and adverse conditions without turning approval rate into the primary success metric." /><div style={styles.threeColumn}><SummaryPanel title="Participation" items={[`${workspace.activities.reduce((sum, item) => sum + item.enrolled.length, 0)} enrollments`, `${workspace.mentorships.filter((item) => item.status === "ACTIVE").length} active mentorships`, `${workspace.portfolio.length} portfolio artifacts`]} /><SummaryPanel title="Quality and review" items={[`${workspace.observations.filter((item) => item.status === "FOLLOW_UP").length} follow-up observations`, `${workspace.plans.filter((item) => item.status === "AT_RISK").length} plans at risk`, `${workspace.improvements.filter((item) => item.status === "ESCALATED").length} escalated improvements`]} /><SummaryPanel title="Evidence integrity" items={[`${workspace.evidence.filter((item) => item.status === "VERIFIED").length} verified`, `${workspace.evidence.filter((item) => item.status === "PENDING").length} pending`, `${workspace.evidence.filter((item) => item.status === "SUPERSEDED").length} superseded`]} /></div><div style={styles.panel}><h3 style={styles.cardTitle}>Department posture</h3>{byDepartment.map((item) => <div key={item.department} style={styles.reportRow}><div><strong>{item.department}</strong><div style={styles.mutedSmall}>{item.count} faculty</div></div><div style={styles.reportBars}><span>Readiness {item.readiness}%</span><ProgressBar value={item.readiness} /><span>Load {item.load}%</span><ProgressBar value={item.load} /></div></div>)}</div></div>;
}
...
function FacultyModal({ onClose, onSave }: { onClose: () => void; onSave: (member: FacultyMember) => void }) {
  const [form, setForm] = useState({ name: "", email: "", title: "", department: "", notes: "" });
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("FAC"), name: form.name, email: form.email, title: form.title, department: form.department, status: "REVIEW", readiness: 0, teachingLoad: 0, ceHours: 0, ceTarget: 24, mentorId: null, joined: today(), nextReview: today(), specialties: [], goals: ["Complete initial faculty development plan"], notes: form.notes }); }
  return <ModalShell title="Create faculty development record" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Name"><input required style={styles.input} value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} /></Field><Field label="Email"><input required type="email" style={styles.input} value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} /></Field><Field label="Title"><input required style={styles.input} value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} /></Field><Field label="Department"><input required style={styles.input} value={form.department} onChange={(e) => setForm({ ...form, department: e.target.value })} /></Field><Field label="Notes"><textarea style={styles.textarea} value={form.notes} onChange={(e) => setForm({ ...form, notes: e.target.value })} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Create record</button></div></form></ModalShell>;
}

function PlanModal({ faculty, selectedFacultyId, onClose, onSave }: { faculty: FacultyMember[]; selectedFacultyId: string; onClose: () => void; onSave: (plan: DevelopmentPlan) => void }) {
  const [facultyId, setFacultyId] = useState(selectedFacultyId); const [title, setTitle] = useState(""); const [due, setDue] = useState(today()); const [objective, setObjective] = useState("");
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("PLN"), facultyId, title, cycle: "2026 Development Cycle", status: "DRAFT", priority: "MEDIUM", owner: "Faculty Development Committee", start: today(), due, progress: 0, objectives: [objective], successMeasures: ["Objective supported by preserved evidence"], dependencies: ["Faculty and supervisor review"], risks: [], lastUpdate: today() }); }
  return <ModalShell title="Create professional development plan" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Faculty"><select style={styles.input} value={facultyId} onChange={(e) => setFacultyId(e.target.value)}>{faculty.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Plan title"><input required style={styles.input} value={title} onChange={(e) => setTitle(e.target.value)} /></Field><Field label="Due date"><input required type="date" style={styles.input} value={due} onChange={(e) => setDue(e.target.value)} /></Field><Field label="Primary objective"><textarea required style={styles.textarea} value={objective} onChange={(e) => setObjective(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Create plan</button></div></form></ModalShell>;
}
...
function ActivityModal({ competencies, onClose, onSave }: { competencies: Competency[]; onClose: () => void; onSave: (activity: LearningActivity) => void }) {
  const [title, setTitle] = useState(""); const [category, setCategory] = useState("Instructional Practice"); const [hours, setHours] = useState(4); const [competencyId, setCompetencyId] = useState(competencies[0]?.id ?? "");
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("ACT"), title, provider: "TA-14 Academy", category, format: "WORKSHOP", status: "PLANNED", start: today(), end: today(), hours, seats: 12, enrolled: [], competencyIds: [competencyId], facilitator: "To be assigned", description: "New faculty development activity pending facilitator and evidence-plan review." }); }
...
function ObservationModal({ faculty, onClose, onSave }: { faculty: FacultyMember[]; onClose: () => void; onSave: (observation: Observation) => void }) {
  const [facultyId, setFacultyId] = useState(faculty[0]?.id ?? ""); const [course, setCourse] = useState(""); const [reviewer, setReviewer] = useState(""); const [date, setDate] = useState(today());
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("OBS"), facultyId, reviewer, course, date, status: "SCHEDULED", score: 0, strengths: [], findings: [], requiredActions: [], evidenceIds: [] }); }
  return <ModalShell title="Schedule peer observation" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Faculty"><select style={styles.input} value={facultyId} onChange={(e) => setFacultyId(e.target.value)}>{faculty.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Course"><input required style={styles.input} value={course} onChange={(e) => setCourse(e.target.value)} /></Field><Field label="Reviewer"><input required style={styles.input} value={reviewer} onChange={(e) => setReviewer(e.target.value)} /></Field><Field label="Date"><input type="date" style={styles.input} value={date} onChange={(e) => setDate(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Schedule</button></div></form></ModalShell>;
}

function EvidenceModal({ faculty, onClose, onSave }: { faculty: FacultyMember[]; onClose: () => void; onSave: (record: EvidenceRecord) => void }) {
  const [facultyId, setFacultyId] = useState(faculty[0]?.id ?? ""); const [title, setTitle] = useState(""); const [type, setType] = useState("ARTIFACT"); const [source, setSource] = useState(""); const [limitations, setLimitations] = useState("");
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("EVD"), facultyId, title, type, source, captured: today(), status: "PENDING", hash: `pending:${uid("hash")}`, relatedIds: [facultyId], limitations }); }
  return <ModalShell title="Preserve faculty evidence" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Faculty"><select style={styles.input} value={facultyId} onChange={(e) => setFacultyId(e.target.value)}>{faculty.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Evidence title"><input required style={styles.input} value={title} onChange={(e) => setTitle(e.target.value)} /></Field><Field label="Type"><input required style={styles.input} value={type} onChange={(e) => setType(e.target.value)} /></Field><Field label="Source"><input required style={styles.input} value={source} onChange={(e) => setSource(e.target.value)} /></Field><Field label="Limitations"><textarea required style={styles.textarea} value={limitations} onChange={(e) => setLimitations(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Preserve record</button></div></form></ModalShell>;
}

function ImprovementModal({ faculty, onClose, onSave }: { faculty: FacultyMember[]; onClose: () => void; onSave: (plan: ImprovementPlan) => void }) {
  const [facultyId, setFacultyId] = useState(faculty[0]?.id ?? ""); const [title, setTitle] = useState(""); const [trigger, setTrigger] = useState(""); const [due, setDue] = useState(today());
  function submit(event: FormEvent) { event.preventDefault(); onSave({ id: uid("IMP"), facultyId, title, trigger, status: "OPEN", priority: "HIGH", opened: today(), due, owner: "Faculty Development Committee", actions: ["Complete bounded review with faculty member"], checkpoints: ["Initial evidence review", "Midpoint check", "Final determination"], progress: 0, determination: "HOLD" }); }
  return <ModalShell title="Open faculty improvement plan" onClose={onClose}><form onSubmit={submit} style={styles.formGrid}><Field label="Faculty"><select style={styles.input} value={facultyId} onChange={(e) => setFacultyId(e.target.value)}>{faculty.map((m) => <option key={m.id} value={m.id}>{m.name}</option>)}</select></Field><Field label="Plan title"><input required style={styles.input} value={title} onChange={(e) => setTitle(e.target.value)} /></Field><Field label="Trigger finding"><textarea required style={styles.textarea} value={trigger} onChange={(e) => setTrigger(e.target.value)} /></Field><Field label="Due date"><input type="date" style={styles.input} value={due} onChange={(e) => setDue(e.target.value)} /></Field><div style={styles.modalActions}><button type="button" style={styles.buttonSecondary} onClick={onClose}>Cancel</button><button style={styles.buttonPrimary}>Open plan</button></div></form></ModalShell>;
}
