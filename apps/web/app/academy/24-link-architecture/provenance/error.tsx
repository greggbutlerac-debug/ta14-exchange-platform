...
export default function TA14ProvenanceError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("TA-14 provenance route error", error);
  }, [error]);
      ...
      <section className="mx-auto flex min-h-screen max-w-4xl items-center px-6 py-20 lg:px-8">
        <div className="w-full rounded-3xl border border-rose-300/20 bg-white/[0.03] p-8 sm:p-10">
          <p className="text-xs font-semibold uppercase tracking-[0.22em] text-rose-200">
            TA-14 Provenance · Recovery Boundary
          </p>

          <h1 className="mt-4 text-3xl font-semibold tracking-tight sm:text-5xl">
            The provenance map could not be resolved.
          </h1>

          <p className="mt-5 max-w-2xl leading-7 text-slate-300">
            The canonical architecture and provenance records remain separate
            from this display failure. Retry the map or continue directly to
            the patent portfolio, patent-family view, or 24-Link Explorer.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              ...
              className="rounded-full border border-indigo-300/20 bg-indigo-300/[0.06] px-5 py-2.5 text-sm font-semibold text-indigo-200"
            >
