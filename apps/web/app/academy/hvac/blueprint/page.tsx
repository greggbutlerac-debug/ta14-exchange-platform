      ...
      <div className="shell">
        ...
        <header>
          ...
          <div className="actions">
            <a href="/academy/hvac/blueprint/TA14_Evidence_Before_Intervention_HVAC_Service_Competency_Assessment_Blueprint_v0_2.pdf" download>
              DOWNLOAD v0.2 PDF
            </a>
        ...
        <section className="principle">
          ...
          <span>
            The technician must prove the progression from original system state, through justified refrigerant entry and a declared diagnostic determination, to an intervention whose outcome is verified against the preserved baseline.
          </span>
        </section>

        <section>
          <div className="sectionHead"><span>01</span><h2>The six canonical proof elements</h2></div>
          <div className="proofChain">
            {proofChain.map((item, index) => <div key={item}><b>{String(index + 1).padStart(2,"0")}</b><span>{item}</span></div>)}
          </div>
        </section>

        <section>
          <div className="sectionHead"><span>02</span><h2>Assessment domains</h2></div>
        ...
        <section className="niret">
          <div className="sectionHead"><span>03</span><h2>NIRET boundary</h2></div>
          <div className="niretBox">
            <strong>Non-Invasive Refrigerant Entry Threshold</strong>
            <p>Refrigerant-system entry is not treated as a neutral first diagnostic step. The candidate must demonstrate that the current TA-14 Academy NIRET has been satisfied before attaching gauges or otherwise crossing the invasive refrigerant boundary.</p>
            <small>The assessment must use the current Academy NIRET standard. This blueprint does not invent or silently redefine the threshold.</small>
          </div>
        </section>

        <section>
          <div className="sectionHead"><span>04</span><h2>Critical-failure boundary</h2></div>
          <p className="lead">A passing aggregate score cannot override a critical failure. The credential fails closed when the candidate breaks the evidence-before-intervention chain.</p>
        ...
        <section>
          <div className="sectionHead"><span>05</span><h2>Candidate evidence record</h2></div>
          <div className="recordFlow">
            {[
              "Candidate / session identity",
              "Equipment / system identity",
              "Sequence execution record",
              "Original HVAC Performance Record",
              "NIRET evidence set and entry decision",
              "Declared Diagnostic Determination",
              "Intervention scope",
              ...
              "Outcome statement",
              "Assessor scoring / critical-failure review",
            ].map((item, index) => <div key={item}><b>{index + 1}</b><span>{item}</span></div>)}
          </div>
        </section>

        <section className="comparison">
          <div className="sectionHead"><span>06</span><h2>Close the performance loop</h2></div>
          <div className="compareGrid">
            <article><small>ORIGINAL STATE</small><h3>HVAC Performance Record</h3><p>Preserved before intervention. This is the baseline against which the service outcome will be judged.</p></article>
            <div className="arrow">→</div>
            <article><small>POST-INTERVENTION STATE</small><h3>HVAC Post-Performance Record</h3><p>Comparable measurements after intervention establish whether performance improved, was restored, remained unchanged, degraded, or remains unresolved.</p></article>
          </div>
        </section>

        <section className="independence">
          <div className="sectionHead"><span>07</span><h2>Credential separation</h2></div>
          <div className="split">
            <article><small>TA-14 ACADEMY</small><h3>Teach the competency</h3><p>Sequence, simulations, evidence discipline, NIRET reasoning, stop rules, labs, and candidate preparation.</p></article>
            <div className="arrow">→</div>
