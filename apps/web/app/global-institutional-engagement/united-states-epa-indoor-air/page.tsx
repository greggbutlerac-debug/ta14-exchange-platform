...
export default function USEPAIndoorAirShowroom() {
  return <main className="page"><div className="shell">
    ...
    <header>
      ...
      <div className="rule"><small>THE EXECUTION-AUTHORITY QUESTION</small><b>What prevents a command established at T₀ from executing at T₁ after the material conditions that justified it have changed?</b></div><Link className="continuation" href="/global-institutional-engagement/united-states-epa-indoor-air/ashrae-bacnet">CONTINUE TO ASHRAE / BACnet STANDARDS LAYER →</Link>
    </header>
