...
import SwedenExecutionLayer from './SwedenExecutionLayer';
      ...
      <div className="shell">
        ...
        <header>
          <div className="country">
            <div className="flags" aria-label="Sweden and United States">
              <span className="flag" title="Sweden">🇸🇪</span>
              <span className="exchangeMark">×</span>
              <span className="flag" title="United States">🇺🇸</span>
            </div>
            <div>
              <b>SWEDEN × TA-14 · UNITED STATES</b>
              <small>SWEDISH ENVIRONMENTAL PROTECTION AGENCY · AIR QUALITY UNIT · PUBLIC TECHNICAL EXCHANGE</small>
            </div>
          </div>
