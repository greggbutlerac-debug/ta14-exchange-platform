...
const nationalMilestones=[
  ['NATIONAL MONITORING','Estonia operates a national environmental-monitoring programme with ambient air as a dedicated sub-programme and state monitoring information preserved through KESE.'],
  ['AIR-QUALITY MANAGEMENT','EKUK integrates continuous measurements, company self-monitoring, modelling and other air data through Estonia’s Air Quality Management System.'],
  ['2026 LEGAL UPDATE','Estonia amended its air-quality framework in 2026 as the newer EU ambient-air quality requirements move into national implementation.'],
  ['NETWORK MODERNIZATION','Estonia is renewing and expanding the nationwide air-quality monitoring network while updating air-quality requirements and methods.'],
  ['2027 PROGRAMME','Cross-government work is updating Estonia’s national air-pollutant reduction programme for the next European reporting cycle.'],
  ['EXECUTION QUESTION','As measurement, modelling and law become more capable, TA-14 asks how current evidence and competent authority remain explicitly bound to the exact consequence at the moment of action.']
];
...
<section className="national">
  <p className="eye">05 · ESTONIA'S AIR-QUALITY EVOLUTION</p>
  <h2>This is not a static system. The national evidence architecture is actively evolving.</h2>
  <p className="lead2">The execution question becomes more important—not less—as monitoring density, modelling, digital records and regulatory requirements improve. Better observation increases the number of moments when a trustworthy record can influence a consequential decision.</p>
  <div className="milestones">{nationalMilestones.map(([title,text],i)=><article key={title}><span>{String(i+1).padStart(2,'0')}</span><div><b>{title}</b><p>{text}</p></div></article>)}</div>
</section>
...
<section>
  <p className="eye">07 · THE TA-14 QUESTION</p>
...
<section>
  <p className="eye">08 · TA-14 BOLTS ON HERE</p>
...
<section>
  <p className="eye">09 · PUBLIC SOURCE MAP</p>
...
<section className="exam">
  <p className="eye">10 · A BOUNDED ESTONIA EXAMINATION</p>
  <h2>Start small enough that every claim can be inspected.</h2>
  <div className="examgrid">
    <article><span>01</span><b>SELECT ONE REAL RECORD</b><p>Use one bounded ambient-air measurement or model-supported event from Estonia’s existing technical infrastructure. No replacement sensor or platform is required.</p></article>
    <article><span>02</span><b>FREEZE THE RELIANCE</b><p>State exactly what the record is proposed to support: information, warning, permit decision, restriction, enforcement step or another defined consequence.</p></article>
    <article><span>03</span><b>IDENTIFY CURRENT AUTHORITY</b><p>Name the competent institution, legal basis, jurisdiction, time window and scope for that exact consequence rather than treating institutional proximity as permission.</p></article>
    <article><span>04</span><b>CHANGE ONE CONDITION</b><p>Change time, environmental state, threshold, permit status, responsible authority or contemplated act and inspect whether the earlier basis still binds.</p></article>
    <article><span>05</span><b>RETURN A DETERMINATION</b><p>ALLOW, HOLD, DENY or ESCALATE. The system must expose why the consequence can or cannot proceed now.</p></article>
    <article><span>06</span><b>PRESERVE THE OUTCOME</b><p>Record what actually happened and close the chain. A later consequence begins from current reality rather than inheriting stale permission.</p></article>
  </div>
  <div className="requirements"><p><b>ESTONIA BRINGS</b><br/>One bounded use case · native evidence path · applicable authority context · proposed consequence.</p><p><b>TA-14 BRINGS</b><br/>Evidence map · frozen examination object · currentness/binding test · preserved determination and outcome.</p><p><b>NOT REQUIRED</b><br/>Procurement · national deployment · sensor replacement · platform replacement · endorsement · paid pilot.</p></div>
</section>
