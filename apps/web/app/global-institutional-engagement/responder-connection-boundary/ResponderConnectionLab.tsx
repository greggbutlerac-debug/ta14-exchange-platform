...
export default function ResponderConnectionLab(){
  ...
  return <section className="lab">
    <p className="eye">THE LIVE CROSSING · INTERACTIVE</p>
    <h2>Keep the Profiles fixed. <em>Change reality.</em></h2>
    <p className="intro">Choose a state below. The same two Profiles remain available while the live connection, context and local consequence determination change.</p>
