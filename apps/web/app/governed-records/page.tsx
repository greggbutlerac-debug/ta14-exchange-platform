      ...
      <section className="shell">
        <header className="topbar">
          ...
          <nav>
            ...
            <Link className="navButton" href="/workspace/governed-records">
              Enter Playground
            </Link>
          </nav>
        </header>
        ...
        <section className="hero">
          <div className="heroCopy">
            ...
            <div className="actions">
              <Link className="primaryButton" href="/workspace/governed-records">
        ...
        <section className="enterPanel">
          ...
          <Link className="enterButton" href="/workspace/governed-records">
            Enter Playground
            <span>→</span>
          </Link>
        </section>
