...
export default function Layout({children}:{children:ReactNode}){
 return <>
  <FoundingArtifactCopyCorrections artifactId='TA14-EA-000006' sequence={6}/>
  {children}
  <section style={{maxWidth:1180,margin:'28px auto 0',padding:'0 24px'}}>
   <div style={{padding:20,border:'1px solid rgba(242,204,104,.45)',borderRadius:14,background:'rgba(242,204,104,.06)',color:'#eef6ff'}}>
    ...
    <p style={{margin:'10px 0 8px',lineHeight:1.7,color:'#c8d6df'}}>The historical public RECORD_HASH, PACKAGE_HASH, and RECEIPT_HASH values on TA14-EA-000006 are also present on TA14-EA-000003 even though the two artifacts describe materially different events. TA-14 has preserved the published values and opened a parity audit rather than manufacturing replacement historical digests.</p>
  ...
  <ExecutableArtifactProof artifactId='TA14-EA-000006'/>
 </>;
}
