...
const ARTIFACT_ID = "TA14-EA-000008";
const ARTIFACT_TITLE = "Material Condition Changed After Approval";
const ROUTE_ID = "TA14-ROUTE-AIR-INTERVENTION-REVALIDATION-HOLD-008";
const ROUTE_VERSION = "1.0.0";
const RECORD_HASH = "sha256:8e17c901cb4a8f157e2e8c632d2bb49d6814b48b22e6c7b99d9c7f43acb90008";
const PACKAGE_HASH = "sha256:4af24876a1126dd1dd6e84f6f443dfad1d1fb5fb3e453715c74918f5027f0008";
const RECEIPT_HASH = "sha256:b56111e49d870503d146f7ad72d3033dcac65d4f56ee0fe3a131f2a96d280008";
...
const chain: ChainItem[] = [
  {
    ...
    finding: "A governed request sought to increase outdoor-air intake to 60% after approval. Before execution, exterior smoke PM2.5 rose above the route-defined safety limit, materially changing the condition that supported approval.",
    proof: "The requested intervention, affected air-handling system, consequence, operator, destination controller, approval time, and pre-execution condition window were preserved before evaluation.",
  },
  {
    number: "02",
    link: "Record",
    ...
    finding: "The request package, route snapshot, indoor and outdoor sensor records, weather feed, smoke advisory, facilities authority record, and operating change request were captured.",
  ...
  },
  {
    ...
    finding: "Operator identity, route identity, authority, sensor custody, air-handling system, and both approval-time and pre-execution condition records remained continuously attributable.",
  ...
  },
  {
    ...
    finding: "The evidence was current, relevant, attributable, and sufficient to prove that the environmental condition materially changed after approval.",
    proof: "The admissibility evaluator accepted both condition snapshots and required revalidation before any execution could proceed.",
  },
  {
    number: "05",
    link: "Binding",
    ...
    finding: "The frozen route requires approval conditions to remain inside defined environmental tolerances through the final pre-execution check.",
    proof: "The binding record applied the rule that a valid approval cannot survive a material change in the environmental condition it relied upon.",
  },
  {
    number: "06",
    link: "Commit",
    result: "FAIL",
    question: "Did the approved condition remain valid immediately before execution?",
    finding: "The exterior PM2.5 condition changed from 18 µg/m³ at approval to 86 µg/m³ before execution, invalidating the prior approval and requiring a fresh determination.",
    proof: "Runtime link 20 fixed MATERIAL_CONDITION_CHANGED as the earliest controlling failure and committed HOLD before adapter invocation.",
  },
  {
    number: "07",
    link: "Execution",
    ...
    finding: "The building-control adapter suspended the pending command, retained the safe baseline, and prevented fallback, retry, alias, and alternate-endpoint execution.",
    proof: "Receipt EA-000008-EX-01 records HTTP 423, queue state AWAITING_REVALIDATION, zero building-control changes, and no successful bypass.",
  },
  {
    number: "08",
    link: "Outcome",
    ...
    finding: "No intervention change occurred. The threshold exceedance, escalation, held command, and named review path were preserved.",
    proof: "Outcome closure confirms the safe baseline remained unchanged and residual risk was limited to delayed intervention pending fresh evidence and full route revalidation.",
  },
];

const gates: GateItem[] = [
  { number: "01", title: "Observed condition registered", chainLink: "REALITY", result: "PASS", reasonCode: "INTERVENTION_REQUEST_PRESENT", summary: "The proposed intervention invocation and consequence were exact enough to govern." },
  ...
  { number: "03", title: "Request package captured", chainLink: "RECORD", result: "PASS", reasonCode: "REQUEST_CAPTURED", summary: "The intervention request, route snapshot, manifests, ticket, and authority record were preserved before reliance." },
  { number: "04", title: "Record identity fixed", chainLink: "RECORD", result: "PASS", reasonCode: "RECORD_ID_FIXED", summary: "Stable record, route, intervention, and package identifiers were assigned." },
  { number: "05", title: "Actor identity resolved", chainLink: "CONTINUITY", result: "PASS", reasonCode: "ACTOR_IDENTITY_RESOLVED", summary: "Requester, approver, reviewer, and intervention operator identities were resolved." },
  { number: "06", title: "Intervention provenance linked", chainLink: "CONTINUITY", result: "PASS", reasonCode: "MEASUREMENT_PROVENANCE_LINKED", summary: "Both intervention packages were linked to their signed manifests and build provenance." },
  ...
  { number: "09", title: "Evidence relevance tested", chainLink: "ADMISSIBILITY", result: "PASS", reasonCode: "EVIDENCE_RELEVANT", summary: "The manifests and route snapshot directly answered the intervention-threshold question." },
  ...
  { number: "13", title: "Approved intervention fixed", chainLink: "BINDING", result: "PASS", reasonCode: "DELEGATED_THRESHOLD_5_PERCENT", summary: "The governing record fixed five percent as the maximum operator-authorized adjustment." },
  ...
  { number: "16", title: "Separation of duties applied", chainLink: "BINDING", result: "PASS", reasonCode: "DUTIES_SEPARATED", summary: "Requester, approver, and intervention operator remained distinct." },
  { number: "17", title: "Pre-execution condition revalidated", chainLink: "BINDING", result: "FAIL", reasonCode: "MATERIAL_CONDITION_CHANGED", summary: "Exterior smoke PM2.5 exceeded the route-defined pre-execution limit after approval." },
  { number: "18", title: "Earliest failure fixed", chainLink: "BINDING", result: "PASS", reasonCode: "EARLIEST_FAILURE_REVALIDATION", summary: "Pre-execution revalidation fixed the changed environmental condition as the controlling break." },
  { number: "19", title: "Determination fixed", chainLink: "BINDING", result: "PASS", reasonCode: "DETERMINATION_HOLD", summary: "HOLD was committed before the intervention adapter received any release authority." },
  { number: "20", title: "Permitted next action fixed", chainLink: "BINDING", result: "PASS", reasonCode: "FULL_REVALIDATION_REQUIRED", summary: "Only fresh environmental evidence, a new determination, and a complete route rerun may release the intervention." },
  { number: "21", title: "Adapter command generated", chainLink: "EXECUTION", result: "PASS", reasonCode: "COMMAND_HOLD_FOR_REVALIDATION", summary: "The adapter received a hold-for-revalidation command." },
  { number: "22", title: "Unauthorized intervention blocked", chainLink: "EXECUTION", result: "PASS", reasonCode: "HTTP_423_HELD", summary: "The adapter suspended the pending intervention command and retained the safe baseline." },
  ...
  { number: "24", title: "Outcome preserved", chainLink: "OUTCOME", result: "PASS", reasonCode: "ZERO_BUILDING_CONTROL_CHANGES", summary: "No governed execution or building-control transition occurred." },
];

const evidence: EvidenceItem[] = [
  {
    id: "EA-000008-EV-01",
    title: "Building environmental control intervention adjustment request",
    ...
    hash: "1aa79af3...d4c2",
    supports: "Exact target environment, scope, intervention request, destination, and intervention-threshold boundary.",
    limitation: "Controlled demonstration record; no live treatment systems were changed.",
  },
  {
    id: "EA-000008-EV-02",
    title: "Frozen intervention-threshold route",
  ...
  },
  {
    ...
    hash: "bf90e123...93d1",
    supports: "Intervention change purpose, intervention request scope, operating change request relationship, and requested due state.",
    limitation: "Does not independently establish execution authority.",
  },
  {
    id: "EA-000008-EV-04",
    title: "Delegated intervention authority record",
  ...
  },
  {
    ...
    hash: "58a1b51e...e52f",
    supports: "The committed HOLD prevented the changed-condition intervention from reaching the building-control surface and preserved the suspended request.",
    limitation: "Proves control of the TA-14 reference intervention adapter for this bounded event; it does not establish control over unrelated external intervention change systems.",
  },
  {
    id: "EA-000008-EV-08",
    title: "Zero-intervention-change outcome closure",
...
const thresholdEvents: ThresholdEvent[] = [
  {
    ...
    detail: "The approved execution scope was limited to staging diagnostics using intervention profile 5% with read-only privileges.",
    state: "VALID",
  },
  {
    time: "19:13:02",
  ...
  },
  {
    ...
    detail: "The commit validator detected requested 12% intervention increase before release.",
    state: "CHANGED",
  },
  {
    time: "19:15:43",
  ...
  },
  {
    ...
    detail: "The route fixed HOLD and blocked execution pending fresh evidence and full revalidation.",
    state: "HELD",
  },
];
...
const verificationChecks: VerificationCheck[] = [
  ...
  },
  {
    ...
    detail: "Disclosed inputs reproduce HOLD after the material condition-change event.",
  },
  {
    level: "L5",
    label: "Execution effect",
    detail: "The adapter receipt proves HELD, HTTP 423, command suspension, zero intervention changes, and blocked bypass.",
  },
  {
    level: "L6",
...
const acceptanceTests: AcceptanceTest[] = [
  ...
  },
  {
    id: "AT-03",
    result: "PASS",
    condition: "HOLD produced the required suspension, safe-baseline retention, and zero-change execution effect.",
  },
  {
    id: "AT-04",
    result: "PASS",
  ...
  },
  {
    id: "AT-05",
    result: "PASS",
    condition: "The changed environmental condition triggered mandatory pre-execution revalidation and produced HOLD before adapter release.",
  },
  {
    id: "AT-06",
    result: "PASS",
    condition: "The adapter produced a technical receipt proving escalation, command suspension, and zero intervention transition.",
  },
  {
    id: "AT-07",
    result: "PASS",
...
const packageRecord = {
  ...
  scenario: {
    proposedAction:
      "Deploy one named intervention profile only to the authorized environment, with the exact approved privileges, version, time window, and rollback controls.",
    scope: "treatment intervention profile 12%.00",
    consequenceAtStake:
      "No automated intervention change above the delegated five-percent threshold may bind without named route-revalidation review.",
    affectedSubjects: [
      "TA-14 controlled demonstration environment",
      "named building environmental control control environment",
      "reference intervention adapter",
  ...
  commit: {
    ...
    prohibitedAction: "AUTOMATED_BUILDING_CONTROL_CHANGE",
  },
  execution: {
    adapter: "TA-14 Reference Water-Control Adapter",
    adapterVersion: "1.0.0",
    command: "HOLD_FOR_REVALIDATION",
    technicalStatus: 202,
    receiptId: "EA-000008-EX-01",
    receiptHash: RECEIPT_HASH,
    interventionChanges: 0,
...
const thresholdMatrix = [
  ...
  { field: "Operator authority", authorized: "Routine bounded adjustment", requested: "Major process adjustment", result: "FAIL", rule: "Major intervention changes require named route-revalidation review." },
...
const prohibitedCapabilities = [
  "Direct release of a intervention change above five percent",
  "Self-expansion of delegated operating authority",
  "Substitution of an unapproved quantitative setpoint",
  "Execution before named route-revalidation adjudication",
  "Release without complete pre-action revalidation",
  "Alternate-path intervention change after escalation",
];
...
const newAuthorizationRequirements = [
  ...
  "Bind the approval to the current outdoor-air quality measurements, jar-test result, and immutable request hash.",
  "Define the execution window and perform immediate pre-intervention revalidation.",
...
const thresholdRules = [
  ...
  {
    id: "BR-03",
    title: "Intervention profile identity continuity",
    requirement: "The requested setpoint, percentage, duration, and affected air-handling system must match the authorized object.",
  ...
  },
  {
    ...
    requirement: "A changed-condition action must remain held until named adjudication and revalidation are complete.",
    observed: "The request sought immediate release before the required route-revalidation determination.",
    consequence: "Urgency did not enlarge delegated authority.",
  },
  {
    id: "BR-05",
    title: "Rollback readiness",
    requirement: "A bounded rollback and monitoring plan must exist before a changed-condition treatment adjustment.",
    observed: "The original package did not yet contain a route-revalidation-approved intervention plan.",
  ...
  },
  {
    ...
    observed: "The same resolved operator submitted the valid routine request and the changed-condition request.",
    consequence: "Known identity strengthened attribution but did not cure the scope violation.",
  },
  {
    id: "BR-07",
    title: "No alternate-path release",
    requirement: "An held request may not be resubmitted through a less-governed adapter under the same state.",
    observed: "The adapter suspended the execution token and recorded the attempted fallback path.",
    consequence: "The same invalid state remained held across all governed paths.",
  },
  {
    id: "BR-08",
    title: "New event for new authority",
    requirement: "A materially broader authorization must create a new route event.",
    observed: "No route-revalidation approval for twelve percent existed in the frozen record.",
...
const thresholdControlEvidence = [
  ...
  },
  {
    ...
    required: "governed-intervention-primary",
    observed: "governed-intervention-primary",
    result: "PASS",
  ...
  {
    id: "VC-09",
    title: "Environmental program identity",
    required: "coagulant-program-A",
    observed: "coagulant-program-A",
    result: "PASS",
    consequence: "The environmental program identity remained continuous; identity continuity did not cure the changed exterior-air condition.",
  },
  {
    id: "VC-10",
  ...
  },
  {
    ...
    result: "FAIL",
    consequence: "The major-adjustment rollback package required route-revalidation acceptance.",
  },
  {
    id: "VC-16",
    title: "Signature key",
...
const escalationInvariants = [
  "The held request never received a release-capable intervention command.",
  "No outdoor-air setpoint or building-controller state changed.",
  "The original approval remains visible and is not falsely rewritten as though the changed condition never occurred.",
  "The twelve-percent request remains attributable to the requesting operator.",
  "The HOLD commit precedes adapter invocation and cannot be backdated.",
  ...
  "Only a named route-revalidation determination can support a new treatment route.",
...
const packageComponents = [
  ...
  { id: "PKG-07", name: "Threshold comparison matrix", format: "JSON", status: "INCLUDED", purpose: "Delegated versus requested intervention percentage" },
  { id: "PKG-08", name: "24-link runtime ledger", format: "JSON", status: "INCLUDED", purpose: "Ordered gate results" },
  { id: "PKG-09", name: "Determination commit", format: "JSON", status: "INCLUDED", purpose: "Fixed HOLD before action" },
  { id: "PKG-10", name: "Execution hold receipt", format: "JSON", status: "INCLUDED", purpose: "HTTP 423, suspended command, safe-baseline retention, and revalidation queueing" },
  { id: "PKG-11", name: "Bypass-attempt record", format: "JSON", status: "INCLUDED", purpose: "Alternate-path prevention" },
  { id: "PKG-12", name: "Outcome closure", format: "JSON", status: "INCLUDED", purpose: "Verified zero intervention changes" },
...
export default function ExecutionArtifact000008Page() {
  ...
  const tabs: Array<{ id: View; label: string }> = [
    ...
    { id: "intervention", label: "24-gate intervention" },
    { id: "evidence", label: "Evidence manifest" },
    { id: "threshold", label: "Unauthorized intervention threshold" },
    ...
    <main className="artifact-page">
      ...
      <div className="artifact-shell">
        ...
        <section className="artifact-hero">
          <div className="artifact-hero-grid">
            <div className="artifact-hero-copy">
              <div className="artifact-kicker">Execution artifact 06 of 12 · canonical intervention-threshold proof</div>
              <h1>
                Unauthorized intervention threshold
                <span>stopped execution.</span>
              </h1>
              <p className="artifact-lede">
                A executor possessed valid delegated authority when the intervention change route began.
                That authority was exceeded before commitment. TA-14 preserved the change,
                invalidated dependent gates, committed HOLD, suspended the changed-condition intervention, and closed
                the outcome with zero building-control changes executed.
              </p>
            ...
            <aside className="artifact-decision">
              ...
              <div className="artifact-decision-grid">
                <div className="artifact-decision-cell">
                  ...
                  <strong>HTTP 423 · CONDITION CHANGED · HELD</strong>
                </div>
                <div className="artifact-decision-cell">
                  <span>Intervention changes released</span>
                  <strong>$0.00</strong>
                </div>
                <div className="artifact-decision-cell">
                ...
                <div className="artifact-decision-cell">
                  ...
                  <strong>Intervention + route version</strong>
                </div>
              </div>
            </aside>
          </div>
        ...
        <section className="artifact-summary-grid" aria-label="Artifact summary">
          <div className="artifact-stat"><span>Intervention gates</span><strong>24</strong></div>
        ...
        <div className="artifact-layout" id="artifact-workspace">
          <div className="artifact-main">
              ...
              >
                <div className="artifact-proof-grid">
                  <article className="artifact-proof-card">
                    ...
                    <h3>Deploy intervention profile 12% to the treatment decision environment with create, update, and delete privileges.</h3>
                    <p>
                      The route required current intervention change evidence, a frozen target environment destination,
                      valid authority, preserved continuity, an exact intervention manifest, and a
                  ...
                  <article className="artifact-proof-card positive">
                    ...
                    <h3>The architecture failed closed on intervention-threshold mismatch.</h3>
                    <p>
                      TA-14 did not treat an earlier valid approval as permanent permission. It
                      preserved the changed condition state, reran dependent gates, committed HOLD,
                  ...
                  <article className="artifact-proof-card boundary">
                    ...
                    <p>
                      ...
                      reference engine and adapter. It does not certify every organization, intervention change
            ...
            {view === "intervention" ? (
              <Panel
                eyebrow="Complete intervention"
                title="Twenty-four gates preserved the decision path."
                subtitle="The first controlling failure occurred at gate 17 when requested 12% intervention increase failed exact parity with delegated 5% delegated adjustment."
              >
            ...
            {view === "threshold" ? (
              <Panel
                eyebrow="Intervention version integrity"
                title="The identity and authority were valid. The requested intervention threshold was not authorized."
                subtitle="The architecture preserves the valid 5% authorization while refusing to transform it into permission for unapproved 12% intervention increase."
              >
                <div className="artifact-authority-stage">
                  ...
                  <aside className="artifact-break-card">
                    ...
                    <h3>Commit / intervention threshold continuity</h3>
                    <p>
                      Identity, provenance, continuity, evidence, authority, destination, and privileges remained intact. The controlling failure occurred at commit because requested 12% intervention increase did not match delegated 5% delegated adjustment.
                    </p>
                    <div className="artifact-row"><span>Gate</span><strong>17 · Pre-execution condition revalidated</strong></div>
                    <div className="artifact-row" style={{ marginTop: 10 }}><span>Reason</span><strong>MATERIAL_CONDITION_CHANGED</strong></div>
                  </aside>
                </div>
            ...
            {view === "control" ? (
              <Panel
                ...
                subtitle="This is the difference between governance and description. The reference building-control adapter received a HOLD command, suspended the intervention after the changed condition was detected, retained the safe baseline, and generated a technical receipt."
              >
                <div className="artifact-effect">
                  <article className="artifact-effect-box">
                    <div className="artifact-overline">Attempted action</div>
                    <h3>Transmit treatment intervention profile 12%</h3>
                    <p>
                      Target environment, scope, destination, authority chain, route version, and event
                      window were frozen before intervention evaluation.
                    </p>
                    <div className="artifact-receipt-grid">
                      <div className="artifact-row"><span>Adapter</span><strong>Reference Intervention change Adapter</strong></div>
                  ...
                  <article className="artifact-effect-box held">
                    ...
                    <h3>HELD · HTTP 423</h3>
                    <p>
                      The intervention invocation endpoint remained closed to the unauthorized scope. The rejected request was retained in a
                      controlled queue with no alternate-path release and no backdated approval.
                    </p>
                    <div className="artifact-receipt-grid">
                      <div className="artifact-row"><span>Receipt</span><strong>EA-000008-EX-01</strong></div>
                      <div className="artifact-row"><span>Intervention changes</span><strong>0</strong></div>
            ...
            {view === "outcome" ? (
              <Panel
                ...
                subtitle="A HOLD artifact proves that a previously approved action did not bind after its governing condition changed. Fresh evidence and complete revalidation are required before a new determination may be committed."
              >
                <div className="artifact-timeline">
                  <article className="artifact-event"><time>19:12:00 UTC</time><strong>Scenario intake sealed</strong><p>The exact intervention change, target environment, consequence, and declared limits entered the frozen record.</p></article>
                  <article className="artifact-event"><time>19:12:11 UTC</time><strong>Approved intervention resolved</strong><p>The authority record and delegated 5% delegated adjustment manifest were attributable, current, and internally consistent.</p></article>
                  <article className="artifact-event"><time>19:15:41 UTC</time><strong>Unauthorized intervention threshold detected</strong><p>The commit validator detected that 12% intervention increase did not match the frozen and delegated 5% delegated adjustment recorded before execution.</p></article>
                  ...
                  <article className="artifact-event"><time>19:16:02 UTC</time><strong>HOLD committed</strong><p>The non-execution state and revalidation requirement were fixed before adapter invocation.</p></article>
                  <article className="artifact-event"><time>19:16:03 UTC</time><strong>Changed-condition intervention command held</strong><p>Receipt EA-000008-EX-01 recorded HTTP 423 and zero building-control changes executed.</p></article>
          ...
          <aside className="artifact-aside">
            ...
            <section className="artifact-side-card">
              ...
              <p>
                Capture a fresh environmental snapshot, preserve the changed condition, rerun every dependent gate, and generate a new commit. The original HOLD remains
                immutable.
              </p>
              ...
              <button className="artifact-button" type="button" onClick={() => selectView("threshold")}>Inspect intervention-threshold mismatch</button>
            </section>
            ...
            <section className="artifact-side-card artifact-boundary">
              ...
              <p>
                This artifact proves one reference-engine event in which an out-of-scope intervention invocation produced
