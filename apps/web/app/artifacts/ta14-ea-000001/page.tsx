...
const RECORD_HASH = "sha256:de8f213452782f64e0707f8f2f362d4a46b7f370fd2bf6e695bdcd6ab03f1e11";
const PACKAGE_HASH = "sha256:c51388ca0e90f893609011ef54e5e51bc51b61efc537c8353150c227cba31d04";
const RECEIPT_HASH = "sha256:1db6c02c69b26580fb64b39234d66c83f0b39d4816052643091a8a6ef5f26af9";
const COMMIT_HASH = "sha256:8506d2a42cf7b809587a719284f76598a1a78d1f6971abbb22bdba2b52cc8be8";
const OUTCOME_HASH = "sha256:4fca421802c30f21ba731b8e9ff08e4d9f7000c32e7a7b52515506ab282c711a";
const chain: ChainItem[] = [
  {
    ...
    proof: "Scenario record EA-000001-SC-01 fixes the proposed action, affected target, consequence, destination, quantity, and simulation boundary.",
  },
  {
    number: "02",
    link: "Record",
    ...
    finding: "The action request, route snapshot, evidence package, authority record, and target state were preserved before evaluation.",
    proof: "Record manifest EA-000001-RC-01 assigns stable identifiers, timestamps, source attribution, disclosure state, and component hashes.",
  },
  {
    number: "03",
    link: "Continuity",
    ...
    finding: "No material source, authority, route, model, tool, destination, threshold, or dependency changed before commit.",
    proof: "Continuity ledger EA-000001-CT-01 records continuous identity, custody, version, freshness, and dependency state through execution.",
  },
  {
    number: "04",
    link: "Admissibility",
    ...
    finding: "Every mandatory evidence and authority item was current, relevant, sufficient, attributable, and admitted for this bounded event.",
    proof: "Admissibility record EA-000001-AD-01 contains twelve admitted items, zero conflicts, and zero unresolved mandatory conditions.",
  },
  {
    number: "05",
    link: "Binding",
    ...
    finding: "The frozen route permits exactly one release to the reference adapter within the declared action, destination, quantity, model, tool, and time boundary.",
    proof: "Binding record EA-000001-BD-01 applies the governing rule and fixes all execution limits before commitment.",
  },
  {
    number: "06",
    link: "Commit",
    ...
    finding: "ALLOW was committed before adapter invocation with one exact permitted next action and no broader delegation.",
    proof: "Commit record EA-000001-CM-01 preserves the determination, reason codes, approved scope, route version, authority snapshot, and commit time.",
  },
  {
    number: "07",
    link: "Execution",
    ...
    finding: "The reference adapter released exactly one committed action and rejected every field outside the frozen request.",
    proof: "Execution receipt EA-000001-EX-01 records HTTP 202, RELEASED, exact scope parity, one invocation, zero retries, and zero bypass attempts.",
  },
  {
    number: "08",
    link: "Outcome",
    ...
    finding: "The authorized target state occurred once; no additional action, destination, quantity, privilege, or downstream effect was released.",
    proof: "Outcome record EA-000001-OT-01 and independent parity review confirm the bounded result and preserved residual-risk statement.",
  },
];
const gates: GateItem[] = [
  ...
  },
  {
    ...
    summary: "The reference target, initiating actor, reviewer, adapter, and institutional environment are attributable.",
  },
  {
    number: "03",
    ...
    summary: "The action is limited to one release, one destination, one tool, one model, and one event window.",
  },
  {
    number: "04",
    ...
    summary: "The action request and supporting declarations were preserved before reliance.",
  },
  {
    number: "05",
  ...
  },
  {
    ...
    summary: "The route, engine, model, tool, policy, and canonicalization versions were frozen.",
  },
  {
    number: "07",
    ...
    summary: "The initiating actor, steward, reviewer, adapter, and verifier identities remained connected.",
  },
  {
    number: "08",
  ...
  },
  {
    ...
    summary: "No material condition changed between intake, commitment, and adapter invocation.",
  },
  {
    number: "10",
  ...
  },
  {
    ...
    summary: "No contradictory evidence, authority, route, destination, or target-state record remains unresolved.",
  },
  {
    number: "14",
    ...
    summary: "The artifact steward and runtime operator possess valid authority for the exact demonstration action.",
  },
  {
    number: "15",
    title: "Authority scope exact",
    chainLink: "BINDING",
    result: "PASS",
  ...
  },
  {
    ...
    summary: "Requested model, tool, destination, quantity, privileges, and time window remain inside the route boundary.",
  },
  {
    number: "17",
  ...
  },
  {
    ...
    summary: "Evidence, authority, route, model, tool, destination, threshold, and target state were rechecked immediately before release.",
  },
  {
    number: "21",
  ...
  },
  {
    ...
    summary: "The performed action matches the committed action across target, quantity, destination, model, tool, and time.",
  },
  {
    number: "23",
    ...
    summary: "The resulting target state was observed after execution and compared with the expected bounded state.",
  },
  {
    number: "24",
...
const evidence: EvidenceItem[] = [
  {
    ...
    supports: "Exact action, consequence, destination, quantity, affected target, and declared limits.",
  ...
  {
    id: "EA-000001-EV-03",
    title: "Authority identity record",
    ...
    supports: "Actor identity, role, organization, source of authority, and delegation chain.",
    limitation: "Authority is bounded to the controlled institutional demonstration environment.",
  },
  {
    id: "EA-000001-EV-04",
    title: "Authority scope and validity record",
    source: "TA-14 Authority Resolver",
    type: "AUTHORITY_RECORD",
    disclosure: "SELECTIVE",
    status: "ADMITTED",
    ...
    supports: "Exact scope, valid time, revocation state, conflict state, and permitted action.",
    limitation: "Creates no external operational authority.",
  },
  {
    id: "EA-000001-EV-05",
  ...
  },
  {
    ...
    supports: "Identity, evidence, route, model, tool, destination, threshold, target, and state continuity.",
  ...
  },
  {
    ...
    supports: "Applicable rule, authority scope, destination, quantity, model, tool, privilege, and time limits.",
  ...
  },
  {
    ...
    supports: "Immediate recheck of evidence, authority, route, model, tool, destination, threshold, and target state.",
  ...
  },
  {
    ...
    supports: "Committed ALLOW released exactly one bounded action with exact scope parity.",
  ...
  },
  {
    ...
    supports: "Observed target state after release and absence of additional mutations.",
...
const timeline: TimelineItem[] = [
  {
    ...
    detail: "The exact proposed action, consequence, target, destination, quantity, and declared limits entered the canonical record.",
    state: "SEALED",
  },
  {
    time: "08:00:04 UTC",
    event: "Route snapshot frozen",
    detail: "Route TA14-ROUTE-CANONICAL-ALLOW-001 version 2.0.0 and all twenty-four gates were fixed.",
    state: "FROZEN",
  },
  {
    time: "08:00:08 UTC",
    event: "Authority resolved",
    detail: "Identity, role, source, scope, valid time, delegation, revocation, and conflict state were preserved.",
    state: "VALID",
  },
  {
    time: "08:00:12 UTC",
    event: "Evidence manifest completed",
    detail: "Twelve evidence and authority records received stable identifiers and integrity commitments.",
    state: "COMPLETE",
  },
  {
    time: "08:02:40 UTC",
    event: "Continuity validated",
    detail: "No material drift was found across identity, evidence, route, model, tool, destination, threshold, or target state.",
    state: "CONTINUOUS",
  },
  {
    time: "08:02:44 UTC",
  ...
  },
  {
    ...
    detail: "Authority, obligation, scope, destination, quantity, privilege, and time boundaries all remained valid.",
    state: "BOUND",
  },
  {
    time: "08:03:09 UTC",
  ...
  },
  {
    ...
    detail: "The reference adapter accepted one signed bounded command and returned HTTP 202 RELEASED.",
    state: "RELEASED",
  },
  {
    time: "08:03:42 UTC",
...
const verificationChecks: VerificationCheck[] = [
  ...
  },
  {
    ...
    detail: "The adapter receipt proves RELEASED, one invocation, exact scope parity, and zero bypass attempts.",
  },
  {
    level: "6",
...
const boundaryControls: BoundaryControl[] = [
  {
    id: "CONTROL-01",
    field: "Exact action",
    committed: "One bounded release request",
    result: "PASS",
    explanation: "The action contains a stable target, operation, quantity, destination, model, tool, and event window.",
  },
  {
    id: "CONTROL-02",
    field: "Target identity",
    committed: "TA-14 reference execution target",
    result: "PASS",
    explanation: "The target identity resolves to one controlled demonstration resource.",
  },
  {
    id: "CONTROL-03",
    field: "Destination",
    committed: "TA-14 reference adapter",
    result: "PASS",
    explanation: "No alternate destination is authorized or invoked.",
  },
  {
    id: "CONTROL-04",
    field: "Quantity",
    committed: "One action",
    result: "PASS",
    explanation: "The adapter rejects duplicate, batch, retry, or expanded quantity fields.",
  },
  {
    id: "CONTROL-05",
    field: "Model",
    committed: "TA-14 Reference Runtime 2.0",
    result: "PASS",
  ...
  },
  {
    id: "CONTROL-06",
    field: "Tool",
    committed: "Canonical Execution Adapter 2.0",
    result: "PASS",
    explanation: "The permitted and invoked tool identifiers match.",
  },
  {
    id: "CONTROL-07",
    field: "Privilege",
    committed: "Execute bounded reference action",
    result: "PASS",
    explanation: "No administrative, write-broadening, delegation, or secondary privilege is released.",
  },
  {
    id: "CONTROL-08",
    field: "Time window",
  ...
  },
  {
    id: "CONTROL-09",
    field: "Authority",
    committed: "TA-14 Artifact Steward and Runtime Operator",
    result: "PASS",
    explanation: "Both roles were valid, conflict-free, and in scope at commit.",
  },
  {
    id: "CONTROL-10",
  ...
  },
  {
    ...
    result: "PASS",
    explanation: "No unauthorized token, destination, retry, direct call, or alternate adapter path was observed.",
  },
  {
    id: "CONTROL-14",
    ...
    result: "PASS",
    explanation: "The target reached the committed state once with no extra mutation.",
  },
  {
    id: "CONTROL-15",
    field: "Residual risk",
    committed: "Bounded demonstration risk only",
    result: "PASS",
  ...
  },
  {
    ...
    committed: "One event, one route, one adapter",
    result: "PASS",
...
const packageRecord = {
  ...
  scenario: {
    ...
    environment: "Controlled, auditable, fail-closed TA-14 demonstration environment",
    intendedDestination: "TA-14 Reference Execution Adapter",
    amountOrQuantity: "One bounded action",
    requestedModel: "TA-14 Reference Runtime 2.0",
    requestedTool: "Canonical Execution Adapter 2.0",
    declaredLimits: [
      ...
      "The event is a controlled demonstration and is not represented as a production customer record.",
    ],
  },
  route: {
    routeId: ROUTE_ID,
    ...
    policyBasis: [
      ...
      "Release only the exact authorized action, target, destination, quantity, model, tool, privilege, and time window.",
      "Observe and preserve the resulting condition before closure.",
    ],
    jurisdictionProfile: "TA-14 institutional demonstration profile",
    permittedModel: "TA-14 Reference Runtime 2.0",
    permittedTool: "Canonical Execution Adapter 2.0",
  ...
  outcome: {
    ...
    residualRisk:
      "The record is bounded to one controlled demonstration event and does not establish future or universal performance.",
  ...
  claimBoundary: {
    proves: [
      ...
      "The committed determination controlled the reference adapter.",
      "Exactly one authorized action was released.",
      "The observed target state corresponded to the committed action.",
...
export default function Artifact000001Page() {
  ...
  const exportVerificationGuide = () =>
    downloadText(
      ...
      [
        ...
        `Expected execution effect: RELEASED`,
    ...
    <main className="ea-page">
      ...
      <section className="ea-hero">
        <div className="ea-hero-copy">
          <div className="ea-kicker"><span>Door Eight</span><b>Canonical Execution Artifact 000001</b></div>
          <h1>Authorized Release<br /><em>With Verified Outcome</em></h1>
          <p className="ea-hero-lede">
            A complete bounded record proving that admissible evidence, valid authority,
        ...
        <aside className="ea-command-core">
          ...
          <div className="ea-command-grid">
            ...
            <div><span>Execution</span><strong>RELEASED</strong></div>
          ...
          <div className="ea-command-receipt">
            ...
            <strong>HTTP 202 · RELEASED</strong>
        ...
        {view === "inspection" && (
          <section className="ea-view">
            <SectionHeading
              ...
              text="The inspection surface exposes the proposed consequence, controlling route, admitted evidence, valid authority, committed decision, technical execution effect, observed outcome, and exact limits of the public claim."
            />
            <div className="ea-inspection-grid">
              <article className="ea-panel ea-panel-feature">
                ...
                <p>
                  The requested action targeted one controlled resource through one approved adapter,
                  using one approved runtime and one exact action quantity during a fixed event window.
                </p>
                <div className="ea-mini-grid">
                  <div><span>Target</span><strong>TA-14 reference execution target</strong></div>
              ...
              <article className="ea-panel">
                ...
                <h3>RELEASED · HTTP 202</h3>
                <p>
                  The adapter accepted one signed command whose governed fields matched the frozen
                  commit record exactly. No retry, alternate destination, expanded quantity, or bypass occurred.
                </p>
              </article>
            ...
            <div className="ea-two-column">
              <article className="ea-panel ea-authority-card">
                ...
                <div className="ea-record-grid compact">
                  ...
                  <div><span>Authority source</span><strong>Institutional artifact publication mandate</strong></div>
                  <div><span>Conflict state</span><strong>NONE</strong></div>
                  <div><span>Scope</span><strong>Create, review, package, and publish controlled demonstration artifacts</strong></div>
              ...
              <article className="ea-panel ea-authority-card">
                ...
                <div className="ea-record-grid compact">
                  <div><span>Organization</span><strong>TA-14 Authority</strong></div>
                  <div><span>Role state</span><strong>VALID</strong></div>
                  <div><span>Authority source</span><strong>Controlled runtime delegation</strong></div>
                  <div><span>Conflict state</span><strong>NONE</strong></div>
        ...
        {view === "control" && (
          <section className="ea-view">
            <SectionHeading
              ...
              text="Sixteen boundary controls demonstrate parity across action, target, destination, quantity, model, tool, privilege, time, authority, continuity, command, bypass resistance, and outcome."
            />
            ...
            <article className="ea-receipt ea-margin-top">
              ...
              <div>
                <span className="ea-panel-label">Execution receipt EA-000001-EX-01</span>
                <h3>RELEASED · exact scope parity</h3>
                <p>One invocation. Zero retries. Zero bypass attempts. Zero alternate destinations. Zero expanded privileges.</p>
              </div>
        ...
        {view === "outcome" && (
          <section className="ea-view">
            ...
            <div className="ea-outcome-hero">
              ...
              <div><span>Observed state</span><h3>AUTHORIZED_STATE_OBSERVED</h3><p>One authorized action occurred. No additional mutation, destination, quantity, privilege, or downstream command was detected.</p></div>
            ...
            <div className="ea-two-column ea-margin-top">
              ...
              <article className="ea-panel">
                ...
                <p>The outcome claim is supported by the technical receipt, observed target state, component hashes, and independent comparison record.</p>
              </article>
            </div>
          </section>
        )}
      ...
      <section className="ea-next">
        <div><span>Founding artifact series</span><h2>Continue inspecting governed execution behavior.</h2><p>Artifact 000002 demonstrates a HOLD after authority drift. The original ALLOW record remains stable and independently inspectable.</p></div>
        <div className="ea-next-actions"><Link href="/artifacts/ta14-ea-000002">Next artifact →</Link><Link href="/artifacts">Return to library</Link></div>
      </section>
