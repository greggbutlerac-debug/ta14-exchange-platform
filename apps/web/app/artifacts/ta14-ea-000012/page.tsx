...
const ARTIFACT_ID = "TA14-EA-000012";
const ARTIFACT_TITLE = "Preserved Chain-of-Custody Closure Certificate With Independent Outcome Closure";
const ROUTE_ID = "TA14-ROUTE-CHAIN-OF-CUSTODY-CLOSURE-ALLOW-012";
const ROUTE_VERSION = "2.0.0";
const ENGINE_VERSION = "TA14-CEA-2.0.0";
const RECORD_HASH = "sha256:c8f032f0819b146d43785a54fa56b8dfc2a6dd7ef8f65a49672712e4cd12012a";
const PACKAGE_HASH = "sha256:e5ea918c28c1f4a3fe1af6b63a41052f60f1c0b7405de8d1f6fe30c64a12012b";
const RECEIPT_HASH = "sha256:d2a4f1093f57be07ecb18df104b5ff761a0bd951347c810acf13bc095b12012c";
const COMMIT_HASH = "sha256:b7f5a20ef480ae1911da6f746610d524f09e96b9dfa0d6e85b2eab14aa12012d";
const OUTCOME_HASH = "sha256:a2be23dc6f3b2750d8bb941ad28e52ad030de90a686c6236d4257c6f7a12012e";
const chain: ChainItem[] = [
  {
    ...
    finding: "One bounded outcome-closure-certificate request existed inside a controlled outcome-closure review environment.",
    proof: "Scenario record EA-000012-SC-01 fixes the proposed issuance, affected subject, consequence, governed subject system, closure-certificate scope, and non-production closure-certificate issuance boundary.",
  },
  {
    number: "02",
    link: "Record",
    ...
    finding: "The closure-certificate request, preserved outcome-evidence package, closure eligibility state, custody-steward attestation, independent review record, route snapshot, and intended public closure-certificate state were preserved before evaluation.",
    proof: "Record manifest EA-000012-RC-01 assigns stable identifiers, timestamps, source attribution, public disclosure state, and component hashes.",
  },
  {
    number: "03",
    link: "Continuity",
    ...
    finding: "No material source, closure eligibility state, outcome-verification condition, authority, route, governed subject system, closure-certificate scope, or dependency changed before commit.",
    proof: "Continuity ledger EA-000012-CT-01 records continuous identity, custody, version, freshness, and dependency state through execution.",
  },
  {
    number: "04",
    link: "Admissibility",
    ...
    finding: "Every mandatory public metadata item, cryptographic custody commitment, custody record, and bounded outcome-verifier attestation was current, relevant, sufficient, attributable, and admitted while preserving the underlying evidentiary boundary payload.",
    proof: "Admissibility record EA-000012-AD-01 contains twelve admitted evidence and verification concurrence items, zero conflicts, and zero unresolved mandatory conditions.",
  },
  {
    number: "05",
    link: "Binding",
    ...
    finding: "The frozen route permits exactly one scope-bounded outcome-closure certificate only after the Chain-of-Custody Steward confirms the sealed evidence package and the Independent Outcome Verifier verifies the disclosed custody and outcome commitments without changing or reinterpreting the preserved outcome record.",
    proof: "Binding record EA-000012-BD-01 applies the governing rule and fixes all execution limits before commitment.",
  },
  {
    number: "06",
    link: "Commit",
    ...
    finding: "ALLOW was committed only after the custody steward sealed the preserved chain-of-custody package and an independent outcome verifier verified the commitments, admissibility result, closure-certificate scope, purpose, and validity window through bounded public certification.",
    proof: "Commit record EA-000012-CM-01 preserves the determination, reason codes, approved scope, route version, chain-of-custody snapshot, and commit time.",
  },
  {
    number: "07",
    link: "Execution",
    ...
    finding: "The closure-certificate issuance adapter issued only the committed closure-certificate scope, enforced automatic validity expiration, and rejected every field outside the proof-verified request.",
    proof: "Execution receipt EA-000012-EX-01 records HTTP 202, CERTIFICATE_ISSUED, exact scope parity, one issuance invocation, zero unauthorized retries, and zero bypass attempts.",
  },
  {
    number: "08",
    link: "Outcome",
    ...
    finding: "The approved outcome-closure certificate was issued once, independently verified against the published custody and outcome commitments, and reached its declared validity end while preserving the underlying evidentiary boundary or authorizing any additional claim, subject, system, or downstream action.",
    proof: "Outcome record EA-000012-OT-01 and independent parity review confirm the bounded result and preserved residual-risk statement.",
  },
];
const gates: GateItem[] = [
  ...
  },
  {
    ...
    summary: "The governed subject, requesting outcome-closure steward, outcome verifier, adapter, and institutional environment are attributable.",
  },
  {
    number: "03",
    ...
    summary: "The action is limited to one subject, one closure-certificate scope, one governed subject system, one declared closure purpose, and one closure-certificate validity window.",
  },
  {
    number: "04",
    ...
    summary: "The outcome-closure-certificate issuance request and supporting declarations were preserved before reliance.",
  },
  {
    number: "05",
  ...
  },
  {
    ...
    summary: "The route, engine, chain-of-custody policy, closure-certificate schema, adapter, and canonicalization versions were frozen.",
  },
  {
    number: "07",
    ...
    summary: "The requesting outcome-closure steward, Chain-of-Custody Steward, Independent Outcome Verifier, adapter, steward, and verifier identities remained connected.",
  },
  {
    number: "08",
  ...
  },
  {
    ...
    summary: "No material subject, outcome verification, authority, closure claim, governed subject system, or system condition changed between intake, commitment, and adapter invocation.",
  },
  {
    number: "10",
  ...
  },
  {
    ...
    summary: "No contradictory outcome verification, subject, authority, closure claim, governed subject system, or target-state record remains unresolved.",
  },
  {
    number: "14",
    title: "Chain-of-custody verification valid",
    chainLink: "BINDING",
    result: "PASS",
    reasonCode: "AUTHORITY_VALID",
    summary: "The evidence custody steward and independent assurance outcome verifier possess valid, non-overlapping authority for this exact verification and closure-certificate action.",
  },
  {
    number: "15",
  ...
  },
  {
    ...
    summary: "Requested evidence policy, closure certificate adapter, governed subject, public closure-certificate scope, published closure claims, and validity window remain inside the route boundary.",
  },
  {
    number: "17",
  ...
  },
  {
    ...
    summary: "Evidence commitments, authority, route, public-evidence boundary, closure certificate adapter, governed subject, closure threshold, and intended public closure-certificate state were rechecked immediately before release.",
  },
  {
    number: "21",
  ...
  },
  {
    ...
    summary: "The performed action matches the committed action across subject, public closure-certificate scope, public-evidence boundary, closure certificate adapter, and validity window.",
  },
  {
    number: "23",
    ...
    summary: "The resulting public closure-certificate state was observed after execution and compared with the expected bounded state.",
  },
  {
    number: "24",
...
const evidence: EvidenceItem[] = [
  {
    id: "EA-000012-EV-01",
    title: "Compliance closure-certificate issuance request",
    ...
    supports: "Exact action, consequence, governed subject system, closure-certificate scope, affected subject, and declared limits.",
  ...
  {
    id: "EA-000012-EV-03",
    title: "Chain-of-Custody Steward authority record",
    source: "TA-14 Dual-Authority Resolver",
    type: "AUTHORITY_RECORD",
    public disclosure: "SELECTIVE",
    status: "ADMITTED",
    capturedAt: "2026-08-01 08:00:07 UTC",
    hash: "sha256:9a82cb3d...7f0c",
    supports: "Chain-of-Custody Steward identity, role, organization, source of authority, approval scope, and separation-of-duties position.",
    limitation: "Chain-of-Custody Steward authority is bounded to custody and closure certification and cannot substitute for Independent Outcome Verifier verification concurrence.",
  },
  {
    id: "EA-000012-EV-04",
    title: "Independent Outcome Verifier verification concurrence record",
    source: "TA-14 Dual-Authority Resolver",
    type: "AUTHORITY_RECORD",
    public disclosure: "SELECTIVE",
    status: "ADMITTED",
    ...
    supports: "Independent Outcome Verifier identity, declared review mandate, exact verification scope, valid time, revocation state, and conflict state.",
    limitation: "Independent Outcome Verifier verification concurrence applies only to the named subject, governed subject system, closure-certificate scope, purpose, and closure-certificate validity window.",
  },
  {
    id: "EA-000012-EV-05",
    title: "Evidence provenance manifest",
    source: "TA-14 Evidence Custody Steward",
    type: "MANIFEST",
    public disclosure: "PUBLIC",
    status: "ADMITTED",
    capturedAt: "2026-08-01 08:00:12 UTC",
    hash: "sha256:7dfce40a...c15d",
    supports: "Source origin, capture method, custody, version, public disclosure state, and integrity commitments.",
  ...
  },
  {
    ...
    supports: "Identity, evidence, route, chain-of-custody policy, closure-certificate issuance adapter, governed subject system, threshold, target, and state continuity.",
  ...
  },
  {
    ...
    supports: "Applicable rule, authority scope, governed subject system, closure-certificate scope, chain-of-custody policy, closure-certificate issuance adapter, closure claim, and time limits.",
  ...
  },
  {
    ...
    supports: "Immediate recheck of evidence, authority, route, chain-of-custody policy, closure-certificate issuance adapter, governed subject system, threshold, and closure certificate target state.",
  ...
  },
  {
    ...
    supports: "Committed ALLOW issued exactly one bounded outcome-closure-certificate issuance with exact scope parity.",
    limitation: "Proves control of the closure-certificate issuance adapter, not every possible external system.",
  },
  {
    id: "EA-000012-EV-11",
    ...
    supports: "Observed public closure-certificate state after release and absence of protected-content public disclosure or additional claims.",
...
const timeline: TimelineItem[] = [
  {
    ...
    detail: "The exact proposed issuance, consequence, target, governed subject system, closure-certificate scope, and declared limits entered the canonical record.",
    state: "SEALED",
  },
  {
    time: "08:00:04 UTC",
    event: "Route snapshot frozen",
    detail: "Route TA14-ROUTE-CHAIN-OF-CUSTODY-CLOSURE-ALLOW-012 version 2.0.0 and all twenty-four gates were fixed.",
    state: "FROZEN",
  },
  {
    time: "08:00:08 UTC",
    event: "First authority validated",
    detail: "The Chain-of-Custody Steward was validated as independent, conflict-free, current, and in scope for the exact closure-certificate request.",
    state: "VALID",
  },
  {
    time: "08:00:10 UTC",
    event: "Independent verification concurrence validated",
    detail: "The Independent Outcome Verifier independently approved the same subject, closure-certificate scope, governed subject system, purpose, and closure-certificate validity window without inheriting or duplicating the first authority.",
    state: "CONCURRED",
  },
  {
    time: "08:00:12 UTC",
  ...
  },
  {
    ...
    detail: "No material drift was found across evidence and custody commitments, authority, route, public-evidence boundary, closure certificate adapter, governed subject, closure threshold, or intended public closure-certificate state.",
    state: "CONTINUOUS",
  },
  {
    time: "08:02:44 UTC",
  ...
  },
  {
    ...
    detail: "Authority, obligation, scope, governed subject system, closure-certificate scope, closure claim, and time boundaries all remained valid.",
    state: "BOUND",
  },
  {
    time: "08:03:09 UTC",
  ...
  },
  {
    ...
    detail: "The closure-certificate issuance adapter accepted one signed bounded command and returned HTTP 202 CERTIFICATE_ISSUED.",
...
const verificationChecks: VerificationCheck[] = [
  ...
  },
  {
    ...
    detail: "The adapter receipt proves CERTIFICATE_ISSUED, one issuance invocation, exact scope parity, and zero bypass attempts.",
  },
  {
    level: "6",
...
const boundaryControls: BoundaryControl[] = [
  {
    id: "CONTROL-01",
    field: "Exact action",
    committed: "One bounded outcome-closure certificate",
    result: "PASS",
    explanation: "The action contains a stable target, operation, closure-certificate scope, governed subject system, chain-of-custody policy, closure-certificate issuance adapter, and event window.",
  },
  {
    id: "CONTROL-02",
    field: "Target identity",
    committed: "Account svc-ops-042 on governed subject system IDG-PROD-07",
    result: "PASS",
    explanation: "The target identity resolves to one controlled subject on the named governed subject system.",
  },
  {
    id: "CONTROL-03",
    field: "Destination",
    committed: "TA-14 Chain-of-Custody Closure Closure Certificate Adapter 2.0",
    result: "PASS",
    explanation: "No alternate subject, governed subject system, closure-certificate scope, or destination is authorized or invoked.",
  },
  {
    id: "CONTROL-04",
    field: "Quantity",
    committed: "One issuance for one subject and one closure-certificate scope",
    result: "PASS",
    explanation: "The adapter rejects duplicate issuance, additional subjects, expanded closure claims, extended duration, or secondary-system fields.",
  },
  {
    id: "CONTROL-05",
    field: "Model",
  ...
  },
  {
    ...
    committed: "TA-14 Chain-of-Custody Closure Closure Certificate Adapter 2.0",
    result: "PASS",
    explanation: "The permitted and invoked closure-certificate issuance adapter identifiers match.",
  },
  {
    id: "CONTROL-07",
    field: "Privilege",
    committed: "Issue READ_DIAGNOSTICS and RESTART_SERVICE only",
    result: "PASS",
    explanation: "No administrative delegation, subject creation, policy modification, credential export, or secondary closure claim is issued.",
  },
  {
    id: "CONTROL-08",
    field: "Time window",
  ...
  },
  {
    id: "CONTROL-09",
    field: "Authority",
    committed: "Chain-of-Custody Steward plus Independent Outcome Verifier",
    result: "PASS",
    explanation: "Both independent authorities were valid, conflict-free, in scope, and recorded verification concurrence on the identical issuance object before commit.",
  },
  {
    id: "CONTROL-10",
  ...
  },
  {
    ...
    result: "PASS",
    explanation: "No unauthorized token, governed subject system, retry, direct call, or alternate adapter path was observed.",
  },
  {
    id: "CONTROL-14",
    ...
    result: "PASS",
    explanation: "The subject received exactly the one approved closure-certificate scope, the state was independently observed, and both closure claims reached its declared validity end automatically at the committed time.",
  },
  {
    id: "CONTROL-15",
    field: "Residual risk",
    committed: "Time-bounded chain-of-custody closure risk only",
    result: "PASS",
  ...
  },
  {
    ...
    committed: "One subject, one closure-certificate scope, two authorities, one route, one adapter",
    result: "PASS",
...
const packageComponents: PackageComponent[] = [
  {
    ...
    format: "HTML",
    public disclosure: "PUBLIC",
    purpose: "Presents the sixty-second inspection path and progressive public disclosure surfaces.",
  ...
  },
  {
    ...
    format: "JSON",
    public disclosure: "PUBLIC",
    purpose: "Lists evidence identifiers, sources, public disclosure states, hashes, and admission results.",
  ...
  },
  {
    ...
    format: "JSON",
    public disclosure: "PUBLIC",
    purpose: "Connects the observed result, residual risk, outcome verifier, and closure status.",
...
const packageRecord = {
  ...
  scenario: {
    ...
    affectedSubjects: [
      "TA-14 controlled outcome-closure assurance environment",
    ...
    requestedTool: "TA-14 Chain-of-Custody Closure Closure Certificate Adapter 2.0",
    declaredLimits: [
      ...
      "The event is a controlled chain-of-custody closure-certificate issuance and is not represented as a production customer record.",
    ],
  },
  route: {
    routeId: ROUTE_ID,
    ...
    policyBasis: [
      ...
      "Release only the exact authorized action, target, governed subject system, closure-certificate scope, chain-of-custody policy, closure-certificate issuance adapter, closure claim, and time window.",
    ...
    permittedTool: "TA-14 Chain-of-Custody Closure Closure Certificate Adapter 2.0",
    ...
    revalidationTriggers: [
      ...
      "chain-of-custody policy change",
      "closure-certificate issuance adapter change",
      "governed subject system change",
      "closure-certificate scope change",
      "threshold change",
      "target-state change",
      "dependency change",
    ],
  ...
  execution: {
    ...
    technicalStatus: 202,
    technicalMessage: "CERTIFICATE_ISSUED",
    invocationCount: 1,
    retryCount: 0,
    bypassAttempts: 0,
    scopeParity: true,
    receiptId: "EA-000012-EX-01",
  ...
  outcome: {
    ...
    residualRisk:
      "The record is bounded to one controlled chain-of-custody closure-certificate issuance event and does not establish future or universal performance.",
  ...
  claimBoundary: {
    proves: [
      ...
      "The committed determination controlled the closure-certificate issuance adapter.",
      "Exactly one authorized action was released.",
      "The observed public closure-certificate state corresponded to the committed action.",
...
export default function Artifact000012Page() {
  ...
  const exportVerificationGuide = () =>
    downloadText(
      ...
      [
        ...
        `Expected execution effect: CERTIFICATE_ISSUED`,
  ...
  return (
    <main className="ea-page">
      ...
      <header className="ea-topbar">
        <Link href="/artifacts" className="ea-brand">
      ...
      <section className="ea-hero">
        <div className="ea-hero-copy">
          <div className="ea-kicker"><span>Door Eight</span><b>Canonical Execution Artifact 000012</b></div>
          <h1>Preserved Chain of Custody<br /><em>With Independent Outcome Closure</em></h1>
          <p className="ea-hero-lede">
            A complete bounded record proving that admissible evidence, valid chain-of-custody verification,
        ...
        <aside className="ea-command-core">
          ...
          <div className="ea-command-grid">
            ...
            <div><span>Execution</span><strong>CERTIFICATE_ISSUED</strong></div>
          ...
          <div className="ea-command-receipt">
            ...
            <strong>HTTP 202 · CERTIFICATE_ISSUED</strong>
      ...
      <section className="ea-stats">
        ...
        <Stat label="Outcome" value="1 authorized act" detail="Zero custody breaks" />
      </section>
        ...
        {view === "inspection" && (
          <section className="ea-view">
            <SectionHeading
              ...
              text="The inspection surface exposes the proposed consequence, controlling route, admitted evidence, valid chain-of-custody verification, committed decision, technical execution effect, observed outcome, and exact limits of the public claim."
            />
            <div className="ea-inspection-grid">
              <article className="ea-panel ea-panel-feature">
                ...
                <p>
                  The requested issuance targeted one controlled resource through one approved adapter,
                  using one approved runtime and one exact action closure-certificate scope during a fixed event window.
                </p>
                <div className="ea-mini-grid">
                  <div><span>Target</span><strong>Account svc-ops-042 on governed subject system IDG-PROD-07</strong></div>
              ...
              <article className="ea-panel">
                ...
                <h3>CERTIFICATE_ISSUED · HTTP 202</h3>
                <p>
                  The adapter accepted one signed command whose governed fields matched the frozen
                  commit record exactly. No retry, alternate governed subject system, expanded closure-certificate scope, or bypass occurred.
                </p>
              </article>
        ...
        {view === "evidence" && (
          <section className="ea-view">
            <SectionHeading
              ...
              title="Twelve admitted records with attribution, custody, public disclosure, and limits"
            ...
            <div className="ea-evidence-layout">
              ...
              <article className="ea-evidence-detail">
                ...
                <div className="ea-record-grid">
                  ...
                  <div><span>Public Disclosure</span><strong>{activeEvidenceRecord.disclosure}</strong></div>
            ...
            <div className="ea-two-column">
              <article className="ea-panel ea-authority-card">
                ...
                <div className="ea-record-grid compact">
                  ...
                  <div><span>Chain-of-custody sources</span><strong>Institutional artifact publication mandate</strong></div>
                  <div><span>Conflict state</span><strong>NONE</strong></div>
                  <div><span>Scope</span><strong>Create, review, package, and publish controlled chain-of-custody closure certificate artifacts</strong></div>
              ...
              <article className="ea-panel ea-authority-card">
                ...
                <div className="ea-record-grid compact">
                  <div><span>Organization</span><strong>TA-14 Authority</strong></div>
                  <div><span>Role state</span><strong>VALID</strong></div>
                  <div><span>Chain-of-custody sources</span><strong>Controlled runtime delegation</strong></div>
                  <div><span>Conflict state</span><strong>NONE</strong></div>
        ...
        {view === "control" && (
          <section className="ea-view">
            <SectionHeading
              ...
              text="Sixteen boundary controls demonstrate parity across action, target, governed subject system, closure-certificate scope, chain-of-custody policy, closure-certificate issuance adapter, closure claim, time, authority, continuity, command, bypass resistance, and outcome."
            />
            ...
            <article className="ea-receipt ea-margin-top">
              ...
              <div>
                <span className="ea-panel-label">Execution receipt EA-000012-EX-01</span>
                <h3>CERTIFICATE_ISSUED · exact scope parity</h3>
                <p>One invocation. Zero retries. Zero bypass attempts. Zero alternate governed subject systems. Zero expanded closure claims.</p>
              </div>
        ...
        {view === "outcome" && (
          <section className="ea-view">
            ...
            <div className="ea-outcome-hero">
              ...
              <div><span>Observed state</span><h3>AUTHORIZED_STATE_OBSERVED</h3><p>One certified closureion occurred. No additional mutation, governed subject system, closure-certificate scope, closure claim, or downstream command was detected.</p></div>
            ...
            <div className="ea-two-column ea-margin-top">
              ...
              <article className="ea-panel">
                ...
                <p>The outcome claim is supported by the technical receipt, observed public closure-certificate state, component hashes, and independent comparison record.</p>
              </article>
            </div>
          </section>
        )}
        ...
        {view === "challenge" && (
          <section className="ea-view">
            <SectionHeading
              ...
              text="A material challenge can dispute evidence, authority, route logic, execution effect, outcome, integrity, public disclosure, or claims boundaries. Corrections append; they do not rewrite history."
            />
            <div className="ea-two-column">
              <article className="ea-panel">
      ...
      <section className="ea-next">
        <div><span>Founding artifact series</span><h2>Continue inspecting governed execution behavior.</h2><p>Artifact 000012 proves that separation of duties can govern a successful execution: two separated verification roles concurred on the exact bounded issuance before commit, the adapter enforced the approved closure-certificate scope, and the outcome was independently verified.</p></div>
        <div className="ea-next-actions"><Link href="/artifacts/ta14-ea-000011">Previous artifact →</Link><Link href="/artifacts">Return to artifact library →</Link></div>
      </section>
