...
async function downloadReceipt(run:Run){
 ...
 const integrityPayload=[runId,frozenRecord,deltaId,r.fact,r.source,r.evidence,r.authority,r.standing,r.decision,r.gate].join("|");
 ...
 "This receipt records the selected public examination state. It is not an upstream standing declaration.",
