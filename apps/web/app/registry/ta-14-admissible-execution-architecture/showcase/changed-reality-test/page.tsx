...
<section className="crt-falsify"><p className="crt-eye">R1 · BOUNDED EXAMINATION RESULT</p><h2 className="crt-title">Run the evaluator against raw ΔN facts and inspect the resulting record.</h2><div className="crt-record"><div><small>CONTROL</small><b>Frozen across T₀, ΔN₁, and ΔN₂</b></div><div><small>ΔN₁</small><b>Standing established · ALLOW · commit may proceed</b></div><div><small>ΔN₂</small><b>Standing defeated · HOLD · commit blocked</b></div><div><small>RECORD INTEGRITY</small><b>Run-specific receipt · timestamp · ΔN identifier · SHA-256 integrity hash</b></div></div><p className="crt-change"><b>Bounded conclusion:</b> This implementation separates raw ΔN fixture inputs from evaluator-derived standing and determination. The public record remains inspectable and does not, by itself, establish universal runtime efficacy or independent physical enforcement outside this examination environment.</p></section>
