    ...
    <main>
      ...
      <section className="hero shell">
        ...
        <div className="heroActions">
          ...
          <Link className="grandButton glass" href="#seven-doors">Choose a Governed Door <span>↓</span></Link>
      ...
      <section className="hall shell" id="seven-doors">
        ...
        <div className="sectionIntro centeredIntro">
          <p className="eyebrow">SEVEN PRIMARY GOVERNANCE DESTINATIONS</p>
      ...
      <style jsx>{`
        ...
        .siteActivityDock{display:flex;justify-content:flex-end;padding-top:16px}
        .siteActivityCounter{width:min(100%,430px);padding:13px 15px;border:1px solid rgba(112,216,239,.24);border-radius:16px;background:linear-gradient(145deg,rgba(8,27,42,.9),rgba(5,15,26,.94));box-shadow:0 14px 34px rgba(0,0,0,.24),inset 0 1px rgba(255,255,255,.04);backdrop-filter:blur(12px)}
        .activityHeading{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-bottom:10px}
        .activityHeading p{margin:0;color:#d9f9ff;font-size:10px;font-weight:950;letter-spacing:.16em;text-transform:uppercase}
        .activityHeading span{color:#718a98;font-size:10px}
        .activityMetrics{display:grid;grid-template-columns:repeat(2,1fr);gap:9px}
        .activityMetrics>div{min-height:58px;padding:9px 12px;display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid rgba(255,255,255,.08);border-radius:11px;background:rgba(255,255,255,.025)}
        .activityMetrics strong{color:#fff4bf;font-family:Georgia,"Times New Roman",serif;font-size:24px;line-height:1;font-variant-numeric:tabular-nums}
        .activityMetrics span{color:#8fa5b1;font-size:9px;font-weight:900;letter-spacing:.11em;text-transform:uppercase;text-align:right}
        .activityUnavailable{margin:9px 0 0;color:#8b9aa3;font-size:10px;text-align:right}
        ...
        .featureSection{min-height:690px;margin-top:118px;padding:52px;display:grid;grid-template-columns:1fr 1.15fr;gap:72px;align-items:center;border:1px solid rgba(103,194,220,.17);border-radius:32px;background:radial-gradient(circle at 0 0,rgba(69,179,228,.09),transparent 40%),linear-gradient(145deg,rgba(12,31,47,.9),rgba(5,15,26,.96));box-shadow:0 30px 80px rgba(0,0,0,.24);overflow:hidden}.featureCopy{position:relative;z-index:2}.featureCopy p{max-width:840px}.featureActions{display:flex;flex-wrap:wrap;gap:12px;margin-top:26px}.statusFlag{display:inline-flex;min-height:31px;align-items:center;padding:0 11px;margin-bottom:16px;border-radius:999px;border:1px solid rgba(255,194,72,.36);color:#ffe09b;background:rgba(111,69,5,.14);font-size:10px;font-weight:950;letter-spacing:.12em}.credentialsSection{min-height:560px;margin-top:118px;padding:44px 48px;display:grid;grid-template-columns:.72fr 1.28fr;gap:56px;align-items:center;border:1px solid rgba(255,194,74,.2);border-radius:30px;background:radial-gradient(circle at 0 40%,rgba(65,188,216,.13),transparent 38%),radial-gradient(circle at 100% 0,rgba(255,188,62,.1),transparent 34%),linear-gradient(145deg,rgba(11,30,45,.94),rgba(5,15,26,.98));box-shadow:0 28px 76px rgba(0,0,0,.25);overflow:hidden}.credentialsVisual{height:390px;position:relative;display:grid;place-items:center}.credentialsHalo{position:absolute;width:340px;height:340px;border-radius:50%;background:radial-gradient(circle,rgba(89,211,232,.22),rgba(255,191,65,.09) 38%,transparent 68%);filter:blur(24px);animation:ambientBreath 5s ease-in-out infinite alternate}.credentialsSeal{width:220px;height:220px;position:relative;z-index:3;display:flex;flex-direction:column;align-items:center;justify-content:center;border-radius:50%;border:2px solid rgba(255,207,111,.68);background:radial-gradient(circle at 36% 30%,rgba(91,211,232,.24),rgba(10,28,43,.96) 55%,rgba(31,19,4,.98));box-shadow:0 0 0 10px rgba(255,198,77,.05),0 0 70px rgba(74,202,228,.2),inset 0 0 38px rgba(255,190,66,.12)}.credentialsSeal::before,.credentialsSeal::after{content:"";position:absolute;border-radius:50%;border:1px solid rgba(255,218,143,.26)}.credentialsSeal::before{inset:18px}.credentialsSeal::after{inset:38px;border-color:rgba(102,221,236,.25)}.credentialsSeal small{position:relative;z-index:2;color:#83e3f1;font-size:12px;font-weight:950;letter-spacing:.23em}.credentialsSeal strong{position:relative;z-index:2;margin:10px 0 8px;color:#ffe09a;font-family:Georgia,serif;font-size:25px;letter-spacing:.05em}.credentialsSeal span{position:relative;z-index:2;max-width:155px;color:#abc2ca;font-size:8px;font-weight:900;line-height:1.55;letter-spacing:.12em;text-align:center}.credentialOrbit{position:absolute;border-radius:50%;border:1px solid rgba(104,218,235,.3);animation:orbitSpin 18s linear infinite}.credentialOrbit.one{width:305px;height:305px}.credentialOrbit.two{width:360px;height:165px;border-color:rgba(255,197,74,.35);transform:rotate(34deg);animation-direction:reverse;animation-duration:24s}.credentialsCopy{position:relative;z-index:2}.credentialsCopy h2{margin:12px 0 16px;font-family:Georgia,"Times New Roman",serif;font-size:clamp(38px,4.3vw,64px);line-height:.99;letter-spacing:-.045em;text-wrap:balance}.credentialsCopy>p:not(.eyebrow){max-width:900px;color:#aebfc8;font-size:15px;line-height:1.7}.credentialsGrid{display:grid;grid-template-columns:repeat(2,1fr);gap:10px;margin-top:23px}.credentialsGrid article{display:grid;grid-template-columns:38px 1fr;gap:12px;padding:13px;border:1px solid rgba(255,197,76,.14);border-radius:13px;background:rgba(255,255,255,.022)}.credentialsGrid article>span{width:34px;height:34px;display:grid;place-items:center;border-radius:50%;border:1px solid rgba(116,218,237,.3);color:#86e5f4;background:rgba(56,171,196,.08);font-size:9px;font-weight:950}.credentialsGrid strong{font-size:13px}.credentialsGrid p{margin:4px 0 0;color:#9daeb8;font-size:11px;line-height:1.48}.credentialsBoundary{margin-top:18px;padding:15px 17px;border:1px solid rgba(255,196,75,.2);border-radius:14px;background:rgba(98,61,9,.12)}.credentialsBoundary strong{color:#ffe09b;font-size:13px}.credentialsBoundary p{margin:6px 0 0;color:#aab9c1;font-size:11px;line-height:1.58}.credentialsPrimary{min-width:310px}
        .euSection{grid-template-columns:1.15fr 1fr;background:radial-gradient(circle at 100% 20%,rgba(42,88,211,.18),transparent 40%),linear-gradient(145deg,rgba(9,27,61,.93),rgba(4,14,31,.98))}.statStrip{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:24px}.statStrip span{padding:15px;border:1px solid rgba(92,156,255,.18);border-radius:13px;color:#9eb0ca;background:rgba(255,255,255,.025);font-size:11px;line-height:1.45}.statStrip b{display:block;margin-bottom:5px;color:#ffd266;font-size:12px}.euUniverse{height:500px;position:relative;display:grid;place-items:center}.euPlanet{width:210px;height:210px;position:relative;display:grid;place-items:center;border-radius:50%;background:radial-gradient(circle at 35% 30%,#4b8cff,#123b9c 40%,#061642 74%);box-shadow:0 0 80px rgba(49,104,255,.45),inset -20px -20px 50px rgba(0,0,0,.4)}.euPlanet span{font-family:Georgia,serif;font-size:54px;color:white;text-shadow:0 0 24px rgba(255,255,255,.4)}.euPlanet i{position:absolute;left:50%;top:50%;width:8px;height:8px;border-radius:50%;background:#ffd33e;box-shadow:0 0 12px #ffd33e;transform:rotate(calc(var(--i)*30deg)) translateY(-77px)}.euOrbit{position:absolute;width:420px;height:170px;border:1px solid rgba(255,207,70,.35);border-radius:50%;animation:orbitSpin 16s linear infinite}.euOrbit.two{transform:rotate(60deg) scale(.78);animation-direction:reverse}.euOrbit.three{transform:rotate(-55deg) scale(.58);animation-duration:11s}.articleMarkers span{position:absolute;min-width:58px;height:34px;display:grid;place-items:center;border-radius:999px;border:1px solid rgba(255,207,70,.4);color:#ffe08d;background:rgba(9,25,63,.86);font-size:11px;font-weight:950;box-shadow:0 0 18px rgba(255,190,45,.13)}.articleMarkers span:nth-child(1){left:4%;top:20%}.articleMarkers span:nth-child(2){right:3%;top:28%}.articleMarkers span:nth-child(3){left:8%;bottom:22%}.articleMarkers span:nth-child(4){right:10%;bottom:14%}
        ...
        @media(max-width:1280px){.doors{grid-template-columns:repeat(3,1fr)}.doorStage{height:500px}.capabilityGrid,.marketGrid{grid-template-columns:repeat(2,1fr)}.featureSection,.verificationSection{grid-template-columns:1fr}.credentialsVisual,.euUniverse,.networkVisual,.verificationBeam{order:2}.chain{grid-template-columns:repeat(4,1fr);row-gap:18px}.chainNode i{display:none}}
        @media(max-width:980px){.doors{grid-template-columns:repeat(2,1fr)}}@media(max-width:760px){.siteActivityDock{justify-content:center;padding-top:12px}.siteActivityCounter{width:100%}.activityHeading{align-items:flex-start;flex-direction:column;gap:3px}.shell{width:min(100% - 20px,1540px)}.institutionRule i{width:42px}.institutionRule span{font-size:13px;letter-spacing:.08em}.hero{padding-top:38px}.hero h1{font-size:clamp(42px,12vw,64px)}.heroLead{font-size:16px}.heroDefinition,.doors,.capabilityGrid,.marketGrid,.recordsPair,.credentialsGrid,.statStrip,.networkSteps{grid-template-columns:1fr}.heroActions .grandButton,.featureActions .grandButton{width:100%}.hall{padding-inline:10px}.doorStage{height:475px}.featureSection,.credentialsSection,.marketplaceSection,.verificationSection{padding:34px 20px;margin-top:80px}.marketplaceHeader{display:grid}.chain{grid-template-columns:repeat(2,1fr)}.credentialsVisual,.euUniverse,.networkVisual,.verificationBeam{height:390px}.credentialsVisual{transform:scale(.82)}.euUniverse{transform:scale(.8)}.networkVisual{transform:scale(.8)}.sectionIntro h2,.featureCopy h2,.marketplaceHeader h2,.closingTemple h2{font-size:clamp(34px,10vw,52px)}footer{flex-direction:column;align-items:flex-start;justify-content:center;gap:6px}}
