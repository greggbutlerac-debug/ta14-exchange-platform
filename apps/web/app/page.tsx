...
const workspaces = [
  {
    ...
    description:
      "Build, test, challenge, correct, and verify AI governance routes before consequential execution is allowed to proceed.",
    color: "#62afff",
  ...
  },
  {
    ...
    kicker: "PRESERVE EVIDENCE WITHOUT COLLAPSE",
    description:
      "Create, upload, interpret, preserve, and review records while keeping evidence, diagnosis, determination, and outcome in separate layers.",
    color: "#9ee84c",
    glow: "rgba(143, 225, 62, .52)",
    world: "recordsWorld",
    features: [
      "Create and upload governed records",
      "Bounded interpretation with explicit limitations",
      "Attributable chronology, ownership, and version history",
      "Review-ready evidence packages and exports",
    ],
  },
  {
    id: "er",
    ...
    kicker: "MAKE LAND, WATER, AND AIR INSPECTABLE",
    description:
      "Govern environmental evidence from buildings, hospitals, HVAC systems, sensors, land, water, and atmospheric records.",
    color: "#65e8f1",
    glow: "rgba(67, 218, 230, .52)",
    world: "environmentWorld",
    features: [
      "Atmospheric and environmental integrity records",
      "Buildings, IAQ, HVAC, hospitals, and sensor packages",
      "Daily records with bounded interpretation",
      "Proof boundaries before diagnosis or optimization",
    ],
  },
  {
    id: "entity",
    ...
    description:
      "Submit an organization, AI system, governance architecture, program, product, or route for independent governed review.",
    color: "#dd83ff",
    ...
    <main>
      ...
      <section className="hero shell">
        ...
        <div className="heroActions">
          ...
          <Link className="grandButton gold" href="#four-doors">Choose a Governed Door <span>↓</span></Link>
      ...
      <section className="hall shell" id="four-doors">
        ...
        <div className="sectionIntro centeredIntro">
          <p className="eyebrow">FOUR GOVERNED ENTRANCES</p>
          <h2>Enter the workspace that matches the thing being governed.</h2>
          <p>Each doorway preserves a different evidence boundary. They connect to one governing discipline, but they do not force every domain through the same schema.</p>
        </div>
              ...
              <div className="doorStage">
                ...
                <div className="archFrame">
                  ...
                  <div className="doorOpening">
                    ...
                    <div className="doorLeaf doorLeft">
                      <div className="doorEmblem halfEmblem"><span>{workspace.code}</span></div>
                      <div className="doorPanels"><i/><i/><i/><i/></div>
                      <span className="hinge h1"/><span className="hinge h2"/><span className="hinge h3"/>
                      <span className="doorHandle leftHandle" />
                    </div>
                    <div className="doorLeaf doorRight">
                      <div className="doorEmblem halfEmblem"><span>{workspace.code}</span></div>
                      <div className="doorPanels"><i/><i/><i/><i/></div>
                      <span className="hinge h1"/><span className="hinge h2"/><span className="hinge h3"/>
                      <span className="doorHandle rightHandle" />
                    </div>
                  </div>
                </div>
      ...
      <section className="featureSection registrySection shell">
        <div className="registryVault" aria-hidden="true">
          <div className="vaultDoor"><span>TA-14</span><i/><i/><i/><i/></div>
      ...
      <section className="recordsConstellation shell">
        <div className="sectionIntro centeredIntro">
          ...
          <p>Governed Records and Environmental Records are separate entrances because evidence remains more trustworthy when the source record is not silently rewritten by diagnosis, optimization, or institutional preference.</p>
        </div>
        <div className="recordsPair">
          <article className="recordWorld green"><div className="recordVisual"><i/><i/><i/><span>GR</span></div><h3>Governed Records</h3><p>Create, upload, preserve, interpret, review, version, and export records with explicit proof boundaries.</p><Link href="/workspace/governed-records">Open Governed Records <Arrow /></Link></article>
          <article className="recordWorld blue"><div className="recordVisual atmosphere"><i/><i/><i/><span>ER</span></div><h3>Environmental Records</h3><p>Bring atmospheric, building, hospital, HVAC, sensor, land, water, and air evidence into bounded interpretation.</p><Link href="/workspace/environmental-records">Open Environmental Records <Arrow /></Link></article>
        </div>
      </section>
      ...
      <style jsx>{`
        ...
        .ambient{position:absolute;width:440px;height:440px;border-radius:50%;filter:blur(80px);opacity:.16;animation:ambientBreath 9s ease-in-out infinite alternate}.ambientOne{left:12%;top:34%;background:#0a69ff}.ambientTwo{right:10%;top:42%;background:#ff9f1a;animation-delay:-3s}.burst{position:absolute;width:10px;height:10px;background:#fff0a6;box-shadow:0 0 18px rgba(255,222,112,.95),0 0 40px rgba(255,180,54,.55);transform:rotate(45deg);animation:burst 4.8s ease-in-out infinite}.burst::before,.burst::after{content:"";position:absolute;left:50%;top:50%;background:linear-gradient(90deg,transparent,#ffe49a,transparent);transform:translate(-50%,-50%)}.burst::before{width:86px;height:1px}.burst::after{width:1px;height:86px}.burstOne{left:48%;top:14%}.burstTwo{right:8%;top:27%;animation-delay:-2.1s}.burstThree{left:9%;top:74%;animation-delay:-3.4s}.cosmicDust{position:absolute;width:4px;height:4px;border-radius:50%;background:#ffeab2;box-shadow:90px 40px #9be9ff,180px 130px #fff,270px 60px #ffd477,350px 190px #bc8aff,480px 10px #fff;animation:dustDrift 13s linear infinite}.dustOne{left:5%;top:28%}.dustTwo{right:6%;top:55%;animation-delay:-6s}
        .topbar{min-height:76px;display:grid;grid-template-columns:auto 1fr auto;align-items:center;gap:24px;border-bottom:1px solid rgba(92,142,174,.16);backdrop-filter:blur(16px)}.brand{display:flex;align-items:center;gap:13px;color:white;text-decoration:none}.brandMark{min-width:78px;height:44px;border-radius:999px;display:grid;place-items:center;border:1px solid rgba(255,194,72,.75);color:#ffd166;font-weight:950;letter-spacing:.06em;box-shadow:inset 0 0 16px rgba(255,184,50,.08),0 0 18px rgba(255,176,38,.08)}.brand>span:last-child{display:flex;flex-direction:column}.brand strong{font-size:17px}.brand small{margin-top:3px;color:#ffcf67;font-size:11px}nav{display:flex;justify-content:center;gap:28px}nav a{position:relative;color:#c5d3dc;text-decoration:none;font-size:13px;font-weight:800;padding:27px 0}nav a::after{content:"";position:absolute;left:50%;right:50%;bottom:18px;height:1px;background:#72dcf3;transition:.25s}nav a:hover{color:white}nav a:hover::after{left:0;right:0}.postButton{min-height:46px;display:inline-flex;align-items:center;gap:16px;padding:0 20px;border-radius:999px;border:1px solid rgba(255,190,64,.46);color:#ffe2a1;background:linear-gradient(180deg,rgba(117,75,10,.25),rgba(47,29,4,.18));text-decoration:none;font-size:13px;font-weight:900;box-shadow:0 0 20px rgba(255,170,31,.12),inset 0 1px rgba(255,255,255,.08);transition:.25s}.postButton:hover{transform:translateY(-2px);box-shadow:0 12px 28px rgba(255,170,31,.18)}.postButton span{color:#ffd15f;text-shadow:0 0 16px rgba(255,203,82,.9)}
        ...
        @media(max-width:1280px){nav{display:none}.topbar{grid-template-columns:1fr auto}.doors{grid-template-columns:repeat(2,1fr)}.doorStage{height:500px}.capabilityGrid,.marketGrid{grid-template-columns:repeat(2,1fr)}.featureSection,.verificationSection{grid-template-columns:1fr}.registryVault,.euUniverse,.networkVisual,.verificationBeam{order:2}.chain{grid-template-columns:repeat(4,1fr);row-gap:18px}.chainNode i{display:none}}
        @media(max-width:760px){.shell{width:min(100% - 20px,1540px)}.brand small{display:none}.postButton{padding:0 14px}.postButton span{display:none}.institutionRule i{width:42px}.institutionRule span{font-size:13px;letter-spacing:.08em}.hero{padding-top:38px}.hero h1{font-size:clamp(42px,12vw,64px)}.heroLead{font-size:16px}.heroDefinition,.doors,.capabilityGrid,.marketGrid,.recordsPair,.registryList,.statStrip,.networkSteps{grid-template-columns:1fr}.heroActions .grandButton,.featureActions .grandButton{width:100%}.hall{padding-inline:10px}.doorStage{height:475px}.featureSection,.marketplaceSection,.verificationSection{padding:34px 20px;margin-top:80px}.marketplaceHeader{display:grid}.chain{grid-template-columns:repeat(2,1fr)}.registryVault,.euUniverse,.networkVisual,.verificationBeam{height:390px}.vaultDoor{transform:scale(.78)}.euUniverse{transform:scale(.8)}.networkVisual{transform:scale(.8)}.sectionIntro h2,.featureCopy h2,.marketplaceHeader h2,.closingTemple h2{font-size:clamp(34px,10vw,52px)}footer{flex-direction:column;align-items:flex-start;justify-content:center;gap:6px}}
