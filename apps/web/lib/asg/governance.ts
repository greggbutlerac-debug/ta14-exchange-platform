...
function words(value:string){return value.toLowerCase().replace(/[^a-z0-9\s-]/g," ").split(/\s+/).filter(Boolean)}
...
export const ASG_ENGINE_VERSION="asg.v0.3";
