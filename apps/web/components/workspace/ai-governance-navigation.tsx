    ...
    <>
      ...
      >
        ...
        <article className="ta14-sidebar-note">
          <small>
            TA-14 Institutional Mission Control
          </small>

          <strong>
            Identity. Action. Records.
            Continuity.
          </strong>

          <p>
            See active work, required actions,
            registered entities, reviews,
            artifacts, credentials, commercial
            scopes, and institutional history in
            one operating view.
          </p>
        ...
        <article className="ta14-sidebar-note">
          <small>
            TA-14 Reviews & Responses
          </small>

          <strong>
            Independent voices. Preserved
            chronology.
          </strong>

          <p>
            Inspect participant reviews,
            independent reviews, evidence
            challenges, factual corrections,
            technical comments, external
            publications, and governed responses
            attached to the institutional record.
          </p>

          <Link href={reviewsResponsesHref}>
            Open Reviews & Responses →
          </Link>
        </article>
        ...
        <article className="ta14-sidebar-note">
          ...
          <strong>
            Independent architectures. Written
            boundaries.
          </strong>

          <p>
            Explore the current partner-review
            pathways and learn what each
            governance architecture contributes.
          </p>

          <Link href={partnerReviewNetworkHref}>
            Explore the network →
          </Link>
        </article>
      </aside>
